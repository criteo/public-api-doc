...
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Delivery_Docs/v2026_01/docs/AD TRACKING/legacy-universal-beacons.md
...
<Info>
  Please refer to [this page](/retailer-integration/docs/beacon-types#non-rendered-product-status-codes) for a full list of status codes.
</Info>

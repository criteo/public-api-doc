---
title: Upgrade from Legacy Beacons
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Delivery_Docs/v2026_01/docs/AD TRACKING/universal-beacons-copy.md
description: This page outlines Criteo's legacy beacon setup and explains how to transition to standard/universal beacons
hidden: true
---
...
# Legacy beacon behavior & key differences

<table>
  <thead>
    <tr>
      <th>Feature</th>
      <th>Legacy beacons</th>
      <th>Standard/Universal beacons</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td><strong>Data transmission</strong></td>
      <td>Sends an <code>onLoad</code> beacon per product</td>
      <td>Includes product data at the placement level</td>
    </tr>
    <tr>
      <td><strong>Performance impact</strong></td>
      <td>Higher network requests and load</td>
      <td>More efficient, fewer requests</td>
    </tr>
    <tr>
      <td><strong>Implementation complexity</strong></td>
      <td>Requires per-product tagging</td>
      <td>Consolidated tracking logic</td>
    </tr>
    <tr>
      <td><strong>Use case</strong></td>
      <td>Legacy setups requiring detailed per-product tracking</td>
      <td>Modern implementations optimizing efficiency</td>
    </tr>
    <tr>
      <td><strong>Feedback mechanism</strong></td>
      <td>No feedback on missing products</td>
      <td>Supports status codes for suppressed/not rendered products</td>
    </tr>
    <tr>
      <td><strong>Optimization potential</strong></td>
      <td>Limited visibility into why products didn't appear</td>
      <td>Enables fill rate optimization and revenue improvement</td>
    </tr>
  </tbody>
</table>
...
# Upgrading to standard/universal beacons

Here’s how you can make the transition, ensuring that you consult with your Technical Account Manager before beginning the process:
...
2. **QA:** Collaborate with your Technical Account Manager to test the new beacon logic in the pre-production environment to ensure it functions correctly.
...
* [Universal beacons](/retailer-integration/docs/universal-beacons)

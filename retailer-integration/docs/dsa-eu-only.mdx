...
<Info>
  **API endpoint**
  ...
  The field is also available within the External API, through the `Account` endpoint, as the `companyName`parameter. The API documentation details can be accessed [here](/retail-media/docs/accounts).
</Info>

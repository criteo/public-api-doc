   ...
   <td>
    ...
    <ul>
     <li>
      ...
      : visible when you hover the “i” icon on the video.
     </li>
     <li>
      <b>
       Mobile and App
      </b>
      : visible at all times below the video.
     </li>
    </ul>
   </td>
  </tr>
  <tr>
   ...
   <td>
    <p>
     ...
     link is provided in the VAST._
    </p>
    <p>
  ...
  <tr>
   ...
   <td>
    <p>
     ...
     ; legal text “i” icon) to ensure visibility over any video file provided.
    </p>
    <p>

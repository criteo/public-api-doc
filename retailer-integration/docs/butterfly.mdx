...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>desktop&#95;background&#95;image&#95;alt&#95;text</code></td>
      <td>Alternative text for desktop background image</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Alternative text for mobile background image</td>
    </tr>
    <tr>
    ...
    <tr>
      <td><code>mobile&#95;logo&#95;image&#95;alt&#95;text</code></td>
      <td>Alternative text for mobile logo image</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Option type. Can have the following values:<br /><ul><li><code>no-option</code>: no footer option</li><li><code>redirection</code>: expect values in <code>optional&#95;footer&#95;redirect&#95;url</code> and/or <code>optional&#95;footer&#95;redirect&#95;url&#95;app</code>)</li><li><code>file</code>: expect values in <code>optional&#95;footer&#95;media&#95;file</code></li><li><code>legal</code>: expect values in <code>optional&#95;footer&#95;text</code></li></ul></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>App deeplink that the user is redirected to</td>
    </tr>
    <tr>
      <td><code>optional&#95;footer&#95;redirect&#95;target</code></td>
      <td>Redirection target. Can have the following values:<br /><ul><li><code>&#95;blank</code>: redirects to a new tab</li><li><code>&#95;self</code>: redirects in the same tab</li></ul><br />(only applicable for web)</td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>The product that should be rendered when the button is clicked. The array is contains the priority order of product rendering. If you are checking product availability in real time, you should render the <strong>first available product</strong> in the array, i.e., if the first product is not available, check the second one, then check the third, and so on.</td>
    </tr>
    <tr>
      <td><code>isMandatory</code></td>
      <td>If <code>true</code>, the unit should only be rendered if <strong>at least one</strong> of the products in the <code>products</code> array is available.<br />If <code>false</code>, the button can be ignored if no product in the <code>products</code> array is available.<br /><ul><li>&#42;Note:&#42;&#42; This option is only relevant if you are check product availability in real time, before rendering the units.</li></ul></td>
    </tr>
  </tbody>
</table>
...
[Embedded content](https://codepen.io/demo_placement/embed/xxojPqG)

 ...
 <tbody>
  ...
  <tr>
   ...
   <td>
    <p>
     ...
     that is persistent across sessions on the same device.
    </p>
   </td>
   <td>
    <p>
  ...
  <tr>
   ...
   <td>
    <p>
     <code>
      laptop or Beverages&gt;Beverages&gt;Soda, or 1000068949
     </code>
    </p>
   </td>
   <td>
  ...
  <tr>
   ...
   <td>
    <p>
     URL Encoded:
     <code>
      %7B%22lang%22%3A%22french%22%7D
     </code>
    </p>
    <p>
     URL Decoded:
  ...
  <tr>
   ...
   <td>
    <p>
     URL Encoded:
     <code>
      %7B%22targetingMap%22%3A%7B%22rvid%22%3A%5B%22TUoQPO58Wkr1dIYn234Eao%22%5D%2C%22context%22%3A%5B%22laptop%22%5D%2C%22lang%22%3A%5B%22french%22%5D%7D%7D
     </code>
    </p>
    <p>
     URL Decoded:
     <code>
      &#123;"targetingMap":&#123;"rvid":["TUoQPO58Wkr1dIYn234Eao"],"context":["laptop"],"lang":["french"]&#125;&#125;
     </code>
    </p>
   </td>
   <td>
  ...
  <tr>
   ...
   <td>
    <p>
     ...
     should be populated via the
     <code>
      %%CACHEBUSTER%%
     </code>
     macro that will generate a random number to prevent caching
    </p>
   </td>
   <td>
    <p>
  ...
  <tr>
   ...
   <td>
    <p>
     Store ID selected by the user when browsing the retailer’s site. It should match the store IDs in the product feed. See more details
     <a href="https://developers.criteo.com/retailer-integration/docs/api-parameters-1#regionid">
      here
     </a>
     .
    </p>

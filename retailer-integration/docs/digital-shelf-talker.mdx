...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Button text<br />(not applicable for mobile version)</td>
    </tr>
    <tr>
      <td><code>footer&#95;text&#95;color</code></td>
      <td>Button text color<br />(not applicable for mobile version)</td>
    </tr>
    <tr>
      <td><code>footer&#95;background&#95;color</code></td>
      <td>Button background color<br />(not applicable for mobile version)</td>
    </tr>
  </tbody>
</table>

  ...
  <tr>
   <td>
    <p>
     ...
     (including all information within this field)
    </p>
   </td>
   <td>
    <p>
     ...
     It is reserved for Criteo purposes only. All video-related information, assets and tracking must be used from the VAST XML only.
    </p>
   </td>
  </tr>
  <tr>
   ...
   <td>
    <p>
     ...
     node). As only one redirection link is supported in VAST, Criteo will automatically return the right URL based on the page requesting ads.
    </p>
   </td>
  </tr>
  <tr>
   <td>
    <p>
     <code>
      alternative_text / background_video_alt_text
     </code>
   ...
   <td>
    <p>
     Text to display in an alt_text div attribute for
  ...
  <tr>
   ...
   <td>
    <p>
     ...
     It is reserved for Criteo purposes only.
    </p>
   </td>
  </tr>
 </tbody>

...
<Warning>
  ...
  **All Criteo beacons should only ever be triggered once**, _except_ for product-level click events (`OnClick`, `OnBasketChange`, and `OnWishlist`), which can occur multiple times.

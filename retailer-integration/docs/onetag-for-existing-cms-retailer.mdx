...
description: If you use an other product then Retail Media, you probably already have
  implemented Onetag and are sending feeds on a daily basis. It means that to integrate
  Retail Media only a few changes are needed. A few extra fields will be needed for
  both onetag and the feed.
hidden: true
---

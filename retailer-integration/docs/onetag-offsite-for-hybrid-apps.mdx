...
<Info>
  This guide is an addendum. Please refer to this page for a more comprehensive documentation: [OneTag for Retail Media Offsite.](/retailer-integration/docs/onetag-for-offsite)
</Info>
...
The steps below details how to apply the needed changes and refer to the example code displayed [at the end of the section.](/retailer-integration/docs/onetag-offsite-for-hybrid-apps#full-example)

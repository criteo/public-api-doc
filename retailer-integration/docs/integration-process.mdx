...
We provide [a general introduction](/retailer-integration/docs/introduction) about how we use beacons at Criteo, as well as [details on beacon types](/retailer-integration/docs/beacon-types), [the universal beacons feature](/retailer-integration/docs/universal-beacons), and [the BeaconSDK library](/retailer-integration/docs/beacon-sdk) in the **Ad Tracking** section.

...
<Frame caption="API レスポンス構造">
  <img src="/images/retailer-integration/docs/6da8237-image.png" alt="API レスポンス構造" />
</Frame>
...
<table>
 ...
 <tbody>
  <tr>
   ...
   <td>
    <p>
     このフィールドは弊社専用となっておりますので、
     <b>
      ご使用はお控えください。
     </b>
     すべての動画関連情報、アセット、トラッキングは、VAST XML からのみ使用する必要があります。
    </p>
   </td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td>
    <p>
     これらのフィールドは弊社専用となっておりますので、
     <b>
      ご使用はお控えください。
     </b>
     ユーザーがビデオプレーヤーをクリックした場合にランディングページへ転送するオプションのリダイレクトリンクは、VAST 定義で使用できます（
     <code>
      &lt;ClickThrough&gt;
     </code>
     ノードなど）。 VAST でサポートするリダイレクトリンクは1つのみであるため、Criteo は広告をリクエストしているページに基づいて適切な URL を自動的に返します。
    </p>
   </td>
  </tr>
  <tr>
   ...
   <td>
    <p>
     ...
     準拠のために alt\_text div 属性に表示するテキスト。
    </p>
   </td>
  </tr>
  <tr>

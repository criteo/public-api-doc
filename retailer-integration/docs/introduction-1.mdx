...
<Info>
  **Which to choose?**
  ...
  Head this way for the [Feed upload guide](https://developers.criteo.com/retailer-integration/docs/product-upload-guide), or this way for the [Product Importer API guide](https://developers.criteo.com/retailer-integration/docs/product-importer-guide).
</Info>
...
* [Dataset parameters](/retailer-integration/docs/product-feed-parameters)

...
* **Set up an app**: Generate an API token by setting up an app in our developer portal. Follow the instructions here: [Configuring Your API Application](/retail-media/docs/configuring-your-api-application).

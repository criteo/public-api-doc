...
<table>
 ...
 <tbody>
  ...
  <tr>
   ...
   <td>
    <p>
     Restricts ad response to specific attributes. Ensure these filter names and values match exactly what is passed in the feed. A list of accepted filter operators can be found <a href="/retailer-integration/docs/filtering">here</a> .
    </p>
   </td>
   <td>
    <p>
  ...
  <tr>
   ...
   <td>
    <p>
     ...
     <a href="/retailer-integration/docs/product-feed-parameters#filters">
      passed in the feed
     </a>
     . A list of accepted filter operators can be found
     <a href="/retailer-integration/docs/filtering">
      here
     </a>
     .
    </p>
  ...
  <tr>
   ...
   <td>
    <p>
     ...
     <a href="/retailer-integration/docs/product-feed-parameters#regional-data">
      includes regiondata
     </a>
     .
    </p>

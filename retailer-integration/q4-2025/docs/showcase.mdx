...
| `optional_footer_redirect_target`    | *For first option:* Redirection target, can have the following values:<ul><li>`_blank`: redirects to a new tab</li><li>`_self`: redirects in the same tab (only applicable for web)</li></ul>                                                                                                                                                |
...
| `optional_footer_type_2`             | *For second option:* Option type. Can have the following values:<ul><li>`no-option`: no footer option</li><li>`redirection`: expect values in `optional_footer_redirect_url` and/or `optional_footer_redirect_url_app`)</li><li>`file`: expect values in `optional_footer_media_file`</li><li>`legal`: expect values in `optional_footer_text`</li></ul> |
...
| `optional_footer_redirect_target_2`  | *For second option:* Redirection target, can have the following values:<ul><li>`_blank`: redirects to a new tab</li><li>`_self`: redirects in the same tab (only applicable for web)</li></ul>                                                                                                                                               |

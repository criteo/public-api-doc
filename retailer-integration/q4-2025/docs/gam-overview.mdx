...
| `regionId`            | string           | `42`                                                                                                                                                                                                                                                                              | Store ID selected by the user when browsing the retailer’s site. It should match the store IDs in the product feed. See more details [here](/retailer-integration/docs/api-parameters-1#regionid). | Yes, if Store IDs are defined in the product feed                  |

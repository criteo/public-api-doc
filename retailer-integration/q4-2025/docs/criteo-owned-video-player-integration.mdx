...
<Warning>
  ...
  Please refer to Step 4 of the [Video Player Implementation (Desktop/Mobile)](https://developers.criteo.com/retailer-integration/docs/video-player-implementation-guide-desktopmobile#step-4-additional-verification-with-omid-compatible-scripts-video-views) for more details. The project itself does not bundle or include our own OMSDK.
</Warning>

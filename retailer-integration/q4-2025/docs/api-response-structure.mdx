...
<Warning>
  All video parameters in the rendering section **must not be used to render the video format**. Please refer to [the table below](https://developers.criteo.com/retail-media-delivery/retail-media/docs/api-response-structure#rendering-fields) for more details.
...
<Info>
  ...
  Please refer to the[ format specifications](https://developers.criteo.com/retailer-integration/docs/format-overview) (in the Ad rendering section) for more information on the rendering capability. You will also find in this section [the Commerce Video Spotlight specification.](https://developers.criteo.com/retailer-integration/docs/commerce-video-spotlight).
</Info>

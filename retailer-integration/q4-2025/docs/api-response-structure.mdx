...
<Warning>
  All video parameters in the rendering section **must not be used to render the video format**. Please refer to [the table below](/retailer-integration/q4-2025/docs/api-response-structure#rendering-fields) for more details.

...
* **Set up an app**: Generate an API token by setting up an app in our developer portal. Follow the instructions here: [Configuring Your API Application](https://developers.criteo.com/retail-media/docs/connect-to-the-api).
* **Share application ID**: Share your `application_id` with your TAM. This ID will be used to set up our authentication server.
* **Authentication request**: Make an authentication request as described here: [Authentication](https://developers.criteo.com/retail-media/docs/authentication).

...
<Frame caption="Example of the Butterfly ad format">
  <img src="/images/retailer-integration/q4-2025/docs/32e70a3d774de37f73f5bf1437e76f121505f6f82b3dccfc912b6be32c1790e6-Website.png" />
</Frame>

<Info>
  This format corresponds to the desktop version of the Butterfly unit. For mobile specs, please refer to [Interactive Header](/retailer-integration/q4-2025/docs/interactive-header).
</Info>
...
![](/images/retailer-integration/q4-2025/docs/c4449d5-5-4-3_product.jpg "5-4-3 product.jpg") ![](/images/retailer-integration/q4-2025/docs/04d5a98-2-1_products.jpg "2-1 products.jpg")
...
<Frame caption="Branding zone behavior on grid tiles larger and smaller than background image.">
  <img src="/images/retailer-integration/q4-2025/docs/e430cc6aee910331274715b1ea9b745d0299903cf488185c1b1ce78a0d712927-TileBehavior-BTF.png" />
</Frame>
...
<Frame>
![](/images/retailer-integration/q4-2025/docs/007ac13ff22859d582941ccc7c29878942bb2a90ba05012e66f3fba5dc0d1af4-image.png)
</Frame>

* If there is only one SKU (no Product Buttons), the **safety zone** is `180x390px`

<Frame>
![](/images/retailer-integration/q4-2025/docs/ed2133f9eab626971ff9905de6cf321d76ed5eb1d3b2e4360575e948f806aa20-image.png)
</Frame>
...
<Frame>
![](/images/retailer-integration/q4-2025/docs/f6689c82a1452bbcaa43bdff9f1335ad394cbad59760f44a9b371a7a5d061819-image.png)
</Frame>

* If there is only one SKU (no Product Buttons), the **safety zone** is `180x190px`

<Frame>
![](/images/retailer-integration/q4-2025/docs/b393f938c6c2875f6265bcb7396a2e0e0f1a774cf1b5a1cfb648fca08e35bb09-image.png)
</Frame>
...
<Frame caption="CTA and legal text specifications for the Butterfly ad format">
  <img src="/images/retailer-integration/q4-2025/docs/d45109976cb1236a84c3aef3bfaa515020f7233bcca049982ef4e0cef3805d9f-image.png" />
</Frame>
...
<Frame caption="Spacing between buttons and base of branding zone with and without CTA button or Legal text.">
  <img src="/images/retailer-integration/q4-2025/docs/98f13771c02d469864a35447e98d4dc0fe9b71ce420c65c69ebbd453cf1dade1-BTF-compnents.png" />
</Frame>
...
| `mobile_logo_image`                 | URL of the logo image file for mobile                                                                                                                                                                                                                                                             |
| `mobile_logo_image_alt_text`        | Alternative text for mobile logo image                                                                                                                                                                                                                                                            |
| `border_color`                      | Hex code for the format's outline color                                                                                                                                                                                                                                                           |
| `background_color`                  | Hex code for the background color of the branding zone                                                                                                                                                                                                                                            |
| `button_color`                      | Product button color                                                                                                                                                                                                                                                                              |
| `selected_button_color`             | Selected product button color                                                                                                                                                                                                                                                                     |
| `button_text_color`                 | Product button text color                                                                                                                                                                                                                                                                         |
| `selected_button_text_color`        | Selected button text color                                                                                                                                                                                                                                                                        |
| `optional_footer_type`              | Option type. Can have the following values:<ul><li>`no-option`: no footer option</li><li>`redirection`: expect values in `optional_footer_redirect_url` and/or `optional_footer_redirect_url_app`)</li><li>`file`: expect values in `optional_footer_media_file`</li><li>`legal`: expect values in `optional_footer_text`</li></ul> |
| `optional_footer_text`              | Option text (non-applicable for mobile version)                                                                                                                                                                                                                                                   |
| `optional_footer_redirect_url`      | Web URL that the user is redirected to                                                                                                                                                                                                                                                            |
| `optional_footer_redirect_url_app`  | App deeplink that the user is redirected to                                                                                                                                                                                                                                                       |
| `optional_footer_redirect_target`   | Redirection target. Can have the following values:<ul><li>`_blank`: redirects to a new tab</li><li>`_self`: redirects in the same tab (only applicable for web)</li></ul>                                                                                                                                               |
| `optional_footer_media_file`        | URL of media file                                                                                                                                                                                                                                                                                 |
| `optional_footer_text_color`        | Option text color                                                                                                                                                                                                                                                                                 |
| `optional_footer_background_color`  | Option background color                                                                                                                                                                                                                                                                           |
...
| `isMandatory` | If `true`, the unit should only be rendered if **at least one** of the products in the `products` array is available.<br/>If `false`, the button can be ignored if no product in the `products` array is available.<br /><br />**Note:** This option is only relevant if you are check product availability in real time, before rendering the units.                    |

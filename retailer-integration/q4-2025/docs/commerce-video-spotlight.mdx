...
<Frame caption="Web (top) and mobile showcases (bottom) of the Commerce Video Spotlight format">
  <img src="/images/retailer-integration/q4-2025/docs/86438c4dccc0a97683489559f8e73f982a3303601a7db0bfea64e8762b4bffc7-CVS_fields.png" />
</Frame>
...
| Key                         | Description                                                                                                                                                                                                                                                                 |
| --------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `optional_legal_text`       | Legal text add-on for the video. Max 90 characters long including spaces.<ul><li>**Desktop**: visible when you hover the “i” icon on the video.</li><li>**Mobile and App**: visible at all times below the video.</li></ul>                                                                       |
| `optional_redirect_target`  | *(only applicable for web). Can be ignored if no `ClickThrough` link is provided in the VAST.*<br/>Redirection target, can have the following values:<ul><li>“`_blank`”: redirects to a new tab</li><li>“`_self`”: redirects in the same tab</li></ul>                                                  |
| `background_video_alt_text` | Video alternative text                                                                                                                                                                                                                                                      |
| `color_mode`                | There are two default settings for the legal text box, buttons, and options (`play/pause`; `mute/unmute`; legal text “i” icon) to ensure visibility over any video file provided.<br/>It can have one of the following values:<ul><li>`lightcommand`: #000000</li><li>`darkcommand`: #FFFFFF</li></ul> |
...
<Frame>
![](/images/retailer-integration/q4-2025/docs/d8b675a6f8f3da1405822917e8acf02a1c334d76bca6f4b3a6393cec37d321ff-CVS_general_desktop.png "FS_desktop.jpg")
</Frame>
...
<Frame>
![](/images/retailer-integration/q4-2025/docs/5ad838ffc44832d932b137a7da22f0d0adca0d876239e16f336f80c66fe809df-CVS_general_mobile.png)
</Frame>
...
<Frame>
![](/images/retailer-integration/q4-2025/docs/b7542f09805f9103899300f89b206b77d8eb725a75be6859c6984fb4d3fc2b22-CVS_general_desktop_hover-legal.png)
</Frame>

* When hovering the **(i)** icon, the legal text is displayed on top of the video like so:

<Frame>
![](/images/retailer-integration/q4-2025/docs/754be63655d5a14a46f097e50bd64730d8a2b82eff57ee722d2e6500c700c8c1-CVS_general_desktop_hover-legal_hovered.png)
</Frame>
...
<Frame>
![](/images/retailer-integration/q4-2025/docs/ee5fd6df419930a56fa9c5eca6e91d4c482457ad7010744112e9bc95c3c0d5e7-CVS_general_mobile-legal.png)
</Frame>
...
<Frame>
![](/images/retailer-integration/q4-2025/docs/2eafb6450f2d9e17fc14286bfcb444a1034894bfde9441d43171d1a876663058-CVS_color_mode.png)
</Frame>
...
<Frame caption="Placement width ≥  Fixed height of 250 px. The product zone adapts to the placement in width">
  <img src="/images/retailer-integration/q4-2025/docs/d62e0d75e79668f552b9ecdd0735ccbd7df941aa13a18a9d32b2795baf4696ef-CVS_888.png" />
...
<Frame caption="< placement width <  The branded zone and the product zone are the same size. The whole format scales to fit the placement in width. Height will vary.">
  <img src="/images/retailer-integration/q4-2025/docs/bd486271c5ecc4ed5336ea4dd2f3da9718e64bcf64d49a2f582f418142e87175-CVS_600-888.png" />
...
<Frame caption="< placement width <  The branded zone is 65% of the placement width. The product zone is 35% of the placement width. Height will vary.">
  <img src="/images/retailer-integration/q4-2025/docs/9fc2e7accee50b97f3eec02933d73b943c69a349a46fc39b066d5ecfedac56b9-CVS_445-600.png" />

  `445px``600px`
</Frame>

<Frame caption="Placement width <  The ad unit switches to mobile. Height will vary.">
  <img src="/images/retailer-integration/q4-2025/docs/f467585db743ab76dd38bec5da6d517cbc67697f9df67c1b454bb426bced08de-CVS_general_mobile.png" />
...
<Frame>
![](/images/retailer-integration/q4-2025/docs/9d22c2925ff537611d45918c5efe8b4f269bd622f87d6686ffef13e19b55d362-CVS_desktop_1_product.png)
</Frame>
...
* There is 10 px padding around each product listing.
  ...
  <Frame>
  ![](/images/retailer-integration/q4-2025/docs/8edcd2c553a81d84d73ecb3582ff4d88a7fdb44d285892c39382b7cddc7d6424-CVS_mobile_spacings.png)
  </Frame>
...
* When multiple products are available :
  ...
  * For the products on the left and right, 80% of the first product is in view and 20% of the secondary product is in view.
    ...
    <Frame>
    ![](/images/retailer-integration/q4-2025/docs/862aef0271540166b2ceffe402b646f348e39d5fbefb22afa6bc18c8a31c0eba-CVS_mobile_80_20.png)
    </Frame>

  * For the other products, 80% of the main product is in view and 10% of the products on each side are in view.

  <Frame>
  ![](/images/retailer-integration/q4-2025/docs/f63d0e00c422ba37a4750e62957b6476c9f0ca86abade792a03d30a9e0d8e917-CVS_mobile_10_80_10.png)
  </Frame>
...
<Frame>
![](/images/retailer-integration/q4-2025/docs/28347b1155b3d55857a170a2fd38e6b65ebe37016a2fa8901c5be06b1b2ba319-CVS_mobile_100.png)
</Frame>

...
<Info>
  **Which to choose?**
  ...
  Head this way for the [Feed upload guide](/retailer-integration/v1.1/docs/product-upload-guide), or this way for the [Product Importer API guide](/retailer-integration/v1.1/docs/product-importer-guide).
</Info>

...
We detail the general ad server requirements [below](/retailer-integration/q4-2025/docs/integration-process#general-ad-server-requirements), [API calls](/retailer-integration/q4-2025/docs/api-calls) , [response formats](/retailer-integration/q4-2025/docs/api-responses), as well as [how to use tokens](/retailer-integration/q4-2025/docs/using-tokens), and the [full detail of all API parameters](/retailer-integration/q4-2025/docs/api-parameters-1) in the **Requesting Ads** section.
...
We provide a [full format overview](/retailer-integration/q4-2025/docs/format-overview) and the details of the rendering for each format in the **Ad Rendering** section.
...
We provide [a general introduction](/retailer-integration/q4-2025/docs/introduction-1) about how we use beacons at Criteo, as well as [details on beacon types](/retailer-integration/q4-2025/docs/beacon-types), [the universal beacons feature](/retailer-integration/q4-2025/docs/legacy-universal-beacons), and [the BeaconSDK library](/retailer-integration/q4-2025/docs/beacon-sdk) in the **Ad Tracking** section.

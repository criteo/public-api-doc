...
<Info>
  **API endpoint**
  ...
  The field is also available within the External API, through the `Account` endpoint, as the `companyName`parameter. The API documentation details can be accessed [here](https://developers.criteo.com/retail-media/docs/accounts-endpoints).
</Info>

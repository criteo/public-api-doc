...
<Info>
  This guide is an addendum. Please refer to this page for a more comprehensive documentation: [OneTag for Retail Media Offsite.](https://developers.criteo.com/retailer-integration/v1.1/docs/onetag-for-offsite)
</Info>
...
The steps below details how to apply the needed changes and refer to the example code displayed [at the end of the section.](https://developers.criteo.com/retailer-integration/v1.1/docs/offsite-for-hybrid-apps#full-example)

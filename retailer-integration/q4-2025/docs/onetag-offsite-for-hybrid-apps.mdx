...
The steps below details how to apply the needed changes and refer to the example code displayed [at the end of the section.](/retailer-integration/q4-2025/docs/onetag-offsite-for-hybrid-apps#full-example)

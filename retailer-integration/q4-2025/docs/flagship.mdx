...
| `optional_footer_type`              | Can have the following values:<ul><li>`no-option`: no footer option</li><li>`redirection`: expect values in `optional_footer_redirect_url` and/or `optional_footer_redirect_url_app`)</li><li>`file`: expect values in `optional_footer_media_file`</li></ul> |

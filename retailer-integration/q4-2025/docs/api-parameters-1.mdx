...
**Description**: Store ID selected by the user when browsing the retailer’s site. It should match the store IDs in the product feed. See more details [here](https://developers.criteo.com/retailer-integration/docs/product-feed-parameters#additional-attributes).
...
**Description**: Change the verbosity level of product objects in the API response. See the [API Responses Guide](https://developers.criteo.com/retailer-integration/docs/api-responses#product-array-verbosity-levels) for examples of both levels of verbosity.

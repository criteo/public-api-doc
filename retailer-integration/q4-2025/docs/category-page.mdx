...
**Description**: The category or taxonomy of the page that the user is browsing. This value should match the `product_type_key` value in the products feed. See more details [here](https://developers.criteo.com/retailer-integration/docs/product-feed-parameters#product_type_key).

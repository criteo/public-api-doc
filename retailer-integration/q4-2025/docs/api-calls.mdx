...
Each page type is linked to valid values of the `event-type` parameter in the API call. More details can be found at [API Parameters](/retailer-integration/q4-2025/docs/api-parameters-1).
...
* [API responses](/retailer-integration/q4-2025/docs/api-responses)

...
<Warning>
  **Migrating from Legacy to Universal**
  ...
  We strongly recommend using Universal Beacons for new integrations. If you are already integrated with **Legacy beacons**, you can find [in this section](/retailer-integration/docs/legacy-universal-beacons#migrating-from-legacy-to-universal-beacons) information on how to migrate to **Universal beacons**.
</Warning>

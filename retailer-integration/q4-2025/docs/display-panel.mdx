...
| `redirect_target`                   | Redirection target, can have the following values:<ul><li>“\_blank”: redirects to a new tab</li><li>“\_self”: redirects in the same tab (only applicable for web)</li></ul> |

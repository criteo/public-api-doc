...
In this page you will find all the metrics and dimensions that are currently support with the [Revenue Report](/retail-media/v2025.04/docs/revenue-report-ssp). Please note that many of the metrics and dimensions listed here are currently supported only through the API.

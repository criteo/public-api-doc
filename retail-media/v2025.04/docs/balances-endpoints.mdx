...
2. [Balances](/retail-media/v2025.04/docs/balances)
...
<Info>
  ...
  Learn more about campaign management with our API [**here**](/retail-media/v2025.04/docs/balances)
</Info>
...
| `startDate`\*              | timestamp | Balance start date; if time zone is not set, will consider [Account](/retail-media/v2025.04/docs/account)'s time zone as defaultAccepted values: `yyyy-mm-ddThh:mm:ss±hh:mm`(in [ISO-8601](https://www.iso.org/iso-8601-date-and-time-format.html) ) Writeable? Y / Nullable? N                                                                    |
| `endDate`                  | timestamp | Balance end date; if time zone is not set, will consider [Account](/retail-media/v2025.04/docs/account)'s time zone as defaultAccepted values: `yyyy-mm-ddThh:mm:ss±hh:mm`(in [ISO-8601](https://www.iso.org/iso-8601-date-and-time-format.html) ) Default: if `null` or absent, balance will be available indefinitely Writeable? Y / Nullable? Y |
...
| Attribute | Data Type | Description                                                                                                                                             |
| --------- | --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `id`      | string    | [Campaign](/retail-media/v2025.04/docs/campaign) ID, respective to the campaign(s) currently appended to the balanceAccepted values: string of int64 Writeable? N / Nullable? N |
...
| Attribute | Data Type | Description                                                                                                                                                               |
| --------- | --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `id`      | string    | [Campaign](/retail-media/v2025.04/docs/campaign) ID, required to define to which campaign(s) the balance should be appended or deletedAccepted values: string of int64 Writeable? N / Nullable? N |
...
| 🔴 `403` | **Authorization error**                           | Resource access forbidden: does not have permissions                                                                   | One of the permission levels was not respected. Make sure that the respective API app has access to:- Read/Manage the domain "Balance" (depending on the requested action). Review the Types of Permissions in [Authorization Requests](/retail-media/v2025.04/docs/authorization-requests)

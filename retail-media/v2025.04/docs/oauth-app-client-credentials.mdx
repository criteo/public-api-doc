...
![](/images/retail-media/v2025.04/docs/ff276e4-image.png)
...
![](/images/retail-media/v2025.04/docs/ec2ea86-portal-_clientcreds1.gif)
...
2. For this setup, we are selecting "*Client Credentials*", but you can review our [OAuth App implementation](/retail-media/v2025.04/docs/oauth-app-implementation) guide to determine the best option for your organization.

![](/images/retail-media/v2025.04/docs/74936ae-client_credentials_option.png)
...
![](/images/retail-media/v2025.04/docs/544d9f0-image.png)
...
![](/images/retail-media/v2025.04/docs/b205ae3-consenturl.gif)

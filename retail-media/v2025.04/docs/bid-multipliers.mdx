...
| `aiAssistant`   | decimal   | Bid multiplier to the `aiAssistant` page type Note: bids can be increased up to 500% (6.0) or decreased up to 50% (0.50)Accepted values: `0.50` ≤ `aiAssistant` ≤ `6.0` Default: `1.0` Writeable? Y / Nullable? Y   |

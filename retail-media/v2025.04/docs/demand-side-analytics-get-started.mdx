...
| `reportType`             | enum                   | Report types are pre-packaged reports that allow the specification of the report breakdown. See [Report Types](/retail-media/v2025.04/docs/report-types) for more details about each of them.- \*Note\*\*: when `metrics` and `dimensions` are used, the `reportType` is ignored.Accepted values: refer to [Report Types](/retail-media/v2025.04/docs/report-types) page for a complete list of available values Writeable? N / Nullable? N                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
- when `metrics` and `dimensions` are used, the `reportType` is automatically ignoredAccepted values: refer to [Metrics and Dimensions](/retail-media/v2025.04/docs/metrics-and-dimensions) page for a complete list of available values Writeable? N / Nullable? N                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
- when including `winRate` metric, it is required to either define `campaignType` as `sponsoredProducts` or include `campaignTypeName` in the list of dimensionsAccepted values: refer to [Metrics and Dimensions](/retail-media/v2025.04/docs/metrics-and-dimensions) page for a complete list of available values Writeable? N / Nullable? N                                                                                                                                                                                                                                                                                                                                                                                     |
...
| `campaignType`           | enum                   | [Campaign](/retail-media/v2025.04/docs/campaign) typeAccepted values: `sponsoredProducts`, `onSiteDisplays` Writeable? N / Nullable? N                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
* [Metrics and Dimensions](/retail-media/v2025.04/docs/metrics-and-dimensions)

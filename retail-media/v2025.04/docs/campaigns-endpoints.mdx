...
| `drawableBalanceIds`       | list\<string> | List of [Balances](doc:balances) the campaign is able to draw from; at least one balance is required for a campaign to startAccepted values: list of `balanceId` Default: `[]` Writeable? N / Nullable? N                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |

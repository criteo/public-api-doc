---
title: "Brands"
openapi: "GET /2025-04/retail-media/accounts/{accountId}/brands"
---
...
<Info>
  **View in the API Reference**
  ...
  You can also check this endpoint in [the API reference](/retail-media/v2025.04/reference/campaign/accounts-get-v-1-external-account-brands-by-account-id).
</Info>

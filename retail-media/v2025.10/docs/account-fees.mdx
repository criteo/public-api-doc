...
You can find more details in the API reference for this endpoint [here](/retail-media/v2025.10/api-reference/accounts/account-fees-search).
...
This endpoint allows **Private Market retailers** to update fees for child seller or demand accounts. You can find more details about this endpoint in our API reference [here](/retail-media/v2025.10/api-reference/accounts/update-account-fees).

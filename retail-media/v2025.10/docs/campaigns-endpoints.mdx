 ...
 <tbody>
  ...
  <tr>
   ...
   <td>
    ...
    <ul>
     <li>
      _Invalid isautodailypacing_* - _Cannot turn on IsAutoDailyPacing and add a DailyPacing value_
     </li>
    </ul>
    <p>
    ...
    <ul>
     <li>
      _Invalid budget_* - _Budget is not allowed for the Preferred campaign._
     </li>
    </ul>
   </td>
  </tr>

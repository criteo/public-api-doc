  ...
  <tr>
   ...
   <td>
    ...
    <p>
     ...
     to be specified in the list of dimension or use
     <code>
      "campaignTypeName": "sponsoredProducts"
     </code>
     filter
    </p>
    <p>
...
<table>
 ...
 <tbody>
  ...
  <tr>
   ...
   <td>
    <p>
     ...
     <a href="/retail-media/v2025.10/docs/catalogs#catalog-product-attributes">
      Catalogs
     </a>
    </p>
   </td>
  ...
  <tr>
   ...
   <td>
    <p>
     Creative template name, (also referred as Ad Format).
    </p>
    <p>
  ...
  <tr>
   ...
   <td>
    <p>
     ...
     <a href="/retail-media/v2025.10/docs/onsite-sponsored-products#submited-keywords">
      normalized keyword
     </a>

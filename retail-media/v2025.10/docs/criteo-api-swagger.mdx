...
<Frame caption="The OpenAPI spec corresponding to the example URL above (2024-10 version, for retail media)">
  <img src="/images/retail-media/v2024.10/docs/2a5d468dbfb285354f1bfa8bfb704843e7a72b1493750c349b5ea9248da69f22-image.png" alt="The OpenAPI spec corresponding to the example URL above (2024-10 version, for retail media)" />
</Frame>
## What's next

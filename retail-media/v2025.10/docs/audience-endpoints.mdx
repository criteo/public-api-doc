...
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Retail_Media/v2025_10/docs/Guides for Retail Media API/audiences/audience-endpoints.md
---
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>string</td>
      <td><a href="/retail-media/v2025.10/docs/account">Account</a> ID associated with the Audience, generated internally by Criteo<br />Accepted values: string of int64<br />Writeable? N / Nullable? N</td>
    </tr>
    <tr>

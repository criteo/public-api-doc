...
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Retail_Media/v2025_10/docs/Guides for Retail Media API/onsite-sponsored-products/negative-keywords-open-auction-only.md
hidden: true
---

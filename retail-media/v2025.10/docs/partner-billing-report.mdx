...
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Retail_Media/v2025_10/docs/Guides for Retail Media API/billing/partner-billing-report.md
---
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>list</td>
      <td><a href="/retail-media/v2025.10/docs/retailers">Retailer</a> IDs<br />Accepted values: array of strings/int64<br />Writeable? N / Nullable? N</td>
    </tr>
    <tr>

...
| `campaignId`       | string    | [Campaign](doc:campaign) ID, in which the respective line item belongsAccepted values: string of int64 Writeable? N / Nullable? N                                                                                                                                                                                                                                                                                                                                                         |
| `type`             | enum      | [Campaign](doc:campaign) typeAccepted values: `auction`, `preferred` Writeable? Y / Nullable? N                                                                                                                                                                                                                                                                                                                                                                                           |
| `targetRetailerId` | string    | [Retailer](doc:retailers) ID, in which the respective line item serves ad onAccepted values: string of int64 Writeable? N / Nullable? N                                                                                                                                                                                                                                                                                                                                                   |
| `startDate`        | date      | Start date of the line item, in the [Account](doc:account) timezone; used to schedule its activation and start serving ads. To understand the conditions that will cause a status to change, check out [Campaign & Line Item Status](doc:campaign-lineitem-status)Accepted values: `yyyy-mm-dd` Writeable? Y / Nullable? N                                                                                                                                                                |
| `endDate`          | date      | End date of the line item, in the [Account](doc:account) timezone; serves ads indefinitely if omitted or set to `null`. A timestamp can be included as well if the line item is desired to end at a certain time of dayAccepted values: `yyyy-mm-ddThh:mm:ss±hh:mm` (in [ISO-8601](https://www.iso.org/iso-8601-date-and-time-format.html) ) Default: if `null` or absent, balance will be available indefinitely Writeable? Y / Nullable? Y                                              |

...
<Info>
  This guide assumes you have a **partner account** and **Organization & API application** created within Criteo. Instructions for getting started are available on [Getting connected to the API](doc:connect-to-the-api).
</Info>
...
![](/images/retail-media/v2025.10/docs/f9829c8-auth_methods2.png)
...
<Frame caption="Source:">
  <img src="/images/retail-media/v2025.10/docs/a324441-client_credentials_v2.png" />
...
For more information, check out the app setup process for [OAuth App - Client Credentials Setup](doc:oauth-app-client-credentials).
...
<Frame caption="Source:">
  <img src="/images/retail-media/v2025.10/docs/1c88391-authcodev4.png" />
...
For setup details, refer to [OAuth App - Authorization Code Setup](doc:oauth-app-authorization-code)

***

What’s Next

You can now dive into each specific setup by visiting the following pages:

* [OAuth App - Client Credentials Setup](https://developers.criteo.com/retail-media/v2023.10/docs/oauth-app-client-credentials)

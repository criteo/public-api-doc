...
![Source: [Auth0 - Client Credentials Flow](https://auth0.com/docs/get-started/authentication-and-authorization-flow/client-credentials-flow)](/images/retail-media/docs/a324441-client_credentials_v2.png)
...
![**Source**: [Auth0 - Authorization Code Flow](https://auth0.com/docs/get-started/authentication-and-authorization-flow/authorization-code-flow)](/images/retail-media/docs/1c88391-authcodev4.png)

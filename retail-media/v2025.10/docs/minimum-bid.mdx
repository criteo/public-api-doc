...
<Info>
  ...
  1. A [Onsite Sponsored Products](doc:onsite-sponsored-products) line item holds promoted products to advertise on a single retailer.
  ...
  4. Products SKU IDs are available through [Catalog](doc:catalogs) endpoints
</Info>
...
| --------------- | -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `retailerId`\*  | string         | [Retailer](doc:retailers) ID where the line item will serve ads onAccepted values: int64 Writeable? N / Nullable? N                                                                                                                         |
| `skuIds`\*      | list`<string>` | List of SKU IDs in which the minimum bid is requested (usually, the SKUs promoted by the line item). Values are available through [Catalog](doc:catalogs) endpointsAccepted values: at least, an empty list `[]` Writeable? N / Nullable? N |
...
[Budget Overrides](/retail-media/v2025.10/docs/budget-overrides)

[Demand Side Analytics (DSP)](/retail-media/v2025.10/docs/analytics)

...
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Retail_Media/v2025_10/docs/Concepts/consent-url-generation-old.md
hidden: true
---
...
These guides assume you have created a developer account, are part of an organization and have created an app. Instructions for getting started can be found [here](/retail-media/v2026-preview/docs/onboarding-checklist).
...
Example of POST Consent Callback body:

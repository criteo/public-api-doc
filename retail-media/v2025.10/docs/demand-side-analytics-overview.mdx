---
title: Overview
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Retail_Media/v2025_10/docs/Guides for Retail Media API/analytics/demand-side-analytics-overview.md
---

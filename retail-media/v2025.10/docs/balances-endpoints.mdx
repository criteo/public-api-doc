...
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Retail_Media/v2025_10/docs/Guides for Retail Media API/balances/balances-endpoints.md
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Balance start date; if time zone is not set, will consider <a href="/retail-media/v2025.10/docs/account">Account</a>'s time zone as default<br />Accepted values: <code>yyyy-mm-ddThh:mm:ss±hh:mm</code>(in <a href="https://www.iso.org/iso-8601-date-and-time-format.html">ISO-8601</a> )<br />Writeable? Y / Nullable? N</td>
    </tr>
    <tr>
      <td><code>endDate</code></td>
      <td><code>timestamp</code></td>
      <td>Balance end date; if time zone is not set, will consider <a href="/retail-media/v2025.10/docs/account">Account</a>'s time zone as default<br />Accepted values: <code>yyyy-mm-ddThh:mm:ss±hh:mm</code>(in <a href="https://www.iso.org/iso-8601-date-and-time-format.html">ISO-8601</a> )<br />Default: if <code>null</code> or absent, balance will be available indefinitely<br />Writeable? Y / Nullable? Y</td>
    </tr>
    <tr>
...
Results are paginated using `pageIndex` and `pageSize` query parameters; if omitted, defaults to `0` and `25`, respective - see [API Response](/retail-media/v2025.10/docs/api-response)
...
<table>
  ...
  <tbody>
    <tr>
      <td><code>id</code></td>
      <td><code>string</code></td>
      <td><a href="/retail-media/v2025.10/docs/campaign">Campaign</a> ID, respective to the campaign(s) currently appended to the balance<br />Accepted values: string of int64<br />Writeable? N / Nullable? N</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      <td><code>id</code></td>
      <td><code>string</code></td>
      <td><a href="/retail-media/v2025.10/docs/campaign">Campaign</a> ID, required to define to which campaign(s) the balance should be appended or deleted<br />Accepted values: string of int64<br />Writeable? N / Nullable? N</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>One of the permission levels was not respected. Make sure that the respective API app has access to:<br /><ul><li>Read/Manage the domain "Balance" (depending on the requested action). Review the Types of Permissions in <a href="/retail-media/v2025.10/docs/authorization-requests">Authorization Requests</a></li><li>the <code>accountId</code> or <code>balanceId</code> provided in the request</li></ul></td>
    </tr>
  </tbody>
</table>

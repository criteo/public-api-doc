...
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Retail_Media/v2025_10/docs/Guides for Retail Media API/onsite-display-line-items/index.md
hidden: true
---
...
* Several [reports](/retail-media/v2025.10/docs/demand-side-analytics-get-started) are available to measure line item performance
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>ID of the <a href="/retail-media/v2025.10/docs/retailers">retailer</a> the line item serves on</td>
      <td>int64</td>
      <td>R</td>
      <td>&#42;</td>
      <td>&#42;</td>

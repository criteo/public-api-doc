...
<Note>
  **Getting Started**
  ...
  4 - Several [reports](/retail-media/v2026.01/docs/demand-side-analytics-get-started) are available to measure line item performance\
...
<ParamField path="targetRetailerId" type="string" required>
  **Is Nullable?** -
  ...
  ID of the [retailer](/retail-media/v2026.01/docs/retailers) the line item serves on

...
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Retail_Media/v2026_01/docs/Resources/postman-collection.md
---
...
<Frame caption="Create a fork from your chosen Postman collection">
  <img src="/images/retail-media/v2026.01/docs/0c62e5b-Fork_collection.png" alt="Create a fork from your chosen Postman collection" />
</Frame>

<br />

<Frame caption="Add a label and a location to your local collection">
  <img src="/images/retail-media/v2026.01/docs/c74bc7d-Capture_decran_2022-01-20_a_17.48.44.png" alt="Add a label and a location to your local collection" />
</Frame>
...
<Frame caption="Collection of variables to be customized">
  <img src="/images/retail-media/v2026.01/docs/4d1b8d8-fork_env.png" alt="Collection of variables to be customized" />
</Frame>
...
<Frame caption="Ensure the environment is &amp;#x22;MyCriteoConnector&amp;#x22; in Postman">
  <img src="/images/retail-media/v2026.01/docs/ea55a20-nonoenv.png" alt="Ensure the environment is &amp;#x22;MyCriteoConnector&amp;#x22; in Postman" />
</Frame>
...
<Frame caption="Make your first call from the versioned folder">
  <img src="/images/retail-media/v2026.01/docs/26255ef-Capture_decran_2022-01-20_a_19.43.18.png" alt="Make your first call from the versioned folder" />
</Frame>
...
<Info>
  ...
  More information about error handling can be found in [API Response](/retail-media/v2026.01/docs/api-response).
</Info>

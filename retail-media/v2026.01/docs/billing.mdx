...
* Reports are generated at a [Line Items](/retail-media/v2026.01/docs/line-items) granularity, i.e., `Demand account` x `Campaign` x `Line-Item`
...
* [Partner Billing Report](/retail-media/v2026.01/docs/partner-billing-report)

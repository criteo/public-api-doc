...
The metrics definition of the Partner Billing Report is available in [PBR Metrics](/retail-media/v2026.01/docs/pbr-metrics)
...
* [PBR Metrics](/retail-media/v2026.01/docs/pbr-metrics)

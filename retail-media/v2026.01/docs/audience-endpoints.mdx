...
Audiences are built of one or multiple audience segments that can be combined using logical [Algebra Nodes](/retail-media/v2026.01/docs/algebra-nodes) to define target campaigns' audiences.
 ...
 <tbody>
  ...
  <tr>
   ...
   <td>
    ...
    <p>
     Accepted values: see
     <a href="/retail-media/v2026.01/docs/algebra-nodes">
      Algebra Nodes
     </a>
    </p>
    <p>
...
* [Audience Segment Endpoints](/retail-media/v2026.01/docs/audience-segment-endpoints)

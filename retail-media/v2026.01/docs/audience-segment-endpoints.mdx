...
Multiple **Audience Segments** can be combined using logical [Algebra Nodes](/retail-media/v2026.01/docs/algebra-nodes) to define the desired target audience for your campaigns.
...
<table>
 ...
 <tbody>
  ...
  <tr>
   ...
   <td>
    <p>
     <a href="/retail-media/v2026.01/docs/retailers">
      Retailer
     </a>
     ID, associated with the Audience Segment, generated internally by Criteo
    </p>

...
<Info>
  ...
  If your application is a mobile app, single-page app (SPA), or other public client that cannot securely store a client secret, you must use the [Authorization Code with PKCE](/retail-media/v2026.01/docs/oauth-app-authorization-code-pkce-setup) instead.
</Info>
...
<Frame>
![862451e image](/images/retail-media/v2026.01/docs/862451e-image.png)
</Frame>
...
* On your app page, you can define the scope of your application and OAuth parameters. For more details, please refer to [Getting connected to the API](/retail-media/v2026.01/docs/connect-to-the-api).

<Frame>
![abc222c portal _step1_1](/images/retail-media/v2026.01/docs/abc222c-portal-_step1_1.gif)
</Frame>
...
* For this setup, we are selecting "_Authorization Code_", but you can review our [OAuth App implementation](/retail-media/v2026.01/docs/oauth-app-implementation) guide to determine the best option for your organization.

<Frame>
![190da94 auth_methods](/images/retail-media/v2026.01/docs/190da94-auth_methods.png)
</Frame>
...
<Frame>
![4a14336 services](/images/retail-media/v2026.01/docs/4a14336-services.png)
</Frame>
...
<Frame>
![fb84380 portal _step4final_1](/images/retail-media/v2026.01/docs/fb84380-portal-_step4final_1.gif)
</Frame>
...
<Frame>
  <img src="/images/retail-media/v2026.01/docs/706af65-2023-06-30_14_57_56-My_First_App___Criteo_Developer_Portal.png" />
</Frame>
...
<Frame caption="The Criteo Consent page allows selecting the advertisers to grand access to">
  <img src="/images/retail-media/v2026.01/docs/0151441-consentgeneration3.png" alt="The Criteo Consent page allows selecting the advertisers to grand access to" />
</Frame>
...
* [OAuth App – Authorization Code & PKCE Setup](/retail-media/v2026.01/docs/oauth-app-authorization-code-pkce-setup)

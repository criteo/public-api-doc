...
import ReportTypesTable from "/snippets/retail-media/ReportTypesTable.mdx";
...
<Info>
  ...
  * [Demand Side Analytics (DSP)](/retail-media/v2026.01/docs/demand-side-analytics-get-started)
...
<Info>
  See [this page ](/retail-media/v2026.01/docs/metrics-and-dimensions)for the full list of available metrics and dimensions.
</Info>
...
* Reports support a maximum window of **100 days per request** for the campaigns and line items endpoints. For the [account reporting endpoint](/retail-media/v2026.01/docs/account-level-report), that window is **31 days max**.
* Use [bulk calls](/criteo-apis/docs/bulk-calls) to pass up to **50 IDs** at a time when pulling data across a large number of Campaigns or Line Items. Note that for [the account reporting endpoint](/retail-media/v2026.01/docs/account-level-report), that limit is only **5 IDs**.
...
* [DSP Analytics Endpoints](/retail-media/v2026.01/docs/demand-side-analytics-get-started)
* [Supply Side Analytics (SSP)](/retail-media/v2026.01/docs/supply-side-reporting-ssp)
* [Metrics and Dimensions (SSP)](/retail-media/v2026.01/docs/metrics-and-dimensions-ssp)
* [Metrics & Dimensions (Fill Rate Report)](/retail-media/v2026.01/docs/metrics-dimensions-fill-rate-report)
* [Metrics and Dimensions (DSP)](/retail-media/v2026.01/docs/metrics-and-dimensions)

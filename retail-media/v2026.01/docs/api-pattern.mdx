...
The technical definition of each resource type is contained in the machine-readable [OpenAPI specification](/retail-media/v2026.01/docs/criteo-api-swagger).
...
<Info>
  Please refer to[ this page](/retail-media/v2026.01/docs/bulk-calls) for more information about Bulk Calls.
</Info>

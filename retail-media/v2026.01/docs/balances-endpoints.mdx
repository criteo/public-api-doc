...
<Info>
  **Getting Started**
  ...
  Learn more about balances [here](/retail-media/v2026.01/docs/balances#/).
</Info>
...
<Warning>
  ...
  * All other new fields (`retailerId`, `privateMarketBillingType`) are additive. Retailer budgets are hidden by default on prior API versions.
  ...
  You can learn more about retailer budgets [on this page](/retail-media/v2026.01/docs/retailer-budgets).
</Warning>
...
<Warning>
  ...
  Learn more on retailer budgets [here](/retail-media/v2026.01/docs/retailer-billed).
...
Results are paginated using `pageIndex` and `pageSize` query parameters; if omitted, defaults to `0` and `25`, respective - see [API Response](/criteo-apis/docs/api-response)
...
<table>
 ...
 <tbody>
  <tr>
   ...
   <td>
    <p>
     <a href="/retail-media/v2026.01/docs/campaign">
      Campaign
     </a>

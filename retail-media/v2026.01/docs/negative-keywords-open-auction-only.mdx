...
```http
https://api.criteo.com/{version}/retail-media/auction-line-items/{lineItemId}/targeting/keywords
```
</EndpointBadge>
...
```http
https://api.criteo.com/{version}/retail-media/auction-line-items/{lineItemId}/targeting/keywords/append
```
</EndpointBadge>
...
<EndpointBadge method="post">
```http
https://api.criteo.com/{version}/retail-media/auction-line-items/{lineItemId}/targeting/keywords/delete
```
</EndpointBadge>

...
<Info>
  **Getting Started**
  ...
  4. Several [reports](/retail-media/v2026.01/docs/demand-side-analytics-get-started) are available to track line item performance.
...
<table>
 ...
 <tbody>
  ...
  <tr>
   ...
   <td>
    <p>
     Start date of the line item, in the <a href="/retail-media/v2026.01/docs/account">Account</a> timezone; used to schedule its activation and start serving ads.
    </p>
    <p>
  ...
  <tr>
   ...
   <td>
    <p>
     End date of the line item, in the <a href="/retail-media/v2026.01/docs/account">Account</a> timezone; serves ads indefinitely if omitted or set to
     <code>
      null
     </code>
     .

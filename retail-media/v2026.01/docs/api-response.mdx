...
The technical definition of each response type is contained in the machine-readable [OpenAPI specification](/retail-media/v2026.01/docs/criteo-api-swagger). The `type` field inside `errors` is different: it identifies the error category, such as `validation`.
...
* [API Pattern](/retail-media/v2026.01/docs/api-pattern)
* [Bulk Calls](/retail-media/v2026.01/docs/bulk-calls)
...
* [Rate Limits](/retail-media/v2026.01/docs/rate-limits)

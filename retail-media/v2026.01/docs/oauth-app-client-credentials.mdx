...
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Retail_Media/v2026_01/docs/Getting Started/oauth-app-implementation/oauth-app-client-credentials.md
description: This guide provides step-by-step instructions on setting up an API application using the client credentials workflow
---
...
<Frame>
![ff276e4 image](/images/retail-media/v2026.01/docs/ff276e4-image.png)
</Frame>
...
<Frame>
![ec2ea86 portal _clientcreds1](/images/retail-media/v2026.01/docs/ec2ea86-portal-_clientcreds1.gif)
</Frame>
...
2. For this setup, we are selecting "_Client Credentials_", but you can review our [OAuth App implementation](/retail-media/v2026.01/docs/oauth-app-implementation) guide to determine the best option for your organization.

<Frame>
![74936ae client_credentials_option](/images/retail-media/v2026.01/docs/74936ae-client_credentials_option.png)
</Frame>
...
<Frame>
![544d9f0 image](/images/retail-media/v2026.01/docs/544d9f0-image.png)
</Frame>
...
<Frame>
![b205ae3 consenturl](/images/retail-media/v2026.01/docs/b205ae3-consenturl.gif)
</Frame>

...
1. An [Onsite Sponsored Products](/retail-media/v2026.01/docs/onsite-sponsored-products) line item holds promoted products to advertise on a single retailer.
...
4. Products SKU IDs are available through [Catalog](/retail-media/v2026.01/docs/catalogs) endpoints.
...
* [Demand Side Analytics (DSP)](/retail-media/v2026.01/docs/analytics)

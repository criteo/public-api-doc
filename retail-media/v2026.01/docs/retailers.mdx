...
A retailer typically allows multiples types of pages to be targeted. A *page* is an inventory that can be targeted by [Campaigns](/retail-media/v2026.01/docs/campaign) and [Line Items](/retail-media/v2026.01/docs/line-items) with specific configurations.
...
| 🔴`403`  | API user does not have the authorization to make requests to the account ID. For an authorization request, follow the steps indicated here: [authorization request](/retail-media/v2026.01/docs/authorization-requests) |
...
* [Retailer Search](/retail-media/v2026.01/docs/retailer-search)

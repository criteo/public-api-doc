...
Once you have [created your organization](/retail-media/v2026.01/docs/create-your-organization), you can access the `My Apps` page to begin creating your application. This page is also where you will manage your Criteo API applications.
...
* Criteo’s API supports two OAuth authentication methods: [Client Credentials](/retail-media/v2026.01/docs/oauth-app-client-credentials) and [Authorization Code](/retail-media/v2026.01/docs/oauth-app-authorization-code). Each method has its own advantages, so before proceeding, we strongly recommend reviewing which authentication method is best suited to your application’s needs.

<Frame>
![2ce3350 auth_methods2](/images/retail-media/v2026.01/docs/2ce3350-auth_methods2.png)
</Frame>

<Info>
  **Trying to decide which OAuth method is right for you?**

  If you're unsure which authentication method to use, take a look at our [OAuth App Implementation](/retail-media/v2026.01/docs/oauth-app-implementation) guide for an overview of each authentication method.
</Info>
...
<Frame>
![6c1fa6d portal _step3_1](/images/retail-media/v2026.01/docs/6c1fa6d-portal-_step3_1.gif)
</Frame>
...
<Frame>
![e78d65c9adb193a529a09e1b7fae330694c8941d1cd8a4d3d0af11fde3d33824 Google_Chrome_2025 01 28_11.46.31](/images/retail-media/v2026.01/docs/e78d65c9adb193a529a09e1b7fae330694c8941d1cd8a4d3d0af11fde3d33824-Google_Chrome_2025-01-28_11.46.31.png)
</Frame>
...
* [Manage Your Account, Organization and Apps](/retail-media/v2026.01/docs/developer-accounts-organizations-apps)

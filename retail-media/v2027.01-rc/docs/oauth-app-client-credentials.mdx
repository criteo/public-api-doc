...
2. For this setup, we are selecting "_Client Credentials_", but you can review our [OAuth App implementation](/retail-media/v2027.01-rc/docs/oauth-app-implementation) guide to determine the best option for your organization.

...
<Info>
  **Get Started**
  ...
  Learn more about how open auction line items work with our API in [Onsite Sponsored Products](/retail-media/v2027.01-rc/docs/onsite-sponsored-products).
</Info>
 ...
 <tbody>
  ...
  <tr>
   ...
   <td>
    ...
    <p>
     ⚠️ <b>Note:</b> <code>keywordStrategy</code> cannot be modified after the line item is created.
    </p>
    <p>
     Accepted values:
    </p>
...
<Warning>
  **Retailer Budgets Campaigns**
  ...
  Learn more about Retailer Budgets [here](/retail-media/v2027.01-rc/docs/retailer-budgets).

...
For more info, check [OAuth App Implementation](/retail-media/v2027.01-rc/docs/oauth-app-implementation).
...
* [API Response](/retail-media/v2027.01-rc/docs/api-response)

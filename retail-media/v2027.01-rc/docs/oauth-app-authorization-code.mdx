...
<Info>
  ...
  If your application is a mobile app, single-page app (SPA), or other public client that cannot securely store a client secret, you must use the [Authorization Code with PKCE](/retail-media/v2027.01-rc/docs/oauth-app-authorization-code-pkce-setup) instead.
</Info>
...
* On your app page, you can define the scope of your application and OAuth parameters. For more details, please refer to [Getting connected to the API](/retail-media/v2027.01-rc/docs/connect-to-the-api).
...
* For this setup, we are selecting "_Authorization Code_", but you can review our [OAuth App implementation](/retail-media/v2027.01-rc/docs/oauth-app-implementation) guide to determine the best option for your organization.
...
<Frame>
  <img src="/images/retail-media/docs/706af65-2023-06-30_14_57_56-My_First_App___Criteo_Developer_Portal.png" />
</Frame>
...
* [OAuth App – Authorization Code & PKCE Setup](/retail-media/v2027.01-rc/docs/oauth-app-authorization-code-pkce-setup)

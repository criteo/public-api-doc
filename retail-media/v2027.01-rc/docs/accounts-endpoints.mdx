...
<Info>
  **View in the API Reference**
  ...
  You can also see this endpoint in the [API reference](/retail-media/v2027.01-rc/reference/authorization/get-token).
</Info>
...
* [Account Creation and Management (Private Market)](/retail-media/v2027.01-rc/docs/account-creation-and-management-private-market)
* [Account Fees (Private Market)](/retail-media/v2027.01-rc/docs/account-fees)
* [Brands](/retail-media/v2027.01-rc/docs/brands)
* [Sellers](/retail-media/v2027.01-rc/docs/sellers)

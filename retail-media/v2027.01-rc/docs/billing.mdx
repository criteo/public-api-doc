...
* Reports are generated at a [Line Items](/retail-media/v2027.01-rc/docs/line-items) granularity, i.e., `Demand account` x `Campaign` x `Line-Item`
...
* [Partner Billing Report](/retail-media/v2027.01-rc/docs/partner-billing-report)

...
The endpoint supports asynchronous report generation and provides access to the same set of [metrics and dimensions ](/retail-media/v2027.01-rc/docs/metrics-and-dimensions#/).

<Info>
  You can find the list of DSP endpoints available here: [Demand Side Analytics Endpoints](/retail-media/v2027.01-rc/docs/demand-side-analytics-get-started).
</Info>

...
<Info>
  This guide assumes you have a **partner account** and **Organization & API application** created within Criteo. Instructions for getting started are available on [Getting connected to the API](/retail-media/v2027.01-rc/docs/connect-to-the-api).
</Info>
...
<Frame>
![f9829c8 auth_methods2](/images/retail-media/docs/f9829c8-auth_methods2.png)
</Frame>
...
<Frame caption="Source: [Auth0 - Client Credentials Flow](https://auth0.com/docs/get-started/authentication-and-authorization-flow/client-credentials-flow)">
  <img src="/images/retail-media/docs/a324441-client_credentials_v2.png" alt="Source: [Auth0 - Client Credentials Flow](https://auth0.com/docs/get-started/authentication-and-authorization-flow/client-credentials-flow)" />
</Frame>
...
For more information, check out the app setup process for [OAuth App - Client Credentials Setup](/retail-media/v2027.01-rc/docs/oauth-app-client-credentials).
...
<Frame caption="**Source**: [Auth0 - Authorization Code Flow](https://auth0.com/docs/get-started/authentication-and-authorization-flow/authorization-code-flow)">
  <img src="/images/retail-media/docs/1c88391-authcodev4.png" alt="**Source**: [Auth0 - Authorization Code Flow](https://auth0.com/docs/get-started/authentication-and-authorization-flow/authorization-code-flow)" />
</Frame>
...
For setup details, refer to [OAuth App - Authorization Code Setup](/retail-media/v2027.01-rc/docs/oauth-app-authorization-code)
...
* [OAuth App - Authorization Code Setup](/retail-media/v2027.01-rc/docs/oauth-app-authorization-code)

...
Audiences are built of one or multiple audience segments that can be combined using logical [Algebra Nodes](/retail-media/v2027.01-rc/docs/algebra-nodes) to define target campaigns' audiences.
...
* [Audience Segment Endpoints](/retail-media/v2027.01-rc/docs/audience-segment-endpoints)

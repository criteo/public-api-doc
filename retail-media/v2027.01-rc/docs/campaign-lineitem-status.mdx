 ...
 <tbody>
  <tr>
   ...
   <td>
    ...
    <p>
     ⚠️ <b>Note:</b> Temporary budget caps (hourly, daily, or monthly) do <b>not</b> change the campaign status to <code>inactive</code>. The campaign remains <code>active</code> while a temporary cap is in effect; only a total lifetime budget exhaustion results in <code>inactive</code>.
    </p>
   </td>
  </tr>
  <tr>
...
* [API Client Libraries](/retail-media/v2027.01-rc/docs/api-client-libraries)

...
A retailer typically allows multiples types of pages to be targeted. A *page* is an inventory that can be targeted by [Campaigns](/retail-media/v2027.01-rc/docs/campaign) and [Line Items](/retail-media/v2027.01-rc/docs/line-items) with specific configurations.
...
<Info>
  **API reference**
  ...
  You can find this endpoint in [the API reference](/retail-media/v2027.01-rc/reference/authorization/get-token) as well.
</Info>
...
| 🔴`403`  | API user does not have the authorization to make requests to the account ID. For an authorization request, follow the steps indicated here: [authorization request](/retail-media/v2027.01-rc/docs/authorization-requests) |
...
* [Retailer Search](/retail-media/v2027.01-rc/docs/retailer-search)

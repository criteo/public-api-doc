  ...
  <tr>
   ...
   <td>
    ...
    <p>
     ...
     <a href="/retail-media/docs/campaigns-endpoints">
      Campaign
     </a>
...
<Info>
  **Metrics and Dimensions**
  ...
  For a complete list of all supported metrics and dimension, check out the [Metrics and Dimensions](/retail-media/v2027.01-rc/docs/metrics-and-dimensions-ssp)
</Info>

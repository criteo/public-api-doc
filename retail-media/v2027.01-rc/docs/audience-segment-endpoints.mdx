...
Multiple **Audience Segments** can be combined using logical [Algebra Nodes](/retail-media/v2027.01-rc/docs/algebra-nodes) to define the desired target audience for your campaigns.

...
Once you have [created your organization](/retail-media/v2027.01-rc/docs/create-your-organization), you can access the `My Apps` page to begin creating your application. This page is also where you will manage your Criteo API applications.
...
* Criteo’s API supports two OAuth authentication methods: [Client Credentials](/retail-media/v2027.01-rc/docs/oauth-app-client-credentials) and [Authorization Code](/retail-media/v2027.01-rc/docs/oauth-app-authorization-code). Each method has its own advantages, so before proceeding, we strongly recommend reviewing which authentication method is best suited to your application’s needs.
...
<Info>
  **Trying to decide which OAuth method is right for you?**
  ...
  If you're unsure which authentication method to use, take a look at our [OAuth App Implementation](/retail-media/v2027.01-rc/docs/oauth-app-implementation) guide for an overview of each authentication method.
</Info>
...
* [Manage Your Account, Organization and Apps](/retail-media/v2027.01-rc/docs/developer-accounts-organizations-apps)

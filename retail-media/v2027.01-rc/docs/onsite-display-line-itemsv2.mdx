...
<Note>
  **Getting Started**
  ...
  4 - Several [reports](/retail-media/v2027.01-rc/docs/demand-side-analytics-get-started) are available to measure line item performance\
...
<ParamField path="targetRetailerId" type="string" required>
  **Is Nullable?** -
  ...
  ID of the [retailer](/retail-media/v2027.01-rc/docs/retailers) the line item serves on

...
* [Revenue Report](/retail-media/v2027.01-rc/docs/revenue-report-ssp): provides attributed performance data from campaigns.
* [Fill Rate Report](/retail-media/v2027.01-rc/docs/fill-rate-report): provides summary of placement opportunities and impression filled and covered in retailer(s) inventory.

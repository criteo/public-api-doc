...
description: Manage product availability and pricing at the store level using the Store Inventory API
---
...
<Info>
  You can also find the Store Inventory endpoints in our API Reference for [`upsert`](/retail-media/v2027.01-rc/reference/catalog/upsert-store-inventory-per-merchant-id) and [`delete`](/retail-media/v2027.01-rc/reference/catalog/delete-store-inventory-per-merchant-id).
</Info>

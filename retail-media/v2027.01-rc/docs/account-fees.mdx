...
You can find more details in the API reference for this endpoint [here](/retail-media/v2027.01-rc/reference/accounts/account-fees-search).
...
<table>
 ...
 <tbody>
  <tr>
   ...
   <td>
    <p>
     Pagination parameter, see <a href="/criteo-apis/docs/api-response">API Response</a>
    </p>
   </td>
  </tr>
  <tr>
...
This endpoint allows **Private Market retailers** to update fees for child seller or demand accounts. You can find more details about this endpoint in our API reference [here](/retail-media/v2027.01-rc/reference/accounts/update-account-fees).

...
<Info>
  Once your request is submitted, the API responds with an `operationToken` that can be used to track processing status. See below for[ response examples](/retail-media/experimental/docs/product-importer-examples#response) and result reporting.
</Info>

<Info>
  For details on how to structure individual `product` objects, see the [examples](/retail-media/experimental/docs/product-importer-examples#examples-for-the-batch-endpoint) section below.
</Info>
  ...
  "errors" : [
    {
      ...
      "type" : "validation",
      "code" : "required-field",
      "instance" : "/experimental/retail-media/catalog/products/batch",
...
```http HTTP
HTTP GET /experimental/retail-media/catalog/products/batch/report/eyJhbGciOiJub25lIn0.eyJwYXJ0bmVySWQiOjEyLCJvcGVyYXRpb25JZCI6IjQyOTUyMzFmLWVmYTMtNDQzMy05NjA4LWI0ZDdkZTJjOThiNyIsImV4cCI6MTYxNjE0NTEzNX0.
```
...
```http HTTP
HTTP GET /experimental/retail-media/catalog/products/batch/report/invalidToken
```
  ...
  "errors" : [
    {
      ...
      "instance" : "/experimental/retail-media/catalog/products/batch/report/invalidToken",
...
```http HTTP
HTTP GET /experimental/retail-media/catalog/products/batch/report/eyJhbGciOiJub25lIn0.eyJwYXJ0bmVySWQiOjEyLCJvcGVyYXRpb25JZCI6ImM2NjliZmM1LTYzMWEtNDE3Mi05ODhiLTM0OTdlZDg3OThmZiIsImV4cCI6MTYxNjE0NTEzNX0.
```
  ...
  "errors" : [
    {
      ...
      "type" : "authorization",
      "code" : "not-authorized",
      "instance" : "/experimental/retail-media/catalog/products/batch/report/eyJhbGciOiJub25lIn0.eyJwYXJ0bmVySWQiOjEsIm9wZXJhdGlvbklkIjoib3BlcmF0aW9uX2lkX3Rlc3QiLCJleHAiOjE2MTYwNjEwMTN9.",
      "title" : "User is not authorized",
      "detail" : ""
    }
  ],
  ...
  "errors" : [
    {
      ...
      "instance" : "/experimental/retail-media/catalog/products/batch/report/eyJhbGciOiJub25lIn0.eyJwYXJ0bmVySWQiOjEyLCJvcGVyYXRpb25JZCI6ImM2NjliZmM1LTYzMWEtNDE3Mi05ODhiLTM0OTdlZDg3OThmZiIsImV4cCI6MTYxNjE0NTEzNX0.",
...
* [Catalog Endpoints](/retail-media/experimental/docs/catalog-endpoints)

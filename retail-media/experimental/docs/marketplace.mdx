...
```http
https://api.criteo.com/experimental/retail-media/retailers/{retailer-id}/products/set-buy-box-winners
```
</EndpointBadge>
...
<EndpointBadge method="post">
```http
https://api.criteo.com/experimental/retail-media/retailers/{retailer-id}/offers/update
```
</EndpointBadge>

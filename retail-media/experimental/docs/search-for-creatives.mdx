...
import FieldDefinitionsCallout from "/snippets/retail-media/FieldDefinitions.mdx";
...
* `/retail-media/accounts/:account-id/creatives`documented [here](/retail-media/experimental/reference/campaign/create-creative),
* `/retail-media/accounts/:account-id/creatives/:creative-id`documented [here](/retail-media/experimental/reference/campaign/get-creative),
* `/retail-media/accounts/:account-id/creatives/search?creative-ids=<string>&creative-ids=<string>`documented [here](/retail-media/experimental/reference/campaign/search-account-creatives).
...
```http
https://api.criteo.com/experimental/retail-media/accounts/{externalAccountId}/creatives/search
```
</EndpointBadge>
...
| --- | --- | --- |
| `metadata.count` | integer | Total number of creatives matching the search filters. |
| `metadata.offset` | integer | Offset applied to this page of results. |
| `metadata.limit` | integer | Maximum number of results returned per page. |

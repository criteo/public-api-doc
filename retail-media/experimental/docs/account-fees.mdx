 ...
 <tbody>
  <tr>
   ...
   <td>
    <p>
     <code>
      /experimental/retail-media/accounts/fees/search
     </code>
    </p>
   </td>
   <td>
  ...
  <tr>
   ...
   <td>
    <p>
     <code>
      /experimental/retail-media/accounts/fees/update
     </code>
    </p>
   </td>
   <td>
...
```http
https://api.criteo.com/experimental/retail-media/accounts/fees/search
```
</EndpointBadge>
...
<EndpointBadge method="post">
```http
https://api.criteo.com/experimental/retail-media/accounts/fees/update
```
</EndpointBadge>

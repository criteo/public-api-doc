...
3. Products SKU IDs are available through [Catalog](/retail-media/experimental/docs/catalogs) endpoints
...
<table>
 ...
 <tbody>
  ...
  <tr>
   ...
   <td>
    <p>
     List of product IDs (optional), from Retailer's <a href="/retail-media/experimental/docs/catalogs">Catalog</a>, that are intended to be attached to the creatives (usually, the SKUs promoted by the line item), to properly identify the Minimum Bid for the respective scenario of ads impressions
    </p>
    <p>
...
```http
https://api.criteo.com/experimental/retailers/{retailerId}/compute-display-min-bid
```
</EndpointBadge>
...
```bash cURL
curl -L -X POST "https://api.criteo.com/experimental/retail-media/retailers/12345/compute-display-min-bid" \
...
url = "https://api.criteo.com/experimental/retail-media/retailers/12345/compute-display-min-bid"
...
$request->setUrl('https://api.criteo.com/experimental/retail-media/retailers/12345/compute-display-min-bid');

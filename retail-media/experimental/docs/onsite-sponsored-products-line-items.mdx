...
<Warning>
  **These endpoints are available in the stable Retail Media API.** We recommend using [Retail Media 2026.07](/retail-media/docs/welcome-to-criteo) instead of the experimental version. In your API calls, replace `/experimental/` with `/2026-07/`.
</Warning>

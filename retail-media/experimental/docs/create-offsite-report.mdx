...
We added a "create an offsite report request", in the experimental version that is described below.
  ...
  <tr>
   ...
   <td>
    <p>
     ...
     <a href="/retail-media/experimental/docs/report-types">
      Report Types
     </a>
...
* [Retail Media Insights (Share of Voice)](/retail-media/experimental/docs/retail-media-insights-share-of-voice)

 ...
 <tbody>
  <tr>
   ...
   <td>
    <p>
     <code>
      /experimental/retail-media/retailers/&#123;retailerId&#125;/categories/search
     </code>
    </p>
   </td>
   <td>
...
```http
https://api.criteo.com/experimental/retail-media/retailers/{retailerId}/categories/search
```
</EndpointBadge>
...
```bash
curl -L -X POST 'https://api.criteo.com/experimental/retail-media/retailers/12345/categories/search?offset=0&limit=50' \

 ...
 <tbody>
  <tr>
   ...
   <td>
    <p>
     <code>
      /experimental/retail-media/retailers/&#123;retailerId&#125;/recommend-keywords
     </code>
    </p>
   </td>
   <td>
...
```http
https://api.criteo.com/experimental/retail-media/retailers/{retailerId}/recommend-keywords
```
</EndpointBadge>
...
```bash
curl -L -X POST 'https://api.criteo.com/experimental/retail-media/retailers/12345/recommend-keywords' \

...
<Info>
  **Partial Approvals**
  ...
  Bulk operations (`create`, `update`, `delete`) use a **partial approval model**. Even if some items in the request fail, the response will return `200 OK`. Any failed items will be listed in the `error` section of the response with [an error code and details](/retail-media/experimental/docs/audiences-endpoints#errors).
...
```http
https://api.criteo.com/experimental/retail-media/accounts/{account-id}/audiences/create
```
</EndpointBadge>
...
curl -L -X POST 'https://api.criteo.com/experimental/retail-media/accounts/625702934721171442/audiences/create' \
...
conn.request("POST", "https://api.criteo.com/experimental/retail-media/accounts/625702934721171442/audiences/create", payload, headers)
...
Request request = new Request.Builder()
  .url("https://api.criteo.com/experimental/retail-media/accounts/625702934721171442/audiences/create")
  .method("POST", body)
...
$request->setUrl('https://api.criteo.com/experimental/retail-media/accounts/625702934721171442/audiences/create');
...
```http
https://api.criteo.com/experimental/retail-media/accounts/{account-id}/audiences
```
</EndpointBadge>
...
```json JSON expandable
curl -L -X PATCH 'https://api.criteo.com/experimental/retail-media/accounts/625702934721171442/audiences' \
-H 'Content-Type: application/json' \
-H 'Accept: application/json' \
-H 'Authorization: Bearer <MY_ACCESS_TOKEN>' \
-d '{
...
conn.request("PATCH", "https://api.criteo.com/experimental/retail-media/accounts/625702934721171442/audiences", payload, headers)
res = conn.getresponse()
data = res.read()
print(data.decode("utf-8"))
```
...
Request request = new Request.Builder()
  .url("https://api.criteo.com/experimental/retail-media/accounts/625702934721171442/audiences")
  .method("PATCH", body)
  .addHeader("Content-Type", "application/json")
  .addHeader("Accept", "application/json")
  .addHeader("Authorization", "Bearer &lt;TOKEN&gt;")
...
require_once 'HTTP/Request2.php';
$request = new HTTP_Request2();
$request->setUrl('https://api.criteo.com/experimental/retail-media/accounts/625702934721171442/audiences');
...
<EndpointBadge method="post">
```http
https://api.criteo.com/experimental/retail-media/accounts/{account-id}/audiences/delete
```
</EndpointBadge>
...
```json JSON
curl -L -X POST 'https://api.criteo.com/experimental/retail-media/accounts/625702934721171442/audiences/delete' \
-H 'Content-Type: application/json' \
-H 'Accept: application/json' \
-H 'Authorization: Bearer <MY_ACCESS_TOKEN>' \
-d '{
...
conn.request("POST", "/experimental/retail-media/accounts/625702934721171442/audiences/delete", payload, headers)
res = conn.getresponse()
data = res.read()
print(data.decode("utf-8"))
```
...
Request request = new Request.Builder()
  .url("https://api.criteo.com/experimental/retail-media/accounts/625702934721171442/audiences/delete")
  .method("POST", body)
  .addHeader("Content-Type", "application/json")
  .addHeader("Accept", "application/json")
  .addHeader("Authorization", "Bearer &lt;TOKEN&gt;")
...
require_once 'HTTP/Request2.php';
$request = new HTTP_Request2();
$request->setUrl('https://api.criteo.com/experimental/retail-media/accounts/625702934721171442/audiences/delete');
$request->setMethod(HTTP_Request2::METHOD_POST);
$request->setConfig(array(
  'follow_redirects' => TRUE
));
...
* [Audience Segments Endpoints](/retail-media/experimental/docs/audience-segments)
* [Audiences Size](/retail-media/experimental/docs/audience-size)
* [Audience Segments Size](/retail-media/experimental/docs/audience-segments-size)

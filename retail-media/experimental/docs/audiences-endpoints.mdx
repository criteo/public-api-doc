...
```http
https://api.criteo.com/experimental/retail-media/accounts/{accountId}/audiences/create
```
</EndpointBadge>
...
```http
https://api.criteo.com/experimental/retail-media/accounts/{accountId}/audiences
```
</EndpointBadge>
...
<EndpointBadge method="post">
```http
https://api.criteo.com/experimental/retail-media/accounts/{accountId}/audiences/delete
```
</EndpointBadge>

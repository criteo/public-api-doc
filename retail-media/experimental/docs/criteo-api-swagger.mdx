...
```http
 https://api.criteo.com/experimental/{criteo-service}/open-api-specifications.json
```
...
For example, the URL below will download the specification for the Retail Media's experimental version:

```http
https://api.criteo.com/experimental/retailmedia/open-api-specifications.json
```

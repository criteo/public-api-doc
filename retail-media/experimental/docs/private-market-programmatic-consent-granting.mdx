...
<Frame>
  <img src="/images/retail-media/experimental/docs/32dfbf3-image.png" />
</Frame>
...
4. Select all relevant authorizations domains that your users will need to access and Activate App. 
   ...
   <Frame>
     <img src="/images/retail-media/experimental/docs/2ecd77e-image.png" />
   </Frame>
...
```sh
curl -L 'https://api.criteo.com/experimental/retail-media/accounts/{demand-account-id}/grant-consent' \
...
info:
  ...
  version: '1'
paths:
  /experimental/retail-media/accounts/{accountId}/grant-consent:
    post:
      tags:

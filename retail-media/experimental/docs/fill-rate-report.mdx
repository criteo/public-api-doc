...
```http
https://api.criteo.com/experimental/retail-media/reports/fillrate
```
</EndpointBadge>
...
```http
https://api.criteo.com/experimental/retail-media/reports/unfilled-placements
```
...
```bash
curl -L 'https://api.criteo.com/experimental/retail-media/reports/5f148e12-fba3-432e-b0d5-fe316xxxxx/status' \
...
```bash
curl -X GET "https://api.criteo.com/experimental/retail-media/reports/2e733b8c-9983-4237-aab9-17a4xxxxxx/output" \
-H "Authorization: Bearer <MY_ACCESS_TOKEN>"
```

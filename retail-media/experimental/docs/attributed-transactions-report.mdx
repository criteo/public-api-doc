...
<Info>
  **This is not a performance report.** Aggregated metrics — impressions, clicks, spend, attributed sales totals — are not available here. Use [`POST /reports/performance`](/retail-media/experimental/docs/performance-report) for those.
</Info>

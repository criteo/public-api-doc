...
```http
https://api.criteo.com/experimental/retail-media/accounts/{accountId}/audience-segments/compute-sizes
```
</EndpointBadge>
...
conn.request("POST", "/experimental/retail-media/accounts/625702934721171442/audience-segments/compute-sizes", payload, headers)
...
Request request = new Request.Builder()
  .url("https://api.criteo.com/experimental/retail-media/accounts/625702934721171442/audience-segments/compute-sizes")
  .method("POST", body)
...
$request->setUrl('https://api.criteo.com/experimental/retail-media/accounts/625702934721171442/audience-segments/compute-sizes');
...
<EndpointBadge method="post">
```http
https://api.criteo.com/experimental/retail-media/accounts/{accountId}/audience-segments/estimate-size
```
</EndpointBadge>
...
```bash cURL
curl -L -X POST 'https://api.criteo.com/experimental/retail-media/accounts/625702934721171442/audience-segments/estimate-size' \
  -H 'Content-Type: application/json' \
  -H 'Accept: application/json' \
  -H 'Authorization: Bearer <MY_ACCESS_TOKEN>' \
  -d '{
...
conn.request("POST", "/experimental/retail-media/accounts/625702934721171442/audience-segments/estimate-size", payload, headers)
res = conn.getresponse()
data = res.read()
print(data.decode("utf-8"))
```
...
Request request = new Request.Builder()
  .url("https://api.criteo.com/experimental/retail-media/accounts/625702934721171442/audience-segments/estimate-size")
  .method("POST", body)
  .addHeader("Content-Type", "application/json")
  .addHeader("Accept", "application/json")
  .addHeader("Authorization", "Bearer <MY_ACCESS_TOKEN>")
...
require_once 'HTTP/Request2.php';
$request = new HTTP_Request2();
$request->setUrl('https://api.criteo.com/experimental/retail-media/accounts/625702934721171442/audience-segments/estimate-size');
$request->setMethod(HTTP_Request2::METHOD_POST);
$request->setConfig(array(
  'follow_redirects' => TRUE
));

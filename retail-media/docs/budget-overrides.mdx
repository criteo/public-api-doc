  ...
  <tr>
   ...
   <td>
    <ul>
     ...
     <li>
      _Budget override dates must not overlap any existing budget overrides for this campaign / line item_
     </li>
     <li>
      _Duration of daily budget override must end with D or d_
     </li>
     <li>
      _Duration of monthly budget override must end with M or m_
     </li>
    </ul>
   </td>
  </tr>

...
<Info>
  This guide assumes you have a **partner account** and **Organization & API application** created within Criteo. Instructions for getting started are available on [Getting connected to the API](https://developers.criteo.com/retail-media/docs/connect-to-the-api).
</Info>
...
![](/images/retail-media/docs/f9829c8-auth_methods2.png)
...
<Frame caption="Source:">
  <img src="/images/retail-media/docs/a324441-client_credentials_v2.png" />
...
<Frame caption="Source:">
  <img src="/images/retail-media/docs/1c88391-authcodev4.png" />

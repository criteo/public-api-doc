...
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Retail_Media/v2026_01/docs/PRIVATE MARKET/private-market-programmatic-consent-granting.md
hidden: true
---
...
4. Select all relevant authorizations domains that your users will need to access - for more information, check [Create your app](/retail-media/docs/create-your-app#step-3---authorizations):

   ...
   <td>
    ...
    <ul>
     ...
     <li>
      ...
      : _Sales are deduplicated between off-site and on-site, however the Criteo API will report on
      <strong>
       on-site campaigns only
      </strong>
      . A sale can only be attributed to one line item across all campaigns._
     </li>
    </ul>
    <p>
     Also available for

...
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Retail_Media/v2026_01/docs/Getting Started/oauth-app-implementation/oauth-app-authorization-code.md
...
![862451e image](/images/retail-media/docs/862451e-image.png)
...
* On your app page, you can define the scope of your application and OAuth parameters. For more details, please refer to [Getting connected to the API](/retail-media/docs/connect-to-the-api).

![abc222c portal _step1_1](/images/retail-media/docs/abc222c-portal-_step1_1.gif)
...
* For this setup, we are selecting "_Authorization Code_", but you can review our [OAuth App implementation](/retail-media/docs/oauth-app-implementation) guide to determine the best option for your organization.

![190da94 auth_methods](/images/retail-media/docs/190da94-auth_methods.png)
...
![4a14336 services](/images/retail-media/docs/4a14336-services.png)
...
![fb84380 portal _step4final_1](/images/retail-media/docs/fb84380-portal-_step4final_1.gif)
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Your public key, accessible in the app credentials section. You can manage up to 5 pairs of credentials, even after the app has been activated.</td>
    </tr>
    <tr>
      <td><code>client&#95;secret</code></td>
      <td>Your secret key, accessible only once when creating a pair of <code>client&#95;id</code> and <code>client&#95;secret</code>. You can manage up to 5 pairs of credentials after app activation.</td>
    </tr>
    <tr>
      <td><code>redirect&#95;uri</code></td>
      <td>The URL to redirect the user to after consent. Requires HTTPS. You can add up to 30 redirect URIs, manageable after app activation.</td>
    </tr>
  </tbody>
</table>
...
<Frame caption="The Criteo Consent page allows selecting the advertisers to grand access to">
  <img src="/images/retail-media/docs/0151441-consentgeneration3.png" alt="The Criteo Consent page allows selecting the advertisers to grand access to" />
</Frame>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>A single-use authorization code valid for 60 seconds.</td>
    </tr>
    <tr>
      <td><code>state</code></td>
      <td>The originally provided state parameter, returned as-is.</td>
    </tr>
  </tbody>
</table>
...
* [OAuth App – Authorization Code & PKCE Setup](/retail-media/docs/oauth-app-authorization-code-pkce-setup)

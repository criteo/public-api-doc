...
1. Getting Started
2. [OAuth App Implementation](/retail-media/docs/oauth-app-implementation)

This guide provides step-by-step instructions on setting up an API application using the authorization code workflow

<Info>
  This guide describes OAuth App setup using the Authorization Code flow. If your application is a mobile app, single-page app (SPA), or other public client that cannot securely store a client secret, you must use the [Authorization Code with PKCE](https://developers.criteo.com/retail-media/docs/oauth-app-authorization-code-pkce-setup) instead.
</Info>
...
![](/images/retail-media/docs/862451e-image.png)
...
* On your app page, you can define the scope of your application and OAuth parameters. For more details, please refer to [Getting connected to the API](doc:connect-to-the-api).

![](/images/retail-media/docs/abc222c-portal-_step1_1.gif)
...
* For this setup, we are selecting "*Authorization Code*", but you can review our [OAuth App implementation](doc:oauth-app-implementation) guide to determine the best option for your organization.

![](/images/retail-media/docs/190da94-auth_methods.png)
...
![](/images/retail-media/docs/4a14336-services.png)
...
![](/images/retail-media/docs/fb84380-portal-_step4final_1.gif)
...
![](/images/retail-media/docs/706af65-2023-06-30_14_57_56-My_First_App-Criteo_Developer_Portal.png)
...
<Frame caption="The Criteo Consent page allows selecting the advertisers to grand access to">
  <img src="/images/retail-media/docs/0151441-consentgeneration3.png" />
</Frame>

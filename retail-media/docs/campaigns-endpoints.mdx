...
2. [Campaigns](/retail-media/docs/campaign)
...
| `type`                     | `enum`         | Campaign type If the attribute is passed in the call, a value must be specifiedAccepted values: `auction`, `preferred` Default: `auction` Writeable? Y / Nullable? N                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
[Campaigns](/retail-media/docs/campaign)

[Catalog](/retail-media/docs/catalogs)

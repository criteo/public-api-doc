 ...
 <tbody>
  ...
  <tr>
   ...
   <td>
    <p>
     ...
     being the account type for <a href="/retail-media/docs/retailers">Retailers</a> and
     <code>
      demand
     </code>
  ...
  <tr>
   ...
   <td>
    ...
    <p>
     Accepted values: 2-chars country code (in <a href="https://www.iso.org/iso-3166-country-codes.html">ISO-3166</a> alpha-2 code; e.g.
     <code>
      US
     </code>
     ,
  ...
  <tr>
   ...
   <td>
    ...
    <p>
     Accepted values: 3-chars currency code (in <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO-4217</a>; e.g.
     <code>
      USD
     </code>
     ,
  ...
  <tr>
   ...
   <td>
    ...
    <p>
     Accepted values: time zone identifiers from <a href="https://www.iana.org/time-zones">IANA (TZ database)</a> (e.g.
     <code>
      America/New_York
     </code>
     ,

...
<Info>
  Setting up or managing a retailer's own account — Private Market accounts, fees, or retailer search? See [Account Creation and Management (Private Market)](/retail-media/docs/account-creation-and-management-private-market).
</Info>

...
<Info>
  Setting up or managing a retailer's own account — Private Market accounts, fees, or retailer search? See [Retail Media Ads for Retailers](/retail-media/docs/retailers-glossary).
</Info>

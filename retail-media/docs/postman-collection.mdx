...
* Completed the application [onboarding checklist](/retail-media/docs/connect-to-the-api),
...
<Frame caption="Create a fork from your chosen Postman collection">
  <img src="/images/retail-media/docs/0c62e5b-Fork_collection.png" />
</Frame>

<Frame caption="Add a label and a location to your local collection">
  <img src="/images/retail-media/docs/c74bc7d-Capture_decran_2022-01-20_a_17.48.44.png" />
</Frame>
...
<Frame caption="Collection of variables to be customized">
  <img src="/images/retail-media/docs/4d1b8d8-fork_env.png" />
</Frame>
...
<Frame caption="Ensure the environment is &#x22;MyCriteoConnector&#x22; in Postman">
  <img src="/images/retail-media/docs/ea55a20-nonoenv.png" />
</Frame>
...
<Frame caption="Make your first call from the versioned folder">
  <img src="/images/retail-media/docs/26255ef-Capture_decran_2022-01-20_a_19.43.18.png" />
</Frame>
...
<Info>
  Learn more about application scopes and permissions in [Onboarding Checklist](/retail-media/docs/connect-to-the-api#3-define-your-app-scope)

...
This page describes the Criteo API rate limit policy, and provides some best practices to help manage rate limits
...
| -------------------------------------------------------- | -------------------- | --------------------------- |
| [Client Credentials](/retail-media/docs/oauth-app-client-credentials) | 250 calls per minute | Application level           |
| [Authorization Code](/retail-media/docs/oauth-app-authorization-code) | 10 calls per minute  | Account                     |
...
![](/images/retail-media/docs/1dc5ae4-image.png)
...
![](/images/retail-media/docs/d27a3e6dcb5cdb5499666e1496c36669b4bd4b39ae0912f5f5d9d1c85c1fca4d-image.png)

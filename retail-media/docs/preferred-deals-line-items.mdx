...
<Info>
  A new unified [Line Item Core](/retail-media/docs/line-items-core) endpoint is replacing the type-specific creation routes. This page remains available in the meantime.
</Info>
  ...
  <tr>
   ...
   <td>
    <p>
     ...
     <a href="/retail-media/docs/accounts">
      account
     </a>
     <code>
      timeZone

...
description: Generate an aggregated campaign or line-item report based on specific
  private market account IDs
hidden: true
---
...
<Info>
  ...
  * :exclamation:Supply accounts looking to use the endpoint will need to be added to our allowed list. ***Please reach out to your account representative to request access. Provide us with the API application organization ID and the app ID that is requesting access***.
</Info>

...
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Retail_Media/v2026_01/docs/Guides for Retail Media API/account/account-creation-and-management-private-market.md
---
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>list``</td>
      <td>List of <a href="/retail-media/docs/brands">Brand</a> IDs associated with a demand brand account. Required in the demand brand account creation.<br />Accepted values: list of string of int64<br />Writeable? Y / Nullable? N</td>
    </tr>
    <tr>
      <td><code>sellerId</code></td>
      <td>string</td>
      <td>Seller ID from Retailer's <a href="/retail-media/docs/catalogs">Catalog</a>, associated with a demand seller account. Required in the demand seller account creation.<br />Accepted values: string of int64<br />Writeable? Y / Nullable? N</td>
    </tr>
    <tr>

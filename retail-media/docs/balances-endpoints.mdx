...
2. [Balances](/retail-media/docs/balances)
...
| `startDate`\*              | `timestamp` | Balance start date; if time zone is not set, will consider [Account](doc:account)'s time zone as defaultAccepted values: `yyyy-mm-dd`(in [ISO-8601](https://www.iso.org/iso-8601-date-and-time-format.html) ) Writeable? Y / Nullable? N                                                                    |
| `endDate`                  | `timestamp` | Balance end date; if time zone is not set, will consider [Account](doc:account)'s time zone as defaultAccepted values: `yyyy-mm-dd`(in [ISO-8601](https://www.iso.org/iso-8601-date-and-time-format.html) ) Default: if `null` or absent, balance will be available indefinitely Writeable? Y / Nullable? Y |
...
[Billing](/retail-media/docs/billing)

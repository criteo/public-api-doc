...
<Warning>
  This endpoint returns all possible page types supported by our platform, including the ones not currently supported by the respective retailer associated with the line item. For the effective list of supported page types, please refer to [Retailer Search](/retail-media/docs/retailer-search)
</Warning>

...
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Retail_Media/v2026_01/docs/Guides for Retail Media API/supply-side-reporting-ssp/fill-rate-report.md
---
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>list&#92;</td>
      <td>An array of strings used to define which dimensions to see in the report<br />Accepted values: refer to Metrics and Dimensions for the complete list of supported dimensions<br />Writable? N / Nullable? N</td>
    </tr>
    <tr>
      <td><code>metrics</code>&#42;</td>
      <td>list&#92;</td>
      <td>An array of strings used to define which metrics to see in the report<br />Accepted values: refer to Metrics and Dimensions for the complete list of supported metrics<br />Writable? N / Nullable? N</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>string</td>
      <td>Time zone to consider in the metrics calculation,<code>startDate</code> and <code>endDate</code><br />Accepted values: IANA (TZ database) time zones (example: <code>America/New&#95;York</code>, <code>Europe/Paris</code>, <code>Asia/Tokyo</code>, <code>UTC</code>)<br />Default: <code>UTC</code><br />Writable? N / Nullable? Y</td>
    </tr>
    <tr>

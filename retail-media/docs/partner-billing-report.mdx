...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>list</td>
      <td>Account IDs (currently supports only Supply Account IDs)<br />Accepted values: array of strings/int64<br />Writeable? N / Nullable? N</td>
    </tr>
    <tr>
      <td><code>retailerIds</code></td>
      <td>list</td>
      <td><a href="/retail-media/v2025.07/docs/retailers">Retailer</a> IDs<br />Accepted values: array of strings/int64<br />Writeable? N / Nullable? N</td>
    </tr>
    <tr>
      <td><code>startDate</code>&#42;</td>
      <td>date</td>
      <td>Start date of the report (inclusive)<br />Accepted values: <code>yyyy-mm-dd</code><br />Writeable? N / Nullable? N</td>
    </tr>
    <tr>
      <td><code>endDate</code>&#42;</td>
      <td>date</td>
      <td>End date of the report (inclusive)<br />Accepted values: <code>yyyy-mm-dd</code><br />Writeable? N / Nullable? N</td>
    </tr>
    <tr>
      <td><code>format</code></td>
      <td>enum</td>
      <td>The format type the report should return results<br />Accepted values: <code>json</code>, <code>csv</code><br />Default: <code>json</code><br />Writeable? N / Nullable? N</td>
    </tr>
  </tbody>
</table>

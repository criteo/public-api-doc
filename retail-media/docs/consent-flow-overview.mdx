...
- **Standard Consent Flow** — Follow the [Consent URL Generation](/retail-media/docs/consent-url-generation) and [Authorization Requests](/retail-media/docs/authorization-requests) guides.
- **Private Market Programmatic Consent Flow** — Follow the [Private Market Programmatic Consent Granting](/retail-media/docs/private-market-programmatic-consent-granting) guide.

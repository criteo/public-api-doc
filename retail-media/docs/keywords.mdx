...
<Info>
  ...
  Check out the [**Onsite Sponsored Products**](/retail-media/docs/onsite-sponsored-products) page for a complete summary of Criteo's keyword service.
</Info>
...
| ----------------- | --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `id`\*            | string    | [Line Item](/retail-media/docs/line-items) ID, generated internally by CriteoAccepted values: string of int64 Writeable? N / Nullable? N                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |

...
| **Products**   | `active``inactive`                                                      | Not entirely - **`active`** and **`paused`** statuses are read only with most promoted products endpoints. However, they can be directly updated using the pause and unpause endpoints. | Yes, with the `pause` and `unpause` endpoints[/line-items/\{LineItemId}/products/pause](https://developers.criteo.com/retail-media/reference/pausepromotedproducts) directly updates promoted product status to **`paused`**[/line-items/\{LineItemId}/products/unpause](https://developers.criteo.com/retail-media/reference/unpausepromotedproducts) directly updates promoted product to **`active`** | Pausing products SKU’s on a line item will not change the status of a campaign or line item                                                                                                                                                                                                                                                                    |

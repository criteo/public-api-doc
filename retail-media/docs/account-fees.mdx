...
| ---------------- | --------- | -------------------------------------------------------------------------------------------------------------------------- |
| `offsite`        | `integer` | Pagination parameter, see [API Response](https://developers.criteo.com/retail-media/docs/api-response#/)                   |
| `limit`          | `integer` | Pagination parameter, see [API Response](https://developers.criteo.com/retail-media/docs/api-response#/)                   |

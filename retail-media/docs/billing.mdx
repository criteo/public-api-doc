---
title: Billing
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Retail_Media/v2026_01/docs/Guides for Retail Media API/billing/index.md
---
...
* Reports are generated at a [Line Items](/retail-media/docs/line-items) granularity, i.e., `Demand account` x `Campaign` x `Line-Item`
...
* [Partner Billing Report](/retail-media/docs/partner-billing-report)

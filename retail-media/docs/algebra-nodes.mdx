---
title: Algebra Nodes
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Retail_Media/v2026_01/docs/Guides for Retail Media API/audiences/algebra-nodes.md
---
...
```json Examples AND node expandable

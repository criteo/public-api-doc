...
:heavy\_check\_mark: Upload creative image assets\
:heavy\_check\_mark: View available retailer creative templates\
:heavy\_check\_mark: Build new creatives using either one of our built-in templates or using a custom template\
:heavy\_check\_mark: Associate the product SKUs you wish to display on each creative

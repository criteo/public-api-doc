...
We introduced two new endpoints in the latest release to support bid multiples for open auction line items. [Bid Multipliers](/retail-media/docs/bid-multiplier) provide campaign managers more control over managing bids at the line item level while also optimizing campaign performance goals at a page-type level. Bid multipliers are available for enabled page types for Open Auction line items.

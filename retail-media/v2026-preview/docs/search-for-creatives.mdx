...
* `/retail-media/accounts/:account-id/creatives`documented [here](/retail-media-v2026-01/campaign/create-creative),
* `/retail-media/accounts/:account-id/creatives/:creative-id`documented [here](/retail-media-v2026-01/campaign/get-creative),
* `/retail-media/accounts/:account-id/creatives/search?creative-ids=<string>&creative-ids=<string>`documented [here](/retail-media-v2026-01/campaign/search-account-creatives).

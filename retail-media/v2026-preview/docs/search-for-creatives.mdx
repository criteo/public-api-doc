...
* `/retail-media/accounts/:account-id/creatives`documented [here](/retail-media/v2026-preview/reference/createcreative),
* `/retail-media/accounts/:account-id/creatives/:creative-id`documented [here](/retail-media/v2026-preview/reference/getcreative),
* `/retail-media/accounts/:account-id/creatives/search?creative-ids=<string>&creative-ids=<string>`documented [here](/retail-media/v2026-preview/reference/searchaccountcreatives).

...
<Info>
  You can also find the Store Inventory endpoints in our API Reference [here](/retail-media/v2026-preview/reference/upsertstoreinventorypermerchantid) for `upsert`, and [here](/retail-media/v2026-preview/reference/deletestoreinventorypermerchantid) for `delete`.
</Info>

...
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Retail_Media/v2026-preview/docs/Getting started/authorization-requests.md
hidden: true
---
...
* Any user who is mapped to an account on RMP can grant access to a Developer Account with the role of Business Manager or above.  Email addresses that are not mapped to an account in the Retail Media Platform will not be able to grant access to the account 

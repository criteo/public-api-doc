...
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Retail_Media/v2026-preview/docs/Migrated to Stable (2025.10)/recommended-categories.md
hidden: true
---
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><code>/preview/retail-media/retailers/&#123;retailerId&#125;/recommend-categories</code></td>

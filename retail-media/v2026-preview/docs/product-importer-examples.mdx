...
<Info>
  Once your request is submitted, the API responds with an `operationToken` that can be used to track processing status. See below for[ response examples](https://developers.criteo.com/retail-media/v2026-preview/docs/product-importer-examples#response) and result reporting.
</Info>

<Info>
  For details on how to structure individual `product` objects, see the [examples](https://developers.criteo.com/retail-media/v2026-preview/docs/product-importer-examples#examples-for-the-batch-endpoint) section below.
</Info>

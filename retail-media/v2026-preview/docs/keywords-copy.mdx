---
title: Keywords (COPY)
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Retail_Media/v2026-preview/docs/Private market (target Only)/keywords-copy.md
hidden: true
---
...
<ParamField path="id" type="string" required>
  **Default:** Computerized value
  ...
  The external line item id
</ParamField>

<ParamField path="reviewState" type="enum">
  *Optional.*

  **Default:** `InReview`

  Review the keyword's status, only applicable for `PositiveExactMatch` keywords.
...
<ParamField path="matchType" type="enum" required>
...
<ParamField path="bid" type="decimal">
  *Optional.*
...
<ParamField path="isDeleted" type="boolean">
  **Default:** `null`
  ...
  Controls if the keyword will be added or removed from the line item.

  **Values:** `true`, `false`
</ParamField>

<ParamField path="inputKeywords" type="number" required>
  **Default:** N/A

  Keywords supplied by the user matching this normalized keyword phrase binned by match type.
...
<ParamField path="createdAt" type="date-time">
  **Default:** Computerized value

  Date keyword was created in the line item.

  **Values:** yyyy-mm-dd T hh:mm:ss
</ParamField>

<ParamField path="updatedAt" type="date-time">
  **Default:** Computerized value

  Last date keyword was updated in the line-item.

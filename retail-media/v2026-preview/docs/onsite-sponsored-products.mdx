...
![](/images/retail-media/v2026-preview/docs/659142a-lineitem1.png)
...
<Frame caption="Exact match blocks ads from serving for specific keywords, while broad match blocks ads for a range of similar terms.  is considered a subset of exact match, meaning keywords set as broad will be treated as both broad and exact matches.">
  <img src="/images/retail-media/v2026-preview/docs/39b3f99-negativekeyword2.png" />
...
![](/images/retail-media/v2026-preview/docs/824f121-KWS.png "KWS.png")
...
[Demand Side Analytics (DSP)](/retail-media/v2026-preview/docs/demand-side-analytics)

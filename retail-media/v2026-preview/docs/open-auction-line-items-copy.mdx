...
<ParamField path="name" type="string" required>
  **Is Nullable?** No
  ...
  Line item name; must be unique within a [campaign](/retail-media/v2026-preview/docs/campaigns)
...
<ParamField path="monthlyPacing" type="number">
  ...
  **Is Nullable?** Yes
  ...
  Amount the line item can spend per calendar month in the [account](/retail-media/v2026-preview/docs/accounts) `timeZone`; resets each calendar month; uncapped if omitted or set to null
...
<ParamField path="dailyPacing" type="number">
  ...
  **Is Nullable?** Yes
  ...
  Amount the line item can spend per day in the [account](/retail-media/v2026-preview/docs/accounts) timeZone; resets each day; overwritten by a calculation if `isAutoDailyPacing` is configured; uncapped if omitted or set to null

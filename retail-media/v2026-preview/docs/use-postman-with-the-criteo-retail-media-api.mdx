...
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Retail_Media/v2026-preview/docs/RESOURCES/use-postman-with-the-criteo-retail-media-api.md
---
<Warning>
...
* Completion of the application [onboarding checklist](/retail-media/v2026-preview/docs/onboarding-checklist)
...
<Frame>
  <img src="/images/retail-media/v2026-preview/docs/0c62e5b-Fork_collection.png" alt="Fork_collection.png" />
</Frame>

<Frame>
  <img src="/images/retail-media/v2026-preview/docs/c74bc7d-Capture_decran_2022-01-20_a_17.48.44.png" alt="Capture d’écran 2022-01-20 à 17.48.44.png" />
</Frame>
...
<Frame>
  <img src="/images/retail-media/v2026-preview/docs/4d1b8d8-fork_env.png" alt="fork_env.png" />
</Frame>
...
<Frame>
  <img src="/images/retail-media/v2026-preview/docs/ea55a20-nonoenv.png" alt="nonoenv.png" />
</Frame>
...
<Frame>
  <img src="/images/retail-media/v2026-preview/docs/26255ef-Capture_decran_2022-01-20_a_19.43.18.png" alt="Capture d’écran 2022-01-20 à 19.43.18.png" />
</Frame>
...
<Info>
  Learn more about application scopes and permissions [here](/retail-media/v2026-preview/docs/onboarding-checklist#define-your-app-scope). You can also find more information about error handling here: [API Response](/retail-media/v2026-preview/docs/api-response).
</Info>
...
If you keep getting "code authorization-token-invalid" response when issuing a request to Criteo server, the most likely reason is incorrect client_id/client_secret or an uninitialized environment.

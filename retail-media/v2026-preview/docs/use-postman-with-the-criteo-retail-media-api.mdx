...
<Frame caption="Capture d’écran 2022-01-20 à 19.43.18.png">
...
<Info>
  Learn more about application scopes and permissions [here](/retail-media/docs/onboarding-checklist#define-your-app-scope). You can also find more information about error handling here: [API Response](/retail-media/v2026-preview/docs/api-response).
</Info>

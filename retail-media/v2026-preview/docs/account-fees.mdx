...
You can find more details in the API reference for this endpoint [here](/retail-media/reference/accounts/account-fees-search).
  ...
  <tr>
   ...
   <td>
    <p>
     ...
     <a href="/retail-media/v2025.01/docs/api-response">
      API Response
     </a>
    </p>
   </td>
...
This endpoint allows **Private Market retailers** to update fees for child seller or demand accounts. You can find more details about this endpoint in our API reference [here](/retail-media/reference/accounts/update-account-fees).

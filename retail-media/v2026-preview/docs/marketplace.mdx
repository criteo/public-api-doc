...
<Info>
  You can also find the Marketplace endpoints in our API Reference [here](/retail-media/v2026-preview/api-reference/catalog/offer-set-bbw-v-1) for updating the buy box winner and [here](/retail-media/v2026-preview/api-reference/catalog/offer-update-v-1) for updating offers.
</Info>

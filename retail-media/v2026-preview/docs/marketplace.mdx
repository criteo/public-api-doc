...
```http
https://api.criteo.com/preview/retail-media/retailers/{retailerId}/products/set-buy-box-winners
```
</EndpointBadge>
...
<EndpointBadge method="post">
```http
https://api.criteo.com/preview/retail-media/retailers/{retailerId}/offers/update
```
</EndpointBadge>

...
![After authenticating you will receive the access token. Use this access token in the next step to grant the account consent ](https://files.readme.io/e2b810a-image.png)
...
![**Example**: On the right, after completing step 4.1 our callback URL receives the code. On the left a new POST authenticate call is made with the code  ](https://files.readme.io/38a22dc-image.png)

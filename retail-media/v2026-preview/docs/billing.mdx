---
title: Billing
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Retail_Media/v2026-preview/docs/Guides for Retail Media API/billing.md
hidden: true
---
...
* Reports are generated at a [Line Items](/retail-media/v2026-preview/docs/line-items) granularity, i.e., `Demand account` x `Campaign` x `Line-Item`

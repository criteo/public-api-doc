...
<ResponseField name="revenueType">
**Data Type:** enum
...
<ResponseField name="skuRelations">
**Data Type:** enum
...
<ResponseField name="campaignType">
**Data Type:**&#x73;tring
...
<ResponseField name="salesChannel">
**Data Type:** string
...
<ResponseField name="advertiserTypes">
...
<ResponseField name="clickAttributionWindow">
**Data Type:** string
...
<ResponseField name="viewAttributionWindow">
**Data Type:** string
...
<Info>
  **Metrics and Dimensions**
  ...
  For a complete list of all supported metrics and dimension, check out the [Metrics and Dimensions](/retail-media/v2024.10/docs/metrics-and-dimensions-ssp)
</Info>

...
<Info>
  **API reference**
  ...
  You can find this endpoint in [the API reference](/retail-media/v2024.10/api-reference/campaign/accounts-get-v-1-external-account-retailers-by-account-id) as well.
</Info>

...
<ResponseField name="campaignEligibilities">
...
<Info>
  **API reference**
  ...
  You can find this endpoint in [the API reference](/retail-media/reference/accountsapi_getapiv1externalaccountretailersbyaccountid) as well.
</Info>
...
<CodeGroup>
  ...
  url = "https://api.criteo.com/{version}/retail-media/accounts/4/retailers"
  ...
  $request->setUrl('https://api.criteo.com/{version}/retail-media/accounts/4/retailers');
...
* [Line Items](/retail-media/v2024.10/docs/line-items-endpoints)

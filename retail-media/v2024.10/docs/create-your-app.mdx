...
Once you have [created your organization](https://developers.criteo.com/retail-media/docs/create-your-organization), you can access the `My Apps` page to begin creating your application. This page is also where you will manage your Criteo API applications.
...
* Criteo’s API supports two OAuth authentication methods: [Client Credentials](https://developers.criteo.com/retail-media/docs/oauth-app-client-credentials) and [Authorization Code](https://developers.criteo.com/retail-media/docs/oauth-app-authorization-code). Each method has its own advantages, so before proceeding, we strongly recommend reviewing which authentication method is best suited to your application’s needs.
...
<Info>
  ...
  If you're unsure which authentication method to use, take a look at our [OAuth App Implementation](https://developers.criteo.com/retail-media/docs/oauth-app-implementation) guide for an overview of each authentication method.
</Info>

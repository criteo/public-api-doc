...
* **Data Type:** string
  ...
  **Accepted Values:** Refer to the [Metrics & Dimension](https://developers.criteo.com/retail-media/docs/metrics-and-dimensions) page for a complete list of supported metrics
...
* **Data Type:** string
  ...
  **Accepted Values:** Refer to the [Metrics & Dimension](https://developers.criteo.com/retail-media/docs/metrics-and-dimensions) page for a complete list of supported dimensions

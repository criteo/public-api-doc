...
A new Criteo API version is released every three months, at the beginning of each quarter. The version names are date-based by year and month, such as `2024-10`. This helps to know precisely when your version was released.
...
| ------- | ------------------ | --------------------------- |
| 2023-10 | October 17th, 2023 | October 31, 2024            |

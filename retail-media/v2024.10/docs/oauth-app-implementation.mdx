...
<Info>
  This guide assumes you have a **developer account** and **your application has access to an organization** within Criteo. Instructions for getting started are available [on our onboarding checklist](/retail-media/v2026-preview/docs/onboarding-checklist) .
</Info>
...
![](/images/retail-media/v2024.10/docs/f9829c8-auth_methods2.png)
...
<Frame caption="Source:">
  <img src="/images/retail-media/v2024.10/docs/a324441-client_credentials_v2.png" />
...
For more information, check out the app setup process for [OAuth App - Client Credentials Setup](/retail-media/v2024.10/docs/oauth-app-client-credentials).
...
<Frame caption="Source:">
  <img src="/images/retail-media/v2024.10/docs/1c88391-authcodev4.png" />
...
For setup details, refer to [OAuth App - Authorization Code Setup](/retail-media/v2024.10/docs/oauth-app-authorization-code)
...
* [OAuth App - Authorization Code Setup](https://developers.criteo.com/retail-media/v2023.10/docs/oauth-app-authorization-code)

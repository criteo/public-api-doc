...
<Frame caption="Source: [Auth0 - Client Credentials Flow](https://auth0.com/retail-media/docs/demand-side-analytics-get-started/authentication-and-authorization-flow/client-credentials-flow)">
...
<Frame caption="Source: [Auth0 - Authorization Code Flow](https://auth0.com/retail-media/docs/demand-side-analytics-get-started/authentication-and-authorization-flow/authorization-code-flow)">
...
* [OAuth App - Authorization Code Setup](/retail-media/v2023.10/docs/oauth-app-authorization-code)

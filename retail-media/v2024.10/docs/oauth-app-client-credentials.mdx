...
![](/images/retail-media/v2024.10/docs/ff276e4-image.png)
...
1. Provide your app name and description. Optionally, add an image to identify your application. On your app page, you can define the scope of your application and the OAuth parameters. For more details on defining your app scope, visit this [page](doc:onboarding-checklist#3-define-your-app-scope).

![](/images/retail-media/v2024.10/docs/ec2ea86-portal-_clientcreds1.gif)

***

#### Authentication method

1. Select your app's authentication method. Choose between Client Credentials or Authorization Code. For this setup, we are selecting client credentials, but you can review our [OAuth App implementation](doc:oauth-app-implementation) guide to determine the best option for your organization.

![](/images/retail-media/v2024.10/docs/74936ae-client_credentials_option.png)
...
![](/images/retail-media/v2024.10/docs/544d9f0-image.png)
...
![](/images/retail-media/v2024.10/docs/b205ae3-consenturl.gif)

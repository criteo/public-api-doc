...
1. Provide your app name and description. Optionally, add an image to identify your application. On your app page, you can define the scope of your application and the OAuth parameters. For more details on defining your app scope, visit this [page](/retail-media/v2026-preview/docs/onboarding-checklist#3-define-your-app-scope).
...
1. Select your app's authentication method. Choose between Client Credentials or Authorization Code. For this setup, we are selecting client credentials, but you can review our [OAuth App implementation](/retail-media/v2024.10/docs/oauth-app-implementation) guide to determine the best option for your organization.

...
<Info>
  ...
  * Identify eligible products to promote by accessing your account [catalog](/retail-media/v2024.10/docs/catalogs).
...
<ResponseField name="lineItemId" required>
**Data Type:** number
...
<ResponseField name="bidOverride">
**Data Type:** number
...
1. note: GET calls for promoted products can only return active or paused

1. **POST calls can only use**
...
| 🔴 `403` | API user does not have authorization to make requests for the account ID. For authorization, follow the [authorization request](/retail-media/v2024.10/docs/authorization-requests) steps.                                                                                                                                                                                                                                                                                |

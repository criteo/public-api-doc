...
<Info>
  **View in the API Reference**
  ...
  You can also check this endpoint in [the API reference](/retail-media/v2024.10/api-reference/campaign/accounts-get-v-1-external-account-brands-by-account-id).
</Info>

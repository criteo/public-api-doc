...
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Retail_Media/v2025_07/docs/Guides for Retail Media API/creatives/creative-builder.md
hidden: true
---
...
<Note>
  ...
  The creative builder will enable to construction of new creatives through the API. In this document, you will find details regarding the different sections of a creative template variable. A creative comprises five [template variable values](/retail-media/v2025.07/docs/creative-builder#template-variable-value), which is a required array used in the **POST** or **PUT** calls when building a new creative. Any existing [template variable](/retail-media/v2025.07/docs/creative-builder#template-variable) can be found under `sections` of the **GET** Retailer Template endpoint.
</Note>
...
Provided when creating ([POST](/retail-media/v2025.07/docs/creative-builder#create-creative)) or updating ([PUT](/retail-media/v2025.07/docs/creative-builder#update-creatives)) a creative.
...
* The template variables that can be modified are dependent on each creative template. This information is provided in the [GET | Retailer Templates](/retail-media/v2025.07/docs/creative-builder#get-retailer-templates) response, under the `templateVariables` array. 
...
The endpoint will allow for updating existing creatives. The API endpoint request body uses the same `templateVariableValues` model as the one used in the [POST | Create Creative](/retail-media/v2025.07/docs/creative-builder#create-creative) call, but this time allows for updating any of the existing template variable fields. 

...
<Frame>
  <img src="/images/retail-media/v2025.07/docs/228926e-image.png" />
</Frame>
...
<Frame>
  <img src="/images/retail-media/v2025.07/docs/ce977aa-image.png" />
</Frame>

3. Select the C-Max and Retail media as your application service\
   <Frame>
     <img src="/images/retail-media/v2025.07/docs/3dc256f-image.png" />
   </Frame>
4. Select only the "Accounts" domain and provide manage access

<Frame>
  <img src="/images/retail-media/v2025.07/docs/32dfbf3-image.png" />
</Frame>
...
<Frame>
  <img src="/images/retail-media/v2025.07/docs/0a208b5-image.png" />
</Frame>
...
<Frame>
  <img src="/images/retail-media/v2025.07/docs/42ec0b9-image.png" />
</Frame>
...
<Frame>
  <img src="/images/retail-media/v2025.07/docs/0ca3b3e9251f19a6d53653a851a688563cf669b4733d135a06611e2c9599abc9-Google_Chrome_2025-01-28_11.46.31.png" alt="Authorizations for Business Apps" />
</Frame>
...
<Frame>
  <img src="/images/retail-media/v2025.07/docs/02e1f6f-image.png" />
</Frame>
...
<Frame caption="After authenticating you will receive the access token. Use this access token in the next step to grant the account consent">
  <img src="/images/retail-media/v2025.07/docs/e2b810a-image.png" alt="After authenticating you will receive the access token. Use this access token in the next step to grant the account consent" />
</Frame>
...
<Frame caption="**Example**: On the right, after completing step 4.1 our callback URL receives the code. On the left a new POST authenticate call is made with the code">
  <img src="/images/retail-media/v2025.07/docs/38a22dc-image.png" alt="**Example**: On the right, after completing step 4.1 our callback URL receives the code. On the left a new POST authenticate call is made with the code" />
</Frame>

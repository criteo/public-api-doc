...
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Retail_Media/v2025_07/docs/Guides for Retail Media API/billing/partner-billing-report.md
---
...
The metrics definition of the Partner Billing Report is available in [PBR Metrics](/retail-media/v2025.07/docs/pbr-metrics)

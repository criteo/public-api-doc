...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>string</td>
      <td><a href="/retail-media/v2025.07/docs/account">Account</a> ID associated with the Audience, generated internally by Criteo<br />Accepted values: string of int64<br />Writeable? N / Nullable? N</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>object</td>
      <td>Algebra node with the definition of how the different audience segments are combined together to create the audience, using logical operators <code>and</code>, <code>or</code> and <code>not</code><br />Accepted values: see <a href="/retail-media/v2025.07/docs/algebra-nodes">Algebra Nodes</a><br />Writeable? N / Nullable? N</td>
    </tr>
    <tr>

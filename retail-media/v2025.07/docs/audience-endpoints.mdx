...
Audiences are built of one or multiple audience segments that can be combined using logical [Algebra Nodes](doc:algebra-nodes) to define target campaigns' audiences.
...
[Audience Segment Endpoints](/retail-media/v2025.07/docs/audience-segment-endpoints)

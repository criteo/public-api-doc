...
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Retail_Media/v2025_07/docs/Getting Started/oauth-app-implementation/index.md
---
...
<Info>
  This guide assumes you have a **partner account** and **Organization & API application** created within Criteo. Instructions for getting started are available on [Getting connected to the API](/retail-media/v2025.07/docs/connect-to-the-api).
</Info>
...
![f9829c8 auth_methods2](/images/retail-media/v2025.07/docs/f9829c8-auth_methods2.png)
...
<Frame caption="Source: [Auth0 - Client Credentials Flow](https://auth0.com/docs/get-started/authentication-and-authorization-flow/client-credentials-flow)">
  <img src="/images/retail-media/v2025.07/docs/a324441-client_credentials_v2.png" alt="Source: [Auth0 - Client Credentials Flow](https://auth0.com/docs/get-started/authentication-and-authorization-flow/client-credentials-flow)" />
</Frame>
...
For more information, check out the app setup process for [OAuth App - Client Credentials Setup](/retail-media/v2025.07/docs/oauth-app-client-credentials).
...
<Frame caption="**Source**: [Auth0 - Authorization Code Flow](https://auth0.com/docs/get-started/authentication-and-authorization-flow/authorization-code-flow)">
  <img src="/images/retail-media/v2025.07/docs/1c88391-authcodev4.png" alt="**Source**: [Auth0 - Authorization Code Flow](https://auth0.com/docs/get-started/authentication-and-authorization-flow/authorization-code-flow)" />
</Frame>
...
For setup details, refer to [OAuth App - Authorization Code Setup](/retail-media/v2025.07/docs/oauth-app-authorization-code)
## What's next

* [OAuth App - Authorization Code Setup](/retail-media/v2025.07/docs/oauth-app-authorization-code)

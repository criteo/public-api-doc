...
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Retail_Media/v2025_07/docs/API troubleshooting/escalation-guidelines.md
...
<Frame caption="Select your organization in the list">
  <img src="/images/retail-media/v2025.07/docs/80a100621c2b3a74396cdcad2a0a42ca3f4afae8064dae7dd0a693956ba7332e-image.png" alt="Select your organization in the list" />
</Frame>
...
<Frame caption="Then select the App you need assistance with">
  <img src="/images/retail-media/v2025.07/docs/81fb57df32684ba09ecf76d81a8c3809c6802276a6b9b8bf1a5a83c71f7e0055-image.png" alt="Then select the App you need assistance with" />
</Frame>
...
<Frame caption="The App ID appears both in the URL and besides the App name.">
  <img src="/images/retail-media/v2025.07/docs/53001708b9069553525e5435b7ae7e93b0b2596046a3b9f09103c56dc5fbfee9-image.png" alt="The App ID appears both in the URL and besides the App name." />
</Frame>
...
<Info>
  Once you provide all the required information, our teams will get back to you shortly. You can also browse through our [endpoint guides](/retail-media/v2025.07/docs/accounts-endpoints) and the [API reference](/retail-media/v2025.07/api-reference/authorization/v-1-oauth-2-token-post) to learn more about the Criteo Retail Media API.
</Info>

...
Please refer to the [Escalation Checklist](https://developers.criteo.com/retail-media/docs/escalation-guidelines#/escalation-checklist) below for steps to investigate.
...
<Frame caption="Select your organization in the list">
  <img src="/images/retail-media/v2025.07/docs/80a100621c2b3a74396cdcad2a0a42ca3f4afae8064dae7dd0a693956ba7332e-image.png" />
</Frame>
...
<Frame caption="Then select the App you need assistance with">
  <img src="/images/retail-media/v2025.07/docs/81fb57df32684ba09ecf76d81a8c3809c6802276a6b9b8bf1a5a83c71f7e0055-image.png" />
</Frame>
...
<Frame caption="The App ID appears both in the URL and besides the App name.">
  <img src="/images/retail-media/v2025.07/docs/53001708b9069553525e5435b7ae7e93b0b2596046a3b9f09103c56dc5fbfee9-image.png" />
</Frame>
...
<Info>
  Once you provide all the required information, our teams will get back to you shortly. You can also browse through our [endpoint guides](https://developers.criteo.com/retail-media/docs/account-endpoints) and the [API reference](https://developers.criteo.com/retail-media/reference/apiv1oauth2tokenpost) to learn more about the Criteo Retail Media API.
</Info>
...
Users should escalate after completing steps 1 to 4. Steps 5 to 6 are helpful steps for having a healthy amount of logs to reference but are not mandatory.
...
Some APIs have a status page (e.g., [Criteo Services Status](https://status.criteo.com/)) where outages are reported. Also make sure to check the [changelog](https://developers.criteo.com/retail-media/changelog) for breaking changes in documentation.

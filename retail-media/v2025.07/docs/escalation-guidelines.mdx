...
<Info>
  Once you provide all the required information, our teams will get back to you shortly. You can also browse through our [endpoint guides](/retail-media/v2025.07/docs/accounts-endpoints) and the [API reference](/retail-media/reference/apiv1oauth2tokenpost) to learn more about the Criteo Retail Media API.
</Info>

...
A retailer typically allows multiples types of pages to be targeted. A *page* is an inventory that can be targeted by [Campaigns](doc:campaign) and [Line Items](doc:line-items) with specific configurations.
...
* [Line Items](/retail-media/v2025.07/docs/line-items-endpoints)

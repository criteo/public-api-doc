...
2. [Campaigns](/retail-media/v2025.07/docs/campaign)
...
<Info>
  ...
  Learn more about campaign management with our API [**here**](doc:campaigns)!
</Info>
...
| `accountId`\*              | string         | [Account](doc:account) ID associated with the campaign, generated internally by CriteoAccepted values: int64 Writeable? N / Nullable? N                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `name`\*                   | string         | Campaign name; must be unique within an [Account](doc:account)Accepted values: up to 255-chars string Writeable? Y / Nullable? N                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| `promotedBrandIds`         | list`<string>` | List of brand IDs from promoted products in the campaign, originated from the retailer's [Catalog](doc:catalogs) - see also [Brands](doc:brands)Accepted values: list of strings Default: empty list Writeable? N / Nullable? N                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| `drawableBalanceIds`       | list`<string>` | List of [Balances](doc:balances) the campaign is able to draw from; at least one balance is required for a campaign to startAccepted values: list of `balanceId` Default: empty list Writeable? N / Nullable? N                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `status`                   | enum           | Campaign status, derived from the status of [Line Items](doc:line-items) it holds; `active` if at least one line item is active. To understand the conditions that will cause a status to change, check out [Campaign & Line Item Status](doc:campaign-lineitem-status)Accepted values: `active`, `inactive` Default: `inactive` Writeable? N / Nullable? N                                                                                                                                                                                                                                                                                                                                                                                                                          |

...
* Completed the application [onboarding checklist](doc:onboarding-checklist),
...
<Frame caption="Create a fork from your chosen Postman collection">
  <img src="/images/retail-media/v2025.07/docs/0c62e5b-Fork_collection.png" />
</Frame>

<Frame caption="Add a label and a location to your local collection">
  <img src="/images/retail-media/v2025.07/docs/c74bc7d-Capture_decran_2022-01-20_a_17.48.44.png" />
</Frame>
...
<Frame caption="Collection of variables to be customized">
  <img src="/images/retail-media/v2025.07/docs/4d1b8d8-fork_env.png" />
</Frame>
...
<Frame caption="Ensure the environment is &#x22;MyCriteoConnector&#x22; in Postman">
  <img src="/images/retail-media/v2025.07/docs/ea55a20-nonoenv.png" />
</Frame>
...
<Frame caption="Make your first call from the versioned folder">
  <img src="/images/retail-media/v2025.07/docs/26255ef-Capture_decran_2022-01-20_a_19.43.18.png" />
</Frame>
...
Learn more about application scopes and permissions in [Onboarding Checklist](doc:onboarding-checklist#3-define-your-app-scope)

More information about error handling can be found in [API Response](doc:api-response).
...
[Account](/retail-media/v2025.07/docs/account)

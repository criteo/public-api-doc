...
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Retail_Media/v2025_07/docs/Getting Started/oauth-app-implementation/oauth-app-authorization-code.md
...
![](https://files.readme.io/862451e-image.png)
...
* On your app page, you can define the scope of your application and OAuth parameters. For more details, please refer to [Getting connected to the API](/retail-media/v2025.07/docs/connect-to-the-api).
...
* For this setup, we are selecting "*Authorization Code*", but you can review our [OAuth App implementation](/retail-media/v2025.07/docs/oauth-app-implementation) guide to determine the best option for your organization.
...
<Frame caption="The Criteo Consent page allows selecting the advertisers to grand access to">
  <img src="/images/retail-media/v2025.07/docs/0151441-consentgeneration3.png" alt="The Criteo Consent page allows selecting the advertisers to grand access to" />
</Frame>

 ...
 <tbody>
  ...
  <tr>
   ...
   <td>
    ...
    <ul>
     <li>
      _Formula_*: Sum of all Sales
     </li>
     <li>
      _Important_*: _Sales are deduplicated between off-site and on-site, however the Criteo API will report on **on-site campaigns only**. A sale can only be attributed to one line item across all campaigns._
     </li>
    </ul>
    <p>
     Also available for
  ...
  <tr>
   ...
   <td>
    ...
    <ul>
     <li>
      _Example:_* _If a shopper purchases one order of two products, the number of Attributed Orders is one._
     </li>
    </ul>
   </td>
  </tr>
  <tr>
   ...
   <td>
    ...
    <ul>
     <li>
      _Example:_* _If a shopper purchases one order of two products, the number of Attributed Units is two._
     </li>
    </ul>
    <p>
     Also available for
  ...
  <tr>
   ...
   <td>
    ...
    <ul>
     <li>
      _Formula_*: Total Numb of Clicks at the time of capout x (
      <code>
       Missed Traffic
      </code>
      )/ (1 -
  ...
  <tr>
   ...
   <td>
    ...
    <ul>
     <li>
      _Formula_*: Total Numb. of Impressions at the time of capout x (
      <code>
       Missed Traffic
      </code>
      )/ (1 -
  ...
  <tr>
   ...
   <td>
    ...
    <ul>
     ...
     <li>
      *Example: **_If you spend \$100 on advertising and you have 5 orders placed, the CPO would be \$20 (\$100/5)_
     </li>
    </ul>
   </td>
  </tr>
  ...
  <tr>
   ...
   <td>
    ...
    <ul>
     <li>
      _Formula_*: Number of videos that played to completion / Total number of videos started * 100
     </li>
    </ul>
    <p>
     Also available for
  ...
  <tr>
   ...
   <td>
    ...
    <ul>
     <li>
      _Formula_*: Sum of Quartiles x 0.25 / (4 x Video starts)
     </li>
    </ul>
   </td>
  </tr>
  <tr>
   ...
   <td>
    ...
    <ul>
     <li>
      _Formula_*: Video Starts / Placement Impressions
     </li>
    </ul>
    <p>
     Also available for
  ...
  <tr>
   ...
   <td>
    ...
    <ul>
     <li>
      _Formula_*: Viewable Impressions / Placement Impressions
     </li>
    </ul>
   </td>
  </tr>
 ...
 <tbody>
  ...
  <tr>
   ...
   <td>
    <p>
     ...
     <a href="/retail-media/v2025.07/docs/catalogs#catalog-product-attributes">
      Catalogs
     </a>
    </p>
   </td>
  ...
  <tr>
   ...
   <td>
    ...
    <ul>
     <li>
      _Note_*: Offsite is not yet available through the API
     </li>
    </ul>
   </td>
  </tr>
  ...
  <tr>
   ...
   <td>
    ...
    <ul>
     <li>
      _Note:_* Dates are reflected based on the API call requested time zone. Dates are also reported at either the campaign level or line-item level.
     </li>
    </ul>
    <p>
     Available for
  ...
  <tr>
   ...
   <td>
    ...
    <ul>
     <li>
      _Example_*: _an 11pm ad leading to a 1 am sale the next day would have a 0 day difference_
     </li>
    </ul>
    <p>
     Available for
  ...
  <tr>
   ...
   <td>
    <p>
     ...
     <a href="/retail-media/v2025.07/docs/onsite-sponsored-products#submited-keywords">
      normalized keyword
     </a>
    ...
    <ul>
     <li>
      _Note_*: this dimension will only be populated when
      <code>
       pageTypeName
      </code>
      equals
  ...
  <tr>
   ...
   <td>
    ...
    <ul>
     ...
     <li>
      _Automatic targeting_* – All other search terms added via the automated keyword tool
     </li>
    </ul>
   </td>
  </tr>
  ...
  <tr>
   ...
   <td>
    ...
    <ul>
     <li>
      _Note_*: Served category reports will be specific to the retailer while all other category report types will have standardized categories across brands and retailers.
     </li>
    </ul>
   </td>
  </tr>

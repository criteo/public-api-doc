...
description: Advertisers must grant access to apps or integrations built with the
  API through an authorization request, with different permission levels available
  such as read-only or manage access. Advertisers can manage and revoke access through

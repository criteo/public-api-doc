...
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Retail_Media/v2025_07/docs/Guides for Retail Media API/audiences/audience-segment-endpoints-copy.md
hidden: true
---
...
Multiple Audience Segments can be combined together using logical [Algebra Nodes](/retail-media/v2025.07/docs/algebra-nodes) to defined the desired target audience for your campaigns.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><strong>POST</strong></td>
      <td><code>/accounts/&#123;accountId&#125;/audience-segments/search</code></td>
      <td>Search for Audience Segments by segment IDs, retailer IDs and/or segment types</td>
    </tr>
    <tr>
      <td><strong>GET</strong></td>
      <td><code>/accounts/&#123;accountId&#125;/audience-segments/&#123;audienceSegmentId&#125;/contact-list</code></td>
      <td>Retrieve contact list statistics</td>
    </tr>
    <tr>
      <td><strong>POST</strong></td>
      <td><code>/audience-segments/&#123;audienceSegmentId&#125;/contact-list/add-remove</code></td>
      <td>Add/remove identifiers in contact list Audience Segment</td>
    </tr>
    <tr>
      <td><strong>POST</strong></td>
      <td><code>/audience-segments/&#123;audienceSegmentId&#125;/contact-list/clear</code></td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>string</td>
      <td><a href="/retail-media/v2025.07/docs/account">Account</a> ID associated with the Audience Segment, generated internally by Criteo<br />Accepted values: string of int64<br />Writeable? N / Nullable? N</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>list``</td>
      <td>Channels associated to the audience<br />Accepted values: <code>Onsite</code>, <code>Offsite</code>, <code>Unknown</code><br />Writeable? N / Nullable? N</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>enum</td>
      <td>User identifier type from Contact list<br />Accepted values: <code>Email</code>, <code>UserIdentifier</code>, <code>IdentityLink</code>, <code>CustomerId</code>, <code>Unknown</code><br />Writeable? N / Nullable? N</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>list``</td>
      <td>Define users interested in specific categories from retailer's <a href="/retail-media/v2025.07/docs/catalogs">Catalog</a>.<br />Note, either one of <code>categoryIds</code> or <code>brandIds</code> must be included. Both can be included as well, but the request will fail if neither are included<br />Accepted values: array of strings/int64<br />Writeable? Y / Nullable? Y</td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>enum</td>
      <td>Operation required for the sub-set of users provided in the request<br />Accepted values: <code>add</code>, <code>remove</code><br />Writeable? N / Nullable? N</td>
    </tr>
  </tbody>
</table>

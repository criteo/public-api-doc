...
| ------------------------------------------------------ | -------------------- | --------------------------- |
| [Client Credentials](/retail-media/v2025.01/docs/oauth-app-client-credentials) | 250 calls per minute | Application level           |
| [Authorization Code](/retail-media/v2025.01/docs/oauth-app-authorization-code) | 35 calls per minute  | Access token level          |
...
![](/images/retail-media/v2025.01/docs/1dc5ae4-image.png)
...
![](/images/retail-media/v2025.01/docs/003b7eb1b75f7ac44f26f4036ec8220ad4ee2d49bbf6ab9cb1e36a4b0745babe-image.png)

***

### Authorization Code

![](/images/retail-media/v2025.01/docs/d27a3e6dcb5cdb5499666e1496c36669b4bd4b39ae0912f5f5d9d1c85c1fca4d-image.png)

Self-service platforms provide users with a convenient way to manage their own data. However, when an application owner handles the data of multiple owners, it is important to segregate data so that each user can only access their own information.

To accomplish this, the platform must manage different access tokens. Criteo has developed an approach that gives each consenter their own token and rate limit. The number of calls from each access token (or consenter) is accounted for and compared to the rate limit separately.

![](/images/retail-media/v2025.01/docs/3ad6b7bc0b19e12a87121bd44816e3b45856e00f8167571ebd29acf910048bb3-image.png)

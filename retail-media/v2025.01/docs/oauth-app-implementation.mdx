...
<Info>
  This guide assumes you have a **developer account** and **your application has access to an organization** within Criteo. Instructions for getting started are available [on our onboarding checklist](doc:onboarding-checklist) .
</Info>

...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Lookback click and view attribution window of the requested report. The attribution window is based on the parameters selected in the report API request. See [Get Started](https://developers.criteo.com/retail-media/docs/demand-side-analytics-get-started)

...
A new Criteo API version is released every three months, at the beginning of each quarter. The version names are date-based by year and month, such as `2025-01`. This helps to know precisely when your version was released.
...
| ------- | ------------------ | --------------------------- |
| 2024-01 | January 23rd, 2024 | January 30th, 2025          |
...
After 12 months of stability, each Criteo API will sunset and be deprecated. Developers will receive notices when a version is about to be deprecated. These notices will also be posted on [the changelog](https://developers.criteo.com/retail-media/changelog).

...
2. [Campaigns](/retail-media/v2025.01/docs/campaign)
...
| -------------------------- | ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `id`                       | string        | Campaign IDAccepted values: int64 Writeable? N / Nullable? N                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `accountId`\*              | string        | [Account](/retail-media/v2025.01/docs/account) IDAccepted values: int64 Writeable? N / Nullable? N                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `name`\*                   | string        | Campaign name; must be unique within an [Account](/retail-media/v2025.01/docs/account)Accepted values: up to 255-chars string Writeable? Y / Nullable? N                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| `drawableBalanceIds`       | list\<string> | List of [Balances](/retail-media/v2025.01/docs/balances) the campaign is able to draw from; at least one balance is required for a campaign to startAccepted values: list of `balanceId` Default: `[]` Writeable? N / Nullable? N                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `status`                   | enum          | Campaign status, derived from the status of [Line Items](/retail-media/v2025.01/docs/line-items) it holds; `active` if at least one line item is active. To understand the conditions that will cause a status to change, check out [Campaign & Line Item Status](/retail-media/v2025.01/docs/campaign-lineitem-status)Accepted values: `active`, `inactive` Default: `inactive` Writeable? N / Nullable? N                                                                                                                                                                                                                                                                                                                                                                                                                          |

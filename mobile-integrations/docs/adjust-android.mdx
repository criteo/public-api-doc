---
title: Adjust Android — In-App Events
description: Implement Criteo in-app events and deep links for Android using the Adjust SDK.
---
...
<Note>For one-way flight, you can skip the check-out parameter.</Note>

...
- \[Recommended\] **Fingerprint Lookback** — Uses device fingerprinting when a device ID isn't available. Attribution is allowed if the install/conversion occurs within 24 hours of the impression.
- \[Recommended\] **IP Lookback** — Matches users using only the full IP address. Set to `24` hours to allow Kochava to use IP-only matching for impression attribution when device/fingerprint matching aren't available.
- \[Recommended\] **Partial IP Lookback** — Uses a less precise version of the IP address. Set to `24` hours to expand probabilistic matching coverage for impression attribution.
...
<div style={{ width: "55%", margin: "0 auto" }}>
  <Frame>
    ![Image](/images/mobile-integrations/kochava/kochava_impression_reconciliation_android.png "Image")
  </Frame>
</div>
...
- \[Recommended\] **Fingerprint Lookback** — Uses fingerprinting when device IDs aren't available. Attribution is allowed if the install/conversion occurs within 7 days after the click.
- \[Recommended\] **IP and Partial IP Lookback** — Set to `24` hours to allow Kochava to use IP-only and partial-IP matching for click attribution when device/fingerprint matching aren't available.
- **Device Attribution Behavior** — Setting it to Standard means that Kochava uses its default attribution logic and prioritization rules.
...
<div style={{ width: "53%", margin: "0 auto" }}>
  <Frame>
    ![Image](/images/mobile-integrations/kochava/kochava_click_reconciliation_android.png "Image")
  </Frame>
</div>

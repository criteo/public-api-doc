---
title: "Criteo Integration With Kochava [iOS]"
description: "Configure your Criteo App campaign for iOS with Kochava."
---
...
<Accordion title="Expand">
  ...
  The `userStatus` event allows Kochava to identify a user's subscription status (free, subscriber, premium). This event should be triggered to initialize the user's status, and every time when user status changes. Note that _userStatus_ is not supported out of the box using Kochava's SDK and must be implemented as a custom event.
...
<Frame>
  ![Image](/images/mobile-integrations/kochava/kochava_add_configuration_ios.png "Image")
</Frame>
...
<Frame>
  ![Image](/images/mobile-integrations/kochava/kochava_select_media_partner_ios.png "Image")
</Frame>
...
<Frame>
  ![Image](/images/mobile-integrations/kochava/kochava_postbacks_tab_ios.png "Image")
</Frame>
...
<Frame>
  ![Image](/images/mobile-integrations/kochava/kochava_postback_event_status_ios.png "Image")
</Frame>
...
<Frame>
  ![Image](/images/mobile-integrations/kochava/kochava_create_postback_ios.png "Image")
</Frame>
...
<Frame>
  ![Image](/images/mobile-integrations/kochava/kochava_postback_required_settings_ios.png "Image")
</Frame>
...
<Frame>
  ![Image](/images/mobile-integrations/kochava/kochava_reconciliation_menu_ios.png "Image")
</Frame>
...
<div style={{ width: "54%", margin: "0 auto" }}>
  <Frame>
    ![Image](/images/mobile-integrations/kochava/kochava_impression_reconciliation_ios.png "Image")
  </Frame>
</div>
...
<div style={{ width: "48%", margin: "0 auto" }}>
  <Frame>
    ![Image](/images/mobile-integrations/kochava/kochava_click_reconciliation_ios.png "Image")
  </Frame>
</div>
...
<Accordion title="Click to Expand">
  ...
  <Frame>
    ![Image](/images/mobile-integrations/kochava/kochava_add_tracker_install_ios.png "Image")
  </Frame>
  ...
  <Frame>
    ![Image](/images/mobile-integrations/kochava/kochava_set_tracking_install_ios.png "Image")
  </Frame>
  ...
  <Frame>
    ![Image](/images/mobile-integrations/kochava/kochava_copy_urls_install_ios.png "Image")
  </Frame>
</Accordion>
...
<Accordion title="Click to Expand">
  ...
  <Frame>
    ![Image](/images/mobile-integrations/kochava/kochava_add_tracker_retargeting_ios.png "Image")
  </Frame>
  ...
  2. **Set the Tracking**
     - **Required:**
       ...
       - Set Destination URL: Custom / Landing page / Google Referrer
     <Frame>
       ![Image](/images/mobile-integrations/kochava/kochava_set_tracking_retargeting_ios.png "Image")
     </Frame>
     ...
     <Frame>
       ![Image](/images/mobile-integrations/kochava/kochava_select_events_retargeting_ios.png "Image")
     </Frame>
     - **Optional:**
       - Agency Partner
       - UTM Parameters
  ...
  <Frame>
    ![Image](/images/mobile-integrations/kochava/kochava_copy_urls_retargeting_ios.png "Image")
  </Frame>
</Accordion>

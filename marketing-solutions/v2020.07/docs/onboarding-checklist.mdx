...
* ✔ **Learn more about Criteo API use cases**: If you already know Criteo, read our [Is the Criteo API for you?](doc:is-criteo-api-for-you) article to have some inspiration use cases if you are not sure to use the Criteo API
* 💡 **Learn more about Criteo**: If you are new to Criteo, read our [Criteo Marketing Solutions for API users](doc:criteo-marketing-solutions) (if you are an Advertiser or an Agency) or our Criteo Publishers for API users oming soon] ( (if you are an inventory provider) to know more about Criteo API capabilities
...
* 💡 If you want to modify your Account please see our article [Managing my developer account](doc:managing-my-developer-account)
* 💡 If you want to modify your Organization please see our article [Managing my organization](doc:managing-my-organization)
...
* ✔ This fields will be editable before publishing an app (for more details see the [Managing my app](doc:managing-my-app) section)
...
* ✔ API Key will be available in the credentials table and secret will only be provided once (a file with the secret will automatically download when creating a set of credentials) please keep it preciously! For more details about credentials please see the [Create your app](doc:create-your-app) section.
...
* 💡 For more details about how to edit and delete credentials please see the [Create your app](doc:create-your-app)
...
* 💡 For more details on how does it work please see the [Send an authorization request to your users](doc:send-consent-request)

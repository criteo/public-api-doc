...
A full list of all available filters is available on the [Budgets API Technical Reference](https://developers.criteo.com/marketing-solutions/v2020.07/reference/campaigns#budgets_get) page.
...
[\[Campaigns\] Update Category-Level Bids](/marketing-solutions/v2020.07/docs/update-category-level-bids-and-manage-active-categories)

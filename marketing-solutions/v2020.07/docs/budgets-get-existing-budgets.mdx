...
A full list of all available filters is available on the [Budgets API Technical Reference](/marketing-solutions/v2020.07/api-reference/campaigns/budgets-get) page.

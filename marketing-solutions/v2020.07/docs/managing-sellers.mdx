...
The catalog can be updated from the [Criteo Product Catalog API](/marketing-solutions/v2026-preview/docs/product-importer-api) or directly from [Criteo Management Center](https://help.criteo.com/kb/guide/en/update-product-catalog-N8juQWGJuu/Steps/775633).

...
* Test our requests on the Criteo API within an interactive UI format using our [Criteo API Swagger Tool](https://developers.criteo.com/marketing-solutions/v2020.07/reference/authorization-1)
...
* Connect with other to chat about questions or wins in Criteo’s Developer Community [Discussion Forum](https://developers.criteo.com/marketing-solutions/discuss)

## Additional Support

Please feel free to reach out to [\[email protected\]](https://www.criteo.com/contact/) if you have any additional issues or questions!
...
* [Go to our API Reference](https://developers.criteo.com/marketing-solutions/v2020.07/reference/authorization-1)

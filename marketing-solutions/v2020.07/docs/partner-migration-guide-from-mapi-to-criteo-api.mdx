...
* Test our requests on the Criteo API within an interactive UI format using our [Criteo API Swagger Tool](/marketing-solutions/v2020.07/reference/apiv1oauth2tokenpost)

...
<CodeGroup>
  ...
  curl --request PATCH \
    ...
    --data '{"identifiers":["abc@gmail.com","def@yahoo.com","ghi@msn.com","jkl@gmail.com"],"operation":"add","schema":"email"}'
  ```
</CodeGroup>
...
<CodeGroup>
  ...
  curl --request PATCH \
    ...
    --header 'Accept: application/json' \
    --header 'Content-Type: text/json' \
    --data '{"identifiers":["abc@gmail.com","def@yahoo.com","ghi@msn.com","jkl@gmail.com"],"operation":"remove","schema":"email"}'
  ```
</CodeGroup>

...
💡 You can change the name of your set of credentials by clicking directly on the credentials name on in the dashboard. For example: Troubleshooting Credentials, Production Credentials, etc. 💡 You will be limited to 5 API credentials at for an App (for ex. 1 for production, 1 for troubleshooting and 3 others for any other use case you can imagine)

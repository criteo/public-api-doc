...
```
https://api.criteo.com/2025-10/marketing-solutions/ad-sets/{adSetId}/display-multipliers
```
...
  **`campaign--display-multiplier-update-check--category-not-enabled`** The category targeted by the display multiplier is not enabled.

  **`campaign--display-multiplier-update-check--invalid-display-multiplier`** The value provided in the display multiplier field is not valid. Expected values are between 0.5 and 2.0, inclusive.  \\

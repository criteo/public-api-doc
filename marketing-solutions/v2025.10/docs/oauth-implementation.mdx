...
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Performance_Media/v2025_10/docs/Concepts/oauth-implementation/index.md
---
...
> <InlineImage src="/images/marketing-solutions/v2025.10/docs/public/img/emojis/owlbert-thinking.png" alt="owlbert thinking" /> **NOTE** <br />
>
> In this guide, we assume you have created a developer account, and your application has access to a organization within Criteo. Instructions for getting started can be found [here](/marketing-solutions/v2025.10/docs/onboarding-checklist).
...
![f9829c8 auth_methods2](/images/marketing-solutions/v2025.10/docs/f9829c8-auth_methods2.png)
...
<Frame caption="Source: [https://auth0.com/docs/get-started/authentication-and-authorization-flow/client-credentials-flow](https://auth0.com/docs/get-started/authentication-and-authorization-flow/client-credentials-flow)">
  <img src="/images/marketing-solutions/v2025.10/docs/a324441-client_credentials_v2.png" alt="Source: [https://auth0.com/docs/get-started/authentication-and-authorization-flow/client-credentials-flow](https://auth0.com/docs/get-started/authentication-and-authorization-flow/client-credentials-flow)" />
</Frame>
...
<Frame caption="**Source**: [https://auth0.com/docs/get-started/authentication-and-authorization-flow/authorization-code-flow](https://auth0.com/docs/get-started/authentication-and-authorization-flow/authorization-code-flow)">
  <img src="/images/marketing-solutions/v2025.10/docs/1c88391-authcodev4.png" alt="**Source**: [https://auth0.com/docs/get-started/authentication-and-authorization-flow/authorization-code-flow](https://auth0.com/docs/get-started/authentication-and-authorization-flow/authorization-code-flow)" />
</Frame>

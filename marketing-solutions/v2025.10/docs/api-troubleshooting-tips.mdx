...
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Performance_Media/v2025_10/docs/Resources/api-troubleshooting-tips.md
---
...
<table>
  ...
  <tbody>
    <tr>
      <td>178.250.0.0/21<br />185.235.84.0/22<br />91.212.98.0/24<br />91.199.242.0/24<br />2a02:2638::/32</td>
...
Usually if advertiser hasn't given a consent to your app you will get an error in 4xx range. Part 1 of the tutorial covers 4xx error series in more detail here: [How to handle API errors](/marketing-solutions/v2025.10/docs/api-error-types).\
In order to perform a quick check whether an advertiser has given consent to the app you can query [/advertisers/me endpoint](https://developers.criteo.com/marketing-solutions/reference-link/apiportfolioget) and see if it returns advertiser ID that you expect. 
...
Part 1 of the tutorial covers 4xx error series in more detail here: [How to handle API errors](/marketing-solutions/v2025.10/docs/api-error-types). 
...
Starting from [How to handle API errors - Part 1](/marketing-solutions/v2025.10/docs/api-error-types) to now, we have focused on common issues that can arise with the API. 
...
<table>
  ...
  <tbody>
    <tr>
      <td>Revenue and basic metrics, including:<br /><ul><li>Displays, clicks, advertiser cost</li></ul><br />Revenue metrics<br /><ul><li>Revenue-based ROI: ECoS and related metrics</li><li>Sales and derivative metrics:</li><li>Sales data</li><li>Conversion data</li><li>Conversion-based ROI: CPO, CPI, and related metrics</li></ul></td>
      <td>12 hours</td>
      <td>5 hours</td>
    </tr>
    <tr>
      <td>Audience metrics:<br />Potential users<br />Exposed users<br />Displays</td>
      <td>19 hours</td>
      <td>7 hours</td>
    </tr>
    <tr>
      <td>Omnichannel metrics</td>
      <td>207 hours</td>
      <td>197 hours</td>
    </tr>
  </tbody>
...
Aligning the timezones and the date ranges in the API request body and the platform UI (whether Criteo Commerce Growth or a third-party platform) will resolve the issue most of the time. Check [this document](/marketing-solutions/v2025.10/docs/campaign-statistics#timezones) for the list of supported timezones.

**Attribution scope**

Please view [this document](/marketing-solutions/v2025.10/docs/campaign-statistics#metrics) for the list of supported metrics in the Criteo API.  

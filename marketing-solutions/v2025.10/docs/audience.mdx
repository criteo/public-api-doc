---
title: Audience
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Performance_Media/v2025_10/docs/Marketing Solutions Endpoints/audiences/audience.md
---

<Warning>
  The new audience endpoints function according to the bulk operation logic. Before using this endpoint in production, please ensure you are familiar with the [Partial Success For Bulk Operation document](/marketing-solutions/v2025.10/docs/partial-success-for-bulk-operations).
</Warning>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>algebra</td>
      <td><a href="/marketing-solutions/v2025.10/docs/algebra-nodes">Algebra Node</a></td>
      <td>Required</td>

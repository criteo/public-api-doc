...
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Performance_Media/v2025_10/docs/Concepts/api-error-types.md
---
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>If Criteo API responded with 401 it means that there is an issue with authentication, e.g invalid authentication credentials, or an expired token was supplied with the request. Please check <a href="/marketing-solutions/v2025.10/docs/authentication">Authentication</a> for further information.</td>
    </tr>
    <tr>
      <td>403</td>
      <td>Forbidden</td>
    ...
    <tr>
      <td>404</td>
      <td>Not found</td>
      <td>Check correctness of the URL being called. Reference list of the endpoints can be found <a href="https://developers.criteo.com/marketing-solutions/reference/apiv1oauth2tokenpost">here</a>.</td>
    </tr>
    <tr>
      <td>413</td>
    ...
    <tr>
      ...
      <td>Limit is 100 requests per minute per application. More details <a href="/marketing-solutions/v2025.10/docs/rate-limits-1">here</a>.</td>
    </tr>
    <tr>
      <td>500</td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>"Campaigns are unavailable"</td>

...
<Danger>
  If you are using one of the following versions and endpoints, we advise you to migrate your applications to a newer version : [**2025-10**](/marketing-solutions/v2025.10/reference/oauth/v-1-oauth-2-token-post).

...
**`offset`** 0 based index of the first ad to return in the response. The default is 0.

**`limit`** The number of ads to be returned. The default is 50.
...
[Creatives](/marketing-solutions/v2025.10/docs/creative)

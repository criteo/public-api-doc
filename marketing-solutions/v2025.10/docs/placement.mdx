...
The metrics are similar to the ones provided in the [Statistics endpoint](https://developers.criteo.com/marketing-solutions/docs/campaign-statistics), but the dimensions allow for seeing performance across the different placements available in a campaign's inventory.

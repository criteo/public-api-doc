...
<table>
  ...
  <tbody>
    <tr>
      <td><a href="/marketing-solutions/docs/oauth-app-client-credentials">Client Credentials</a></td>
      <td>250 calls per minute</td>
      <td>Application level</td>
    </tr>
    <tr>
      <td><a href="/marketing-solutions/docs/oauth-app-authorization-code">Authorization Code</a></td>

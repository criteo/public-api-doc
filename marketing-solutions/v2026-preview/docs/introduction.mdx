...
If you’re interested in testing the preview version, you can check out its documentation in this section. For the stable endpoints and other detailed documentation, you can check the [current Criteo API version](https://developers.criteo.com/marketing-solutions/docs).

...
This endpoint creates a request for [Campaign Statistics](/marketing-solutions/v2026-preview/docs/campaign-statistics) or [Audience Performance](/marketing-solutions/docs/async-audience-performance) report:

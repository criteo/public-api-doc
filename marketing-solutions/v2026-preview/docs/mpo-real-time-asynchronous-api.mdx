...
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Performance_Media/v2026-preview/docs/MarketPlace Outcome (MPO)/mpo-real-time-asynchronous-api.md
---
...
<Info>
  This endpoint is referenced [here](https://developers.criteo.com/marketing-solutions/v2026-preview/reference/createrealtimeproductreport).
</Info>
...
<Info>
  This endpoint is referenced [here](https://developers.criteo.com/marketing-solutions/v2026-preview/reference/getrealtimeproductjob).
</Info>
...
<Info>
  This endpoint is referenced [here](https://developers.criteo.com/marketing-solutions/v2026-preview/reference/getrealtimeproduct).
</Info>

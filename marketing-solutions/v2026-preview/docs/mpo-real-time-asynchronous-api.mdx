...
<Warning>
  **BETA Access**  
  The API is currently in **beta** and is only available to a limited list of clients onboarded by the Criteo technical team. You can find the reference for the endpoints mentioned in the page in [the **Preview** version](/marketing-solutions/v2026-preview/reference/getrealtimeproduct) of this documentation.
</Warning>
...
<Info>
  This endpoint is referenced [here](/marketing-solutions/v2026-preview/reference/createrealtimeproductreport).
</Info>
...
<Info>
  This endpoint is referenced [here](/marketing-solutions/v2026-preview/reference/getrealtimeproductjob).
</Info>
...
<Info>
  This endpoint is referenced [here](/marketing-solutions/v2026-preview/reference/getrealtimeproduct).
</Info>

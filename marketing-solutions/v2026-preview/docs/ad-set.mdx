...
The attribution method that defines how sales will be attributed to the marketing campaign. Can be `CriteoAttribution`, `GoogleAnalyticsLastClick`, `GoogleAnalyticsDataDriven`, `LastClick`, `PostClick`, `googleAnalytics`, `sftp`.

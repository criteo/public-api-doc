---
title: Category Bids
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Performance_Media/v2026-preview/docs/Preview Endpoints/campaigns/category-bids.md
---
<Warning>
...
<Warning>
  ...
  * Ad set must be set with CPC or CPM as cost controller (more details on cost controller [here](/marketing-solutions/v2026-preview/docs/ad-set#ad-set-attributes#ad-set-bidding)). If your ad set uses another cost controller, you must refer to the [Display Multipliers](/marketing-solutions/v2026-preview/docs/display-multipliers) solution.
</Warning>
...
<Danger>
  **Updating Multiple Category Bids**
  ...
  This endpoint allows you to update several category bids within a single call. Thus it\`s important to understand the [partial success behavior](/marketing-solutions/v2025.07/docs/partial-success-for-bulk-operations).
</Danger>
...
In addition to [general API errors](/marketing-solutions/v2025.07/docs/api-error-types), you may encounter validation errors when retrieving or updating a category bid.
...
Category bid is only available on ad set with CPC-based or CPM-based cost controllers. If your ad set uses other cost controller, you must refer to the [Display Multipliers](/marketing-solutions/v2026-preview/docs/display-multipliers).\
 \
   

...
<Warning>
  ...
  * Ad set must be set with CPC or CPM as cost controller (more details on cost controller [here](doc:ad-set#ad-set-attributes#ad-set-bidding)). If your ad set uses another cost controller, you must refer to the [Display Multipliers](doc:display-multipliers) solution.
</Warning>
...
```
https://api.criteo.com/preview/marketing-solutions/ad-sets/{ad-set-id}/category-bids
```
...
[Ad Set-Level Targeting](/marketing-solutions/v2026-preview/docs/ad-set-level-targeting)

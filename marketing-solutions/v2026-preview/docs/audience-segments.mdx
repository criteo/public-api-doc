...
| Field name            | Type                                                             | Optional / Required / Computed           | Description                                                                                                                                                                        |
| --------------------- | ---------------------------------------------------------------- | ---------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| UsersType             | UsersTypeCan take two values:-`Prospects`-`ProspectsOrNonBuyers` | Required                                 | The type of users included in the segment.If you want clients similar to your visitors select '*prospects*'. If you also want to include non buyers, select *ProspectsOrNonBuyers* |
...
![](/images/marketing-solutions/v2026-preview/docs/1e25c4c-delete.png)
...
[Audience](/marketing-solutions/v2026-preview/docs/audience)

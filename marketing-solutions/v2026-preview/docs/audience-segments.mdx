...
<table>
 ...
 <tbody>
  ...
  <tr>
   <td>
    <p>
     <a href="/marketing-solutions/v2026-preview/docs/audience-segments#operations">
      interestIds
     </a>
    </p>
   </td>
 ...
 <tbody>
  <tr>
   ...
   <td>
    ...
    <p>
     If you want clients similar to your visitors select 'prospects'. If you also want to include non buyers, select ProspectsOrNonBuyers
    </p>
   </td>
  </tr>
  <tr>
...
```json Sample Response (Success) expandable
{
  "data": [
    {
      "id": "1001",

...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>Week</td>
      <td>Weekly aggregations in datetime format YYYY-MM-DD where the first day is Monday</td>
    </tr>
    <tr>
      <td>Month</td>
      <td>Monthly aggregations in datetime format YYYY-MM-01</td>
    </tr>
    <tr>
      <td>Year</td>
      <td>Yearly aggregations in datetime format YYYY-01-01</td>
    </tr>
    <tr>
      <td>Os</td>
      <td>Os used to acces the Ad</td>
    </tr>
    <tr>
      <td>Device</td>
      <td>Device used to acces the Ad</td>
    </tr>
    <tr>
      <td>CampaignId</td>
    ...
    <tr>
      <td>MarketingCampaignGoal</td>
      <td>Objective of a marketing campaign</td>
    </tr>
    <tr>
      <td>VideoPlayerSize</td>
      <td>Dimensions of the video player</td>
    </tr>
    <tr>
      <td>VideoPlacement</td>
      <td>Location where video ad is displayed</td>
    </tr>
    <tr>
      <td>VideoPlaybackMethod</td>
      <td>Manner in which the video ad is played</td>
    </tr>
    <tr>
      <td>SSP</td>
      <td>Supply-side platform, a technology platform for managing and selling digital ad inventory.</td>
    </tr>
    <tr>
      <td>VideoDurationInSeconds</td>
      <td>Length of a video ad in seconds</td>
    </tr>
    <tr>
      <td>MediaType</td>
      <td>Type of media, such as video, audio, or image</td>
    </tr>
    <tr>
      <td>AdFormat</td>
      <td>Format in which an advertisement is presented</td>
    </tr>
    <tr>
      <td>DisplaySize</td>
      <td>Dimensions of the advertisement on a webpage</td>
    </tr>
    <tr>
      <td>VideoPlayerRatio</td>
      <td>Aspect ratio of the video player</td>
    </tr>
    <tr>
      <td>Country</td>
      <td>Geographic location of a user</td>
    </tr>
    <tr>
      <td>Region</td>
      <td>Geographic area within a country</td>
    </tr>
    <tr>
      <td>PostalCode</td>
      <td>Numeric code for a geographic area</td>
    </tr>
    <tr>
      <td>UserBehavior</td>
      <td>Actions of a user, such as clicks or purchases.</td>
    </tr>
  </tbody>
</table>

...
  The default time zone for requests is UTC. See [this link](/marketing-solutions/v2024.01/docs/campaign-statistics#timezones) for more information on supported time zones.

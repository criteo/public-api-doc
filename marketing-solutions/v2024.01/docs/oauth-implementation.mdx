...
>
> In this guide, we assume you have created a developer account, and your application has access to a organization within Criteo. Instructions for getting started can be found [here](doc:onboarding-checklist).

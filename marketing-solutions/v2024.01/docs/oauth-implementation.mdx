...
For more information check out the app setup process for [Client Credentials](/marketing-solutions/docs/client-credentials-setup)
...
For more information check out the app setup process for [Authorization Code](/marketing-solutions/docs/authorization-code-setup)

...
> <InlineImage src="/images/marketing-solutions/v2024.01/docs/public/img/emojis/owlbert-thinking.png" alt="owlbert thinking" /> **NOTE**
>
> In this guide, we assume you have created a developer account, and your application has access to a organization within Criteo. Instructions for getting started can be found [here](/marketing-solutions/v2024.01/docs/onboarding-checklist).
...
![](/images/marketing-solutions/v2024.01/docs/f9829c8-auth_methods2.png)
...
<Frame caption="Source:">
  <img src="/images/marketing-solutions/v2024.01/docs/a324441-client_credentials_v2.png" />

  [https://auth0.com/retail-media/docs/demand-side-analytics-get-started/authentication-and-authorization-flow/client-credentials-flow](https://auth0.com/retail-media/docs/demand-side-analytics-get-started/authentication-and-authorization-flow/client-credentials-flow)
</Frame>
...
For more information check out the app setup process for [Client Credentials](https://developers.criteo.com/marketing-solutions/docs/client-credentials-setup)
...
<Frame caption="Source:">
  <img src="/images/marketing-solutions/v2024.01/docs/1c88391-authcodev4.png" />

  [https://auth0.com/retail-media/docs/demand-side-analytics-get-started/authentication-and-authorization-flow/authorization-code-flow](https://auth0.com/retail-media/docs/demand-side-analytics-get-started/authentication-and-authorization-flow/authorization-code-flow)
</Frame>
...
For more information check out the app setup process for [Authorization Code](https://developers.criteo.com/marketing-solutions/docs/authorization-code-setup)

***

[Coupon](/marketing-solutions/v2024.01/docs/coupon)

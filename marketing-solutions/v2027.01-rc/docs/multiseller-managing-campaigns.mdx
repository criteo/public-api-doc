...
* have a bid (see "[Setting the Bid for a given Seller-Campaign](/marketing-solutions/v2027.01-rc/docs/managing-campaigns#setting-the-bids-of-seller-campaigns)" section),
* have an active budget (see "[Managing Budgets](/marketing-solutions/v2027.01-rc/docs/managing-budgets)" section),
...
* set the bid of the Seller-Campaign to null (see "[Setting the Bid for a given Seller-Campaign](/marketing-solutions/v2027.01-rc/docs/managing-campaigns#setting-the-bids-of-seller-campaigns)" section),
* suspend the current budget (see "[Suspend a Budget](/marketing-solutions/v2027.01-rc/docs/managing-budgets#suspending-budgets)" section),

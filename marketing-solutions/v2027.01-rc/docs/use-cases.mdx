...
* Using the [PATCH /ad-sets endpoint](/marketing-solutions/v2027.01-rc/docs/ad-set#update-ad-sets), you can adjust your bidding at any time you decide
...
* You can then implement a feedback loop with your rules and your performance to adjust your bids accordingly with the [PATCH /ad-sets endpoint](/marketing-solutions/v2027.01-rc/docs/ad-set#update-ad-sets), leading to a more efficient ROI and campaign performance

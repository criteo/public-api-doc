...
<Info>
  You can find more information about the OAuth implementation on [this page](/marketing-solutions/v2027.01-rc/docs/oauth-implementation).
</Info>
...
<Info>
  More information about the Auth endpoint is available in [the API Reference documentation](/marketing-solutions/v2027.01-rc/reference/authorization/get-token) and in [our dedicated guide](/marketing-solutions/v2027.01-rc/docs/authentication).
</Info>
...
* [Send an Authorization Request to Your Users](/marketing-solutions/v2027.01-rc/docs/send-an-authorization-request-to-your-users)
* [Start Using Your API Connection](/marketing-solutions/v2027.01-rc/docs/start-using-your-api-connection)

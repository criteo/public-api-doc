...
For low-latency / near real-time monitoring, use the [**MPO Real-Time Asynchronous API**](/marketing-solutions/v2027.01-rc/docs/getting-realtime-mpo-statistics) instead.
...
Use the [**Real-Time API**](/marketing-solutions/v2027.01-rc/docs/getting-realtime-mpo-statistics) when you need:

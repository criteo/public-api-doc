...
For more information on authentication, see [our Authentication guide](/marketing-solutions/v2027.01-rc/docs/authentication).
...
The default time zone for requests is UTC.  See [this page](/marketing-solutions/v2027.01-rc/docs/campaign-statistics#timezones) for more information on supported time zones.

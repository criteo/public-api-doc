...
Once you have [created your organization](/marketing-solutions/v2027.01-rc/docs/create-your-organization), you can access the `My Apps` page to begin creating your application. This page is also where you will manage your Criteo API applications.
...
* Criteo’s API supports two OAuth authentication methods: [Client Credentials](/marketing-solutions/v2027.01-rc/docs/client-credentials-setup) and [Authorization Code](/marketing-solutions/v2027.01-rc/docs/authorization-code-setup). Each method has its own advantages, so before proceeding, we strongly recommend reviewing which authentication method is best suited to your application’s needs.
...
<Info>
  **Trying to decide which OAuth method is right for you?**
  ...
  If you're unsure which authentication method to use, take a look at our [OAuth App Implementation](/marketing-solutions/v2027.01-rc/docs/oauth-implementation) guide for an overview of each authentication method.
</Info>

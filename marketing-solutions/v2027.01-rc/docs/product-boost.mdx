...
```curl
curl -L -X GET 'https://api.criteo.com/{version}/marketing-solutions/ads/1234567890/product-boost' \
...
```curl
curl -L -X GET 'https://api.criteo.com/{version}/marketing-solutions/ads/1234567890/product-boost/9876543210' \
-H 'Accept: application/json' \
-H 'Authorization: Bearer <MY_ACCESS_TOKEN>'
```
...
```curl
curl -L -X POST 'https://api.criteo.com/{version}/marketing-solutions/ads/1234567890/product-boost/9876543210' \
...
```curl
curl -L -X DELETE 'https://api.criteo.com/{version}/marketing-solutions/ads/1234567890/product-boost/9876543210' \
-H 'Accept: application/json' \
-H 'Authorization: Bearer <MY_ACCESS_TOKEN>'
```
...
```curl
curl -L -X GET 'https://api.criteo.com/{version}/marketing-solutions/dataset/5544332211/product-boost?client-type=CMax' \
-H 'Accept: application/json' \
-H 'Authorization: Bearer <MY_ACCESS_TOKEN>'
```

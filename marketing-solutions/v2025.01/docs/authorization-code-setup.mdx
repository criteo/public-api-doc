...
2. **Authentication method**
   1. Select your app authentication method. You will have the option to select Client Credentials or Authorization Code. To decide which option is best for your organization, review our [OAuth implementation](doc:oauth-implementation) guide. ![](/images/marketing-solutions/v2025.01/docs/190da94-auth_methods.png)

...
| 401       | Authentication error        | If Criteo API responded with 401 it means that there is an issue with authentication, e.g invalid authentication credentials, or an expired token was supplied with the request. Please check [Authentication](/marketing-solutions/v2025.01/docs/authentication) for further information.                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
[Consent URL Generation](/marketing-solutions/v2025.01/docs/consent-url-generation)

[Partial Success for Bulk Operations](/marketing-solutions/v2025.01/docs/partial-success-for-bulk-operations)

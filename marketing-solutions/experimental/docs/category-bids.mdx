...
<Warning>
  ...
  * Ad set must be set with CPC or CPM as cost controller (more details on cost controller [here](/marketing-solutions/experimental/docs/ad-set#ad-set-attributes#ad-set-bidding)). If your ad set uses another cost controller, you must refer to the [Display Multipliers](/marketing-solutions/experimental/docs/display-multipliers) solution.
</Warning>
...
```http
https://api.criteo.com/experimental/marketing-solutions/ad-sets/{ad-set-id}/category-bids
```
</EndpointBadge>
...
Category bid is only available on ad set with CPC-based or CPM-based cost controllers. If your ad set uses other cost controller, you must refer to the [Display Multipliers](/marketing-solutions/experimental/docs/display-multipliers).\
 \
   

...
```http
https://api.criteo.com/experimental/advertisers/{advertiserId}/targeting/domain-rules
```
</EndpointBadge>
...
<EndpointBadge method="get">
```http
https://api.criteo.com/experimental/advertisers/{advertiserId}/targeting/bundle-rules
```
</EndpointBadge>

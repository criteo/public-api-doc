  ...
  "errors" : [
    {
      ...
      "type" : "validation",
      "code" : "batch-empty",
      "instance" : "/experimental/catalog/products/batch",
...
HTTP GET /experimental/catalog/products/batch/report/eyJhbGciOiJub25lIn0.eyJwYXJ0bmVySWQiOjEyLCJvcGVyYXRpb25JZCI6IjQyOTUyMzFmLWVmYTMtNDQzMy05NjA4LWI0ZDdkZTJjOThiNyIsImV4cCI6MTYxNjE0NTEzNX0.
```
...
```http Example Request
HTTP GET /experimental/catalog/products/batch/report/invalidToken
```
  ...
  "errors" : [
    {
      ...
      "instance" : "/experimental/catalog/products/batch/report/invalidToken",
...
```http Example Request
HTTP GET /experimental/catalog/products/batch/report/eyJhbGciOiJub25lIn0.eyJwYXJ0bmVySWQiOjEyLCJvcGVyYXRpb25JZCI6ImM2NjliZmM1LTYzMWEtNDE3Mi05ODhiLTM0OTdlZDg3OThmZiIsImV4cCI6MTYxNjE0NTEzNX0.
```
  ...
  "errors" : [
    {
      ...
      "type" : "authorization",
      "code" : "not-authorized",
      "instance" : "/experimental/catalog/products/batch/report/eyJhbGciOiJub25lIn0.eyJwYXJ0bmVySWQiOjEsIm9wZXJhdGlvbklkIjoib3BlcmF0aW9uX2lkX3Rlc3QiLCJleHAiOjE2MTYwNjEwMTN9.",
      "title" : "User is not authorized",
      "detail" : ""
    }
  ],
  ...
  "errors" : [
    {
      ...
      "instance" : "/experimental/catalog/products/batch/report/eyJhbGciOiJub25lIn0.eyJwYXJ0bmVySWQiOjEyLCJvcGVyYXRpb25JZCI6ImM2NjliZmM1LTYzMWEtNDE3Mi05ODhiLTM0OTdlZDg3OThmZiIsImV4cCI6MTYxNjE0NTEzNX0.",

...
The attribution method that defines how sales will be attributed to the marketing campaign. Can be `criteoAttribution`, `lastClick`, `postClick`, `googleAnalytics`, `sftp`.

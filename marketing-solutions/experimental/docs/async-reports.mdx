...
This endpoint creates a request for [Campaign Statistics](/marketing-solutions/experimental/docs/campaign-statistics) or [Audience Performance](/marketing-solutions/experimental/docs/audience-performance) report:

<EndpointBadge method="post">
```http
https://api.criteo.com/experimental/reports/async-statistics
```
</EndpointBadge>

<EndpointBadge method="post">
```http
https://api.criteo.com/experimental/reports/async-audience-performance
```
</EndpointBadge>
...
```bash
curl -X POST "https://api.criteo.com/experimental/reports/async-statistics" \
...
```http
https://api.criteo.com/experimental/reports/{reportId}/status
```
</EndpointBadge>
...
```bash cURL
curl -X GET "https://api.criteo.com/experimental/reports/ZWQ1ZDYxY2EtUWNlNy00Nyk0LWFkN1ktY2Q5ZWGyMzA0ZTU0fEzVUnxFdXMvcGZvUGFaaXM=/status" \
    -H "Authorization: Bearer myaccesstoken"
```
...
<EndpointBadge method="get">
```http
https://api.criteo.com/experimental/reports/{reportId}/output
```
</EndpointBadge>
...
```bash cURL
curl -X GET "https://api.criteo.com/experimental/reports/ZWQ1ZDYxY2EtUWNlNy00Nyk0LWFkN1ktY2Q5ZWGyMzA0ZTU0fEzVUnxFdXMvcGZvUGFaaXM=/output" \
    -H "Authorization: Bearer myaccesstoken"
```

...
 \
The default time zone for requests is UTC.  See this link for more information on [supported time zones](/marketing-solutions/experimental/docs/campaign-statistics#timezones).

...
A new campaign can be created for a specific advertiser by making a POST call to the campaigns endpoint. The request body should specify the type (`Campaign`) and the [campaign attributes](/marketing-solutions/experimental/docs/campaign#campaign-attributes).
...
```http
https://api.criteo.com/experimental/marketing-solutions/campaigns
```
</EndpointBadge>
...
<EndpointBadge method="post">
```http
https://api.criteo.com/experimental/marketing-solutions/campaigns/search
```
</EndpointBadge>
...
```http
https://api.criteo.com/experimental/marketing-solutions/campaigns/{campaignId}
```
</EndpointBadge>
...
A full list of error codes can be found on the [Validation Errors](/marketing-solutions/experimental/docs/campaign#validation-errors-and-warnings) page at the end of this section.  

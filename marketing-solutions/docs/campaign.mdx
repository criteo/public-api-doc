...
```http
https://api.criteo.com/2026-07/marketing-solutions/campaigns
```
</EndpointBadge>
...
<EndpointBadge method="post">
```http
https://api.criteo.com/2026-07/marketing-solutions/campaigns/search
```
</EndpointBadge>
...
```http
https://api.criteo.com/2026-07/marketing-solutions/campaigns/{campaign-id}
```
</EndpointBadge>

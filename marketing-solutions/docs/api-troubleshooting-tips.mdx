...
In order to perform a quick check whether an advertiser has given consent to the app you can query [/advertisers/me endpoint](/marketing-solutions/reference/listadvertisers) and see if it returns advertiser ID that you expect. 

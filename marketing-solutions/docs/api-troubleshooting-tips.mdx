...
In order to perform a quick check whether an advertiser has given consent to the app you can query [/advertisers/me endpoint](/marketing-solutions/api-reference/advertiser/list-advertisers) and see if it returns advertiser ID that you expect. 

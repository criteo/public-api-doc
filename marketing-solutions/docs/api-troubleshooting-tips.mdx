...
In order to perform a quick check whether an advertiser has given consent to the app you can query [/advertisers/me endpoint](/marketing-solutions/v2026.07/reference/list-advertisers) and see if it returns advertiser ID that you expect. 

...
<table>
  ...
  <tbody>
    <tr>
      <td>ManuallyStopped</td>
      <td>Campaign manually paused</td>
      <td>Resume via budget</td>
    </tr>
    <tr>
      <td>NoBudgetDefined</td>
      <td>No valid budget linked</td>
      <td>Create a budget</td>
    </tr>
    <tr>
      <td>NoCpcDefined</td>
      <td>No CPC set</td>
      <td>Set CPC via API</td>
    </tr>
    <tr>
      <td>NoMoreBudget</td>
    ...
    <tr>
      <td>RemovedFromCatalog</td>
      <td>Products removed</td>
      <td>Restore products</td>
    </tr>
    <tr>
      <td>NotYetStarted</td>
      <td>Newly created</td>
    ...
    <tr>
      <td>NoMoreDailyBudget</td>
      <td>Daily limit reached</td>
      <td>Wait for daily reset</td>
    </tr>
    <tr>
      <td>Other</td>
      <td>Internal/system issue</td>
      <td>Contact your Criteo team</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      <td>Single-Seller + no productSet (default)</td>
      <td>Yes</td>
      <td>All eligible products from the seller are used.</td>
    </tr>
    <tr>
      <td>Single-Seller + one <code>IsIn</code> rule on <code>ExternalItemId</code></td>
      <td>Yes</td>
      <td>Recommended pattern for SKU restriction.</td>
    </tr>
    <tr>
      <td>Multiple <code>productSet</code> rules per Single-Seller</td>
      <td>No</td>
      <td>Updates replace the existing rule.</td>
    </tr>
    <tr>
      <td><code>productSet</code> on a multi-seller campaign</td>
      <td>No</td>
      <td></td>
    </tr>
  </tbody>

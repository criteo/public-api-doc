...
```http POST
POST  https://api.criteo.com/2026-07/marketing-solutions/marketplace-performance-outcomes/budgets/{budgetId}
...
```http
PATCH  https://api.criteo.com/2026-07/marketing-solutions/marketplace-performance-outcomes/seller-campaigns
Content-Type: application/json
```

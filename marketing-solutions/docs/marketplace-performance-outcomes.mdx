...
<Columns cols={3}>
  <Card title="Campaigns - Concept Guide" href="/marketing-solutions/docs/campaigns-concept-guide">
    Start by exploring the campaign-related concepts.
  </Card>

  <Card title="Quick Start" href="/marketing-solutions/docs/quick-start-launch-a-single-seller-campaign-via-mpo">
    Learn how to quick start by launching a Single-Seller Campaign via MPO.
  </Card>

  <Card title="Managing Sellers" href="/marketing-solutions/docs/managing-sellers">
    Explore the endpoints for seller management via API.
  </Card>

  <Card title="Managing Campaigns" href="/marketing-solutions/docs/managing-campaigns">
    Explore the endpoints allowing to manage campaigns.
  </Card>

  <Card title="Managing Budgets" href="/marketing-solutions/docs/managing-budgets">
    Explore the programmatic ways to manage budgets.
  </Card>

  <Card title="Getting Statistics" href="/marketing-solutions/docs/getting-statistics">

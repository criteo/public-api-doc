...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Return budgets that end after the given date. Default is today (<code>yyyy-MM-DD</code>).</td>
      <td>string</td>
      <td>No</td>
    </tr>
    <tr>
      <td><code>startBeforeDate</code></td>
      <td>Return budgets that start on or before the given date. Default is to not filter on startDate.</td>
      <td>string</td>
      <td>No</td>
    </tr>
    <tr>

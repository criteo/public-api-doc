...
```http
POST  https://api.criteo.com/2026-07/marketing-solutions/marketplace-performance-outcomes/budgets
...
```http
PATCH  https://api.criteo.com/2026-07/marketing-solutions/marketplace-performance-outcomes/budgets
Content-Type: application/json
```

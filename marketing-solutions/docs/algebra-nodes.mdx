...
Algebra nodes are the way to mix different Audience Segments. For example, you can use them when you want to include users that belong to more than one segment at the time or if you want to exclude users of a specific segment.
...
[Campaigns](/marketing-solutions/docs/campaigns)

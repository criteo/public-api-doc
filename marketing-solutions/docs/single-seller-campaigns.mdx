...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Single-Seller requires budget-based control (template must use budget as cost controller)</td>
    </tr>
    <tr>
      <td>Budget types</td>
    ...
    <tr>
      ...
      <td>Automatic smoothing: total budget distributed over the period, with daily caps recomputed</td>
    </tr>
  </tbody>
</table>
...
<Info>
  You can find more details about all MPO endpoints in our API Reference [here](https://developers.criteo.com/marketing-solutions/reference/getmarketplaceadvertisers).
</Info>

...
```http
https://api.criteo.com/2026-07/marketing-solutions/marketplace-performance-outcomes/budgets
```
</EndpointBadge>
...
<EndpointBadge method="patch">
```http
https://api.criteo.com/2026-07/marketing-solutions/marketplace-performance-outcomes/budgets/{budgetId}
```
</EndpointBadge>
...
<Info>
  You can find more details about all MPO endpoints in our API Reference [here](/marketing-solutions/reference/campaign/get-marketplace-advertisers).
</Info>

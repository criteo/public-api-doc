...
```http
https://api.criteo.com/2026-07/marketing-solutions/product-sets
```
</EndpointBadge>
...
```http
https://api.criteo.com/2026-07/marketing-solutions/product-sets/{product-set-id}
```
</EndpointBadge>
...
<EndpointBadge method="get">
```http
https://api.criteo.com/2026-07/marketing-solutions/product-sets/dataset/{dataset-id}
```
</EndpointBadge>
...
<EndpointBadge method="post">
```http
https://api.criteo.com/2026-07/marketing-solutions/product-sets/preview
```
</EndpointBadge>
...
<EndpointBadge method="post">
```http
https://api.criteo.com/2026-07/marketing-solutions/ads/{ad-id}/product-filter
```
</EndpointBadge>
...
<EndpointBadge method="get">
```http
https://api.criteo.com/2026-07/marketing-solutions/product-sets/{product-set-id}/product-filters
```
</EndpointBadge>

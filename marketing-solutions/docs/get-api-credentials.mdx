...
<Info>
  More information about the Auth endpoint is available in [the API Reference documentation](/marketing-solutions/api-reference/authorization/get-token) and in [our dedicated guide](/marketing-solutions/docs/authentication).
</Info>

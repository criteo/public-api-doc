...
<Info>
  More information about the Auth endpoint is available in [the API Reference documentation](/marketing-solutions/reference/apiv1oauth2tokenpost) and in [our dedicated guide](/marketing-solutions/docs/authentication).
</Info>

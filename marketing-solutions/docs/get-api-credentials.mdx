...
To get started with Criteo API, you need to get **credentials** to be able to make API requests. Your credentials are made up of an **API Key** and an **API Secret**.
...
<Info>
  You can find more information about the OAuth implementation on [this page](https://developers.criteo.com/marketing-solutions/docs/oauth-implementation).
</Info>
...
![](/images/marketing-solutions/docs/24e134b87148cf42da564fcc6accc82459e078051f49a7777f392d0bbaf03686-5d0cbb5-api_keys.gif)
...
<Info>
  More information about the Auth endpoint is available in [the API Reference documentation](https://developers.criteo.com/marketing-solutions/docs/authentication) and in [our dedicated guide](https://developers.criteo.com/marketing-solutions/docs/authentication).
</Info>

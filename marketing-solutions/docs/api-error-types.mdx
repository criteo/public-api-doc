...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>If Criteo API responded with 401 it means that there is an issue with authentication, e.g invalid authentication credentials, or an expired token was supplied with the request. Please check <a href="/marketing-solutions/docs/authentication">Authentication</a> for further information.</td>
    </tr>
    <tr>
      <td>403</td>
      <td>Forbidden</td>
    ...
    <tr>
      ...
      <td>Limit is 100 requests per minute per application. More details <a href="/marketing-solutions/docs/rate-limits-1">here</a>.</td>
    </tr>
    <tr>
      <td>500</td>

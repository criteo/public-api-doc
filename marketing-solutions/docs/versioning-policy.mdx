...
<Danger>
  If you are using one of the following versions and endpoints, we advise you to migrate your applications to a newer version : [**2026-01**](/marketing-solutions/v2026.01/reference).

...
<Info>
  To stay informed about the Criteo API and upcoming changes, we recommend checking the [Changelog](/marketing-solutions/changelog) and ensuring that your contact information is up to date.
</Info>
...
<table>
 ...
 <tbody>
  <tr>
   ...
   <td>
    <p>
     <a href="/marketing-solutions/changelog/version-202501-release-notes">
      link
     </a>
    </p>
   </td>

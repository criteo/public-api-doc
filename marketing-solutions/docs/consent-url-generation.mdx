...
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Performance_Media/v2026_01/docs/Concepts/consent-url-generation.md
---
...
These guides assume you have created a developer account, are part of an organization and have created an app. Instructions for getting started can be found [here](/marketing-solutions/docs/onboarding-checklist).
...
<Frame caption="app-card.PNG">
  <img src="/images/marketing-solutions/docs/52f9f11-app-card.PNG" alt="app-card.PNG" />
</Frame>
...
<Frame caption="generate_new_url.PNG">
  <img src="/images/marketing-solutions/docs/4e1e9e0-generate_new_url.PNG" alt="generate_new_url.PNG" />
</Frame>
...
<Frame caption="app-card.PNG">
  <img src="/images/marketing-solutions/docs/b0d8b77-app-card.PNG" alt="app-card.PNG" />
</Frame>
...
<Frame caption="create-connector.PNG">
  <img src="/images/marketing-solutions/docs/eed01d6-create-connector.PNG" alt="create-connector.PNG" />
</Frame>

...
API users must be authenticated in order to make calls to the category endpoint. For more information on authentication, see [our Authentication guide](https://developers.criteo.com/marketing-solutions/docs/authentication).
...
[Audiences](/marketing-solutions/docs/audiences)

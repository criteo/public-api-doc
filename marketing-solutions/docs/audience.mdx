...
```http
 https://api.criteo.com/2026-07/marketing-solutions/audiences/create
```
</EndpointBadge>
...
```http
https://api.criteo.com/2026-07/marketing-solutions/audiences
```
</EndpointBadge>
...
<EndpointBadge method="post">
```http
https://api.criteo.com/2026-07/marketing-solutions/audiences/delete
```
</EndpointBadge>

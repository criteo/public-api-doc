---
title: Audience
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Performance_Media/v2026_01/docs/Marketing Solutions Endpoints/audiences/audience.md
---
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>String</td>
      <td>Computed</td>
      <td>Unique ID of the audience</td>
    </tr>
    <tr>
      <td><code>name</code></td>
      <td>String</td>
      <td>Required</td>
      <td>Name of the audience. It must be unique per advertiser.</td>
    </tr>
    <tr>
      <td><code>description</code></td>
      <td>String</td>
      <td>Optional</td>
      <td>Description of the audience</td>
    </tr>
    <tr>
      <td><code>createdAt</code></td>
      <td>String</td>
      <td>Computed</td>
      <td>ISO-8601 timestamp in UTC of audience creation (read-only)</td>
    </tr>
    <tr>
      <td><code>updatedAt</code></td>
      <td>String</td>
      <td>Computed</td>
      <td>ISO-8601 timestamp in UTC of audience update (read-only)</td>
    </tr>
    <tr>
      <td><code>advertiserId</code></td>
      <td>String</td>
      <td>Required</td>
      <td>Advertiser associated to the audience</td>
    </tr>
    <tr>
      <td><code>adSetIds</code></td>
      <td>String Array</td>
      <td>Computed</td>
      <td>Ad sets associated to the audience (read-only).</td>
    </tr>
    <tr>
      <td><code>algebra</code></td>
      <td><a href="/marketing-solutions/docs/algebra-nodes">Algebra Node</a></td>
      <td>Required</td>
      <td>Algebra Node with the definition of how the different segments are mixed to create the audience using logical operators: AND, OR, NOT.</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>optional</td>
      <td>The number of elements to be returned. The default is 50 and the maximum is 100.</td>
    </tr>
    <tr>
      <td><code>offset</code></td>
      <td>optional</td>
      <td>The (zero-based) offset into the collection. The default is 0.</td>
    </tr>
  </tbody>
</table>

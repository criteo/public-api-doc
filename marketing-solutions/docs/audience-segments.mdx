...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><code>AudienceSegmentType</code></td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><a href="/marketing-solutions/docs/audience-segments#operations">interestIds</a></td>
      <td>String array</td>
      <td>Required (if In-market is set)</td>
      <td>Reach new people based on their commercial interests</td>
    </tr>
    <tr>
      <td><a href="/marketing-solutions/docs/audience-segments#operations">brandIds</a></td>
      <td>String array</td>
      <td>Required (if In-market is set)</td>

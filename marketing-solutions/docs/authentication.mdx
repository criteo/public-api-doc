...
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Performance_Media/v2026_01/docs/Marketing Solutions Endpoints/authentication.md
---
...
<Info>
  **Reference** 
  You can find this endpoint in [our Reference section](https://developers.criteo.com/marketing-solutions/reference/apiv1oauth2tokenpost) as well.
</Info>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>string</td>
      <td>Please see below for instructions on getting your credentials through <a href="https://partners.criteo.com">Partner Dashboard</a></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>string</td>
      <td>Must be <code>client&#95;credentials</code> or <code>authorization&#95;code</code></td>
    </tr>
    <tr>
      <td><code>code</code></td>
      <td>string</td>
      <td><strong>Only for Authorization Code apps</strong>. Authorization code returned during redirection</td>
    </tr>
    <tr>
      <td><code>redirect&#95;uri</code></td>
      <td>string</td>
      <td><strong>Only for Authorization Code apps</strong>. Must match the <code>redirect&#95;uri</code> used for the authorization request.</td>
    </tr>
  </tbody>
</table>
...
<Info>
  **OAuth Flow**
  ...
  You can find more details about how to implement OAuth flow for the different authentication methods in our [OAuth implementation](/marketing-solutions/docs/oauth-implementation) guides.
</Info>
## What's next

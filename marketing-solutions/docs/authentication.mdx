...
<Info>
  **Reference** You can find this endpoint in [our Reference section](https://developers.criteo.com/marketing-solutions/docs/authentication) as well.
</Info>
...
| --------------- | ------ | ---------------------------------------------------------------------------------------------------------------------- |
| `client_id`     | string | Please see below for instructions on getting your credentials through [Partner Dashboard](https://partners.criteo.com) |
| `client_secret` | string | Please see below for instructions on getting your credentials through [Partner Dashboard](https://partners.criteo.com) |
...
* [/oauth2/token](/marketing-solutions/docs/authentication)

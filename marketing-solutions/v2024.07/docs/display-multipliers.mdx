...
```text
https://api.criteo.com/2024-07/marketing-solutions/ad-sets/{adSetId}/display-multipliers
```
...
<Warning>
  ...
  This endpoint allows you to update several display multipliers within a single call. Thus it\`s important to understand the [partial success behavior](/marketing-solutions/v2024.07/docs/partial-success-for-bulk-operations).
</Warning>

## **Validation Errors**

In addition to [general API errors](/marketing-solutions/v2024.07/docs/api-error-types) , you may encounter validation errors when updating a display multiplier.
...
[Category Bids](/marketing-solutions/v2024.07/docs/category-bids)

...
| 415       | Unsupported media type      | This error means the wrong value for content-type header has been supplied. For example, you can get this type of error if you supply `'Content-Type: application/xml'`<br/>instead of `'Content-Type: application/json'` in the request header.                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
|                | invalid-date-format                 | "This field must be YYYY-MM-DD"                 | Example:<br /><br />"`<field>` must be YYYY-MM-DD format. Value: '`<value>`'"                                                                                                                         |

...
![Get](/images/marketing-solutions/v2024.07/docs/8a6bfd9-get.png)
...
![Button](/images/marketing-solutions/v2024.07/docs/8a6bfd9-get.png)
...
![Post Button](/images/marketing-solutions/v2024.07/docs/b0623eb-post.png)
...
<Warning>
  To create a contact list audience segment, you need to add an empty *contactList* parameter, as you can see in the example. To define the content of this audience segment, you should refer to the section [Manage Contact Lists](doc:audience-segments#manage-contact-lists).
</Warning>
...
![Patch Button](/images/marketing-solutions/v2024.07/docs/04a928f-patch.png)
...
<Warning>
  To update contact lists within an audience segment, refer to the section [Manage Contact Lists](doc:audience-segments#manage-contact-lists).
</Warning>
...
<Warning>
  This statistic is not an estimation of the audience size. For it, refer to the [Estimate Audience Segment Size](doc:audience-segments#estimate-audience-segment-size) section.
</Warning>
...
Below is a list of error codes for Audience Segment Endpoints, and a more detailed description of their meaning. For more codes don't hesitate to check also the [Audiences validation errors](doc:audiences#validation-errors)

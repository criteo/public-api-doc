...
<Info>
  ...
  You can find more details about how to implement OAuth flow for the different authentication methods in [OAuth implementation](/marketing-solutions/v2024.07/docs/oauth-implementation) guides.
</Info>
...
[Advertisers](/marketing-solutions/v2024.07/docs/advertisers)

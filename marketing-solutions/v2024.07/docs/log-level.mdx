...
```
https://api.criteo.com/2024-07/log-level/advertisers/{advertiser-id}/report
```
...
<CodeGroup>
  ```bash bash
  curl -X POST "https://api.criteo.com/2024-07/log-level/advertisers/{advertiser-id}/report" 
    -H "accept: text/plain"

...
| ------------------------------------------------------ | -------------------- | --------------------------- |
| [Client Credentials](/marketing-solutions/v2024.07/docs/oauth-implementation) | 250 calls per minute | Application level           |
| [Authorization Code](/marketing-solutions/v2024.07/docs/oauth-implementation) | 35 calls per minute  | Access token level          |

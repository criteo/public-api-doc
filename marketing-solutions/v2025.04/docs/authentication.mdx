...
<Info>
  **OAuth Flow**
  ...
  You can find more details about how to implement OAuth flow for the different authentication methods in [OAuth implementation](/marketing-solutions/v2025.04/docs/oauth-implementation) guides.
</Info>
...
[Advertisers](/marketing-solutions/v2025.04/docs/advertisers)

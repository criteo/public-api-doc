...
| [interestIds](/marketing-solutions/v2025.04/docs/audience-segments#operations) | String array                                                                 | Required (if In-market is set) | Reach new people based on their commercial interests                                                                                         |
| [brandIds](/marketing-solutions/v2025.04/docs/audience-segments#operations)    | String array                                                                 | Required (if In-market is set) | Choose the commercial brands your segment might be interested in                                                                             |
...
<Warning>
  The *contactList* parameter should be empty on the creation of this type of audience segment. More details on [Manage Contact Lists](/marketing-solutions/v2025.04/docs/audience-segments#manage-contact-lists).
</Warning>
...
<Warning>
  To create a contact list audience segment, you need to add an empty *contactList* parameter, as you can see in the example. To define the content of this audience segment, you should refer to the section [Manage Contact Lists](/marketing-solutions/v2025.04/docs/audience-segments#manage-contact-lists).
</Warning>
...
<Warning>
  To update contact lists within an audience segment, refer to the section [Manage Contact Lists](/marketing-solutions/v2025.04/docs/audience-segments#manage-contact-lists).
</Warning>
...
<Warning>
  This statistic is not an estimation of the audience size. For it, refer to the [Estimate Audience Segment Size](/marketing-solutions/v2025.04/docs/audience-segments#estimate-audience-segment-size) section.
</Warning>
...
Below is a list of error codes for Audience Segment Endpoints, and a more detailed description of their meaning. For more codes don't hesitate to check also the [Audiences validation errors](/marketing-solutions/v2025.04/docs/audiences#validation-errors)
...
[Audience](/marketing-solutions/v2025.04/docs/audience)

[Algebra Nodes](/marketing-solutions/v2025.04/docs/algebra-nodes)

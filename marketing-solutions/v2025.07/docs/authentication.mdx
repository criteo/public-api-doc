...
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Performance_Media/v2025_07/docs/Marketing Solutions Endpoints/authentication.md
---
...
<table>
  ...
  <tbody>
    <tr>
      <td><code>client&#95;id</code> string</td>
      <td>Please see below for instructions on getting your credentials through <a href="https://partners.criteo.com">Developer Dashboard</a></td>
    </tr>
    <tr>
      <td><code>client&#95;secret</code> string</td>
      <td>Please see below for instructions on getting your credentials through <a href="https://partners.criteo.com">Developer Dashboard</a></td>
    </tr>
    <tr>
      <td><code>grant&#95;type</code> string</td>
    ...
    <tr>
      <td><code>redirect&#95;uri</code> string</td>
...
<Info>
  **OAuth Flow**
  ...
  You can find more details about how to implement OAuth flow for the different authentication methods in [OAuth implementation](/marketing-solutions/v2025.07/docs/oauth-implementation) guides.
</Info>

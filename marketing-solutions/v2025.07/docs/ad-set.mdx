...
**`datasetId`**  
Data Set Id associated with the specified advertiser ID. See [Datasets](/marketing-solutions/v2025.07/docs/datasets)  for how to find datasets associated to advertisers.
...
The data set ID is invalid or not associated to your account. See [Datasets](/marketing-solutions/v2025.07/docs/datasets) for how to find ad sets associated to your account.

...
1. Log in to the [Criteo Partner Dashboard](https://partners.criteo.com/) and go to your app page (My Apps and click on view to select an app)
...
[Send an Authorization Request to Your Users](/marketing-solutions/v2025.07/docs/send-an-authorization-request-to-your-users)

---
title: Campaign
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Performance_Media/v2025_07/docs/Marketing Solutions Endpoints/campaigns/campaign.md
---
...
A new campaign can be created for a specific advertiser by making a POST call to the campaigns endpoint. The request body should specify the type (`Campaign`) and the [campaign attributes](/marketing-solutions/v2025.07/docs/campaign#campaign-attributes).
...
A full list of error codes can be found on the [Validation Errors](/marketing-solutions/v2025.07/docs/campaign#validation-errors-and-warnings) page at the end of this section.  

...
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Performance_Media/v2025_07/docs/Concepts/consent-url-generation.md
---
...
These guides assume you have created a developer account, are part of an organization and have created an app. Instructions for getting started can be found [here](/marketing-solutions/v2025.07/docs/onboarding-checklist).
...
<Frame caption="app-card.PNG">
  <img src="/images/marketing-solutions/v2025.07/docs/52f9f11-app-card.PNG" alt="app-card.PNG" />
</Frame>
...
<Frame caption="generate_new_url.PNG">
  <img src="/images/marketing-solutions/v2025.07/docs/4e1e9e0-generate_new_url.PNG" alt="generate_new_url.PNG" />
</Frame>
...
<Frame caption="app-card.PNG">
  <img src="/images/marketing-solutions/v2025.07/docs/b0d8b77-app-card.PNG" alt="app-card.PNG" />
</Frame>
...
<Frame caption="create-connector.PNG">
  <img src="/images/marketing-solutions/v2025.07/docs/eed01d6-create-connector.PNG" alt="create-connector.PNG" />
</Frame>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>An arbitrary string to be included in the consent callback. For example, the User ID of your app user.</td>
    </tr>
    <tr>
...
```text http Signature Example String
...
```json Example POST Consent Callback
{
  "Type": "ConsentGranted",
  "Data": {

...
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Performance_Media/v2025_07/docs/Marketing Solutions Endpoints/analytics/placement-category.md
---
...
```text
 https://api.criteo.com/2025-07/categories/report
```
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>shoudlDisplayDomainDimension</td>
      <td>boolean</td>
      <td>No</td>
      <td>true</td>
...
```json Error - Insufficent Permissions
"errors": [{
...
 \
The default time zone for requests is UTC.  See [this link](/marketing-solutions/v2025.07/docs/campaign-statistics#timezones) for more information on supported time zones.

```json Error - Invalid Time Zone
"errors": [{
    "traceId": "56ed4096-f96a-4944-8881-05468efe0ec9",
    "type": "validation",

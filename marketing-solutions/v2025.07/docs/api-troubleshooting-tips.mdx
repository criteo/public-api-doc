...
In order to perform a quick check whether an advertiser has given consent to the app you can query [/advertisers/me endpoint](/marketing-solutions/v2025.07/reference/apiportfolioget) and see if it returns advertiser ID that you expect. 

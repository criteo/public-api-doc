...
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Performance_Media/v2025_07/docs/Marketing Solutions Endpoints/marketplace-performance-outcomes/managing-budgets.md
---
...
* **Active** : this budget can be consumed in one or more Seller-Campaigns for delivering ads. A budget is active when all the following conditions are met:
  * the budget has not been suspended (see "[Suspending budgets](/marketing-solutions/v2025.07/docs/managing-budgets#suspending-budgets)" section),

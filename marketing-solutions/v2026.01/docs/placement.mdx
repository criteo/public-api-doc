...
The metrics are similar to the ones provided in the [Statistics endpoint](/marketing-solutions/v2026.01/docs/campaign-statistics), but the dimensions allow for seeing performance across the different placements available in a campaign's inventory.

...
<Info>
  **Reference** 
  You can find this endpoint in [our Reference section](/marketing-solutions/reference/authorization/get-token) as well.
</Info>
...
<Info>
  **OAuth Flow**
  ...
  You can find more details about how to implement OAuth flow for the different authentication methods in our [OAuth implementation](/marketing-solutions/v2026.01/docs/oauth-implementation) guides.
</Info>
## What's next

* [OAuth Implementation](/marketing-solutions/v2026.01/docs/oauth-implementation)

...
   
**`invalid-schema`**  
Bad schema name. Please check the list of allowed schemas on [Managing Audiences](/marketing-solutions/v2026.01/docs/audience)

 

   
**`invalid-operation`**  
Bad operation name. Please check the list of allowed operations on [Managing Audiences](/marketing-solutions/v2026.01/docs/audience)

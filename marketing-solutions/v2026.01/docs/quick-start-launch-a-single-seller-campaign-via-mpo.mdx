...
* Have the **Campaign Manage** permission, as described in the [onboarding checklist](/marketing-solutions/v2026.01/docs/onboarding-checklist#3-define-your-app-scope).
...
* [Single-Seller Campaigns – Concept Guide](https://criteo.atlassian.net/wiki/display/~g.handley/Single-Seller+Campaigns+%E2%80%93+Concept+Guide)
* [Single-Seller API Reference](/marketing-solutions/v2026.01/docs/single-seller-campaigns#/versions)

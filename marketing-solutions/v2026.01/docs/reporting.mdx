...
- When to use the [Standard Reporting API](/marketing-solutions/v2026.01/docs/mpo-standard-reporting-api) vs. the [Real-Time Asynchronous API](/marketing-solutions/v2026.01/docs/getting-realtime-mpo-statistics).
...
<Info>
  ...
  - [**MPO Standard Reporting API**](/marketing-solutions/v2026.01/docs/mpo-standard-reporting-api) for aggregated, historical statistics.
  - [**MPO Real-Time Asynchronous API**](/marketing-solutions/v2026.01/docs/getting-realtime-mpo-statistics) for low-latency, asynchronous exports for operational monitoring.
</Info>

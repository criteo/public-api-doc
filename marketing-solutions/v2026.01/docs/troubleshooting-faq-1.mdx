...
For common questions between Single-seller and Multi-seller documentation, refer to the [shared documentation](/marketing-solutions/v2026.01/docs/troubleshooting-faq).
...
Statistics are typically available with a latency of a few hours. Refer to the [Getting Statistics](/marketing-solutions/v2026.01/docs/getting-statistics) page for current SLA guidance.

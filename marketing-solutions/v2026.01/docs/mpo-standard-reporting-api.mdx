...
For low-latency /near real-time monitoring, use the [**MPO Real-Time Asynchronous API**](/marketing-solutions/v2026.01/docs/getting-realtime-mpo-statistics) instead.
...
Use the [**Real-Time API**](/marketing-solutions/v2026.01/docs/getting-realtime-mpo-statistics) when you need:

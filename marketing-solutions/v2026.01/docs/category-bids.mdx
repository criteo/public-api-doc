...
<Warning>
  ...
  * Ad set must be set with CPC or CPM as cost controller (more details on cost controller [here](/marketing-solutions/v2026.01/docs/ad-set#ad-set-bidding)). If your ad set uses another cost controller, you must refer to the [Display Multipliers](/marketing-solutions/v2026.01/docs/display-multipliers) solution.
</Warning>
...
<Danger>
  **Updating Multiple Category Bids**
  ...
  This endpoint allows you to update several category bids within a single call. When updating multiple items, note that some updates may succeed while others fail.
</Danger>
...
Category bid is only available on ad set with CPC-based or CPM-based cost controllers. If your ad set uses other cost controller, you must refer to the [Display Multipliers](/marketing-solutions/v2026.01/docs/display-multipliers).

...
Once you have [created your organization](/marketing-solutions/v2026.01/docs/create-your-organization), you can access the `My Apps` page to begin creating your application. This page is also where you will manage your Criteo API applications.
...
* Criteo’s API supports two OAuth authentication methods: [Client Credentials](/marketing-solutions/v2026.01/docs/client-credentials-setup) and [Authorization Code](/marketing-solutions/v2026.01/docs/authorization-code-setup). Each method has its own advantages, so before proceeding, we strongly recommend reviewing which authentication method is best suited to your application’s needs.

<Frame>
![2ce3350 auth_methods2](/images/marketing-solutions/v2026.01/docs/2ce3350-auth_methods2.png)
</Frame>
...
<Info>
  **Trying to decide which OAuth method is right for you?**
  ...
  If you're unsure which authentication method to use, take a look at our [OAuth App Implementation](/marketing-solutions/v2026.01/docs/oauth-implementation) guide for an overview of each authentication method.
</Info>
...
<Frame>
![6c1fa6d portal _step3_1](/images/marketing-solutions/v2026.01/docs/6c1fa6d-portal-_step3_1.gif)
</Frame>
...
<Frame>
![](/images/marketing-solutions/v2026.01/docs/cb2adb410b5cb7230ee39dc24febfa57a59e6490e93330d63df771a2f7391f13-image.png)
</Frame>

...
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Performance_Media/v2026_01/docs/Introduction to the Criteo API/onboarding-checklist/send-an-authorization-request-to-your-users.md
---

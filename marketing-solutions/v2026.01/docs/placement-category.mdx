...
For more information on authentication, see [our Authentication guide](/marketing-solutions/v2026.01/docs/authentication).
...
The default time zone for requests is UTC.  See [this page](/marketing-solutions/v2026.01/docs/campaign-statistics#timezones) for more information on supported time zones.

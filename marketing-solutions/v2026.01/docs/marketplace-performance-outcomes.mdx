...
_For more detail, see the public guide:_\
_[MPO Single Seller Campaigns](/marketing-solutions/v2026.01/docs/single-seller-campaigns)._
...
<Columns cols={3}>
  <Card title="Managing Sellers" href="/marketing-solutions/v2026.01/docs/multiseller-managing-sellers">
    Explore the endpoints for seller management via API.
  </Card>

  <Card title="Managing Campaigns" href="/marketing-solutions/v2026.01/docs/multiseller-managing-campaigns">
    Explore the endpoints allowing to manage campaigns.
  </Card>

  <Card title="Managing Budgets" href="/marketing-solutions/v2026.01/docs/multiseller-managing-budgets">
    Explore the programmatic ways to manage budgets.
  </Card>

  <Card title="Getting Statistics" href="/marketing-solutions/v2026.01/docs/multiseller-getting-statistics">
...
<Columns cols={3}>
  <Card title="Campaigns - Concept Guide" href="/marketing-solutions/v2026.01/docs/campaigns-concept-guide">
    Start by exploring the campaign-related concepts.
  </Card>

  <Card title="Quick Start" href="/marketing-solutions/v2026.01/docs/quick-start-launch-a-single-seller-campaign-via-mpo">
    Learn how to quick start by launching a Single-Seller Campaign via MPO.
  </Card>

  <Card title="Managing Sellers" href="/marketing-solutions/v2026.01/docs/managing-sellers">
    Explore the endpoints for seller management via API.
  </Card>

  <Card title="Managing Campaigns" href="/marketing-solutions/v2026.01/docs/managing-campaigns">
    Explore the endpoints allowing to manage campaigns.
  </Card>

  <Card title="Managing Budgets" href="/marketing-solutions/v2026.01/docs/managing-budgets">
    Explore the programmatic ways to manage budgets.
  </Card>

  <Card title="Getting Statistics" href="/marketing-solutions/v2026.01/docs/getting-statistics">

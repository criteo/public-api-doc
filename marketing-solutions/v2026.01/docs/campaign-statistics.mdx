...
<table>
 ...
 <tbody>
  ...
  <tr>
   ...
   <td>
    <p>
     See the <a href="/marketing-solutions/v2026.01/docs/campaign-statistics#dimensions">Dimensions</a> page.
    </p>
   </td>
   <td>
    <p>
  ...
  <tr>
   ...
   <td>
    <p>
     See the <a href="/marketing-solutions/v2026.01/docs/campaign-statistics#full-list-of-metrics">Metrics</a> page.
    </p>
   </td>
   <td>
    <p>
...
Below is a list of error codes for the Statistics endpoint and a more detailed description of their meaning. General guidance on handling API errors can be found [here](/criteo-apis/docs/api-error-types).
...
* [Transaction IDs](/marketing-solutions/v2026.01/docs/transaction-ids)
* [Log-Level](/marketing-solutions/v2026.01/docs/log-level)
* [Placement](/marketing-solutions/v2026.01/docs/placement)
* [Placement Category](/marketing-solutions/v2026.01/docs/placement-category)

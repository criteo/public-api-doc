...
The request body should specify the type (`Campaign`) and the [campaign attributes](/marketing-solutions/v2026.01/docs/campaign#campaign-attributes).
...
A full list of error codes can be found on the [Validation Errors](/marketing-solutions/v2026.01/docs/campaign#validation-errors-and-warnings) page at the end of this section.  
...
* [Ad Set](/marketing-solutions/v2026.01/docs/ad-set)

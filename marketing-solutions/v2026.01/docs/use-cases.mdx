---
title: Use Cases
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Performance_Media/v2026_01/docs/Introduction to the Criteo API/is-criteo-api-for-you/use-cases.md
---
...
* Using the [PATCH /ad-sets endpoint](/marketing-solutions/v2026.01/docs/ad-set#update-ad-sets), you can adjust your bidding at any time you decide
...
* You can then implement a feedback loop with your rules and your performance to adjust your bids accordingly with the [PATCH /ad-sets endpoint](/marketing-solutions/v2026.01/docs/ad-set#update-ad-sets), leading to a more efficient ROI and campaign performance

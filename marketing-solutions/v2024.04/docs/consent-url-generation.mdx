...
These guides assume you have created a developer account, are part of an organization and have created an app. Instructions for getting started can be found [here](/marketing-solutions/v2024.04/docs/onboarding-checklist).
...
![1278](/images/marketing-solutions/v2024.04/docs/52f9f11-app-card.PNG "app-card.PNG")

   

At the top of your App page, provided you have activated your app, you will see a **Generate new URL** button.

![1410](/images/marketing-solutions/v2024.04/docs/4e1e9e0-generate_new_url.PNG "generate_new_url.PNG")
...
![1278](/images/marketing-solutions/v2024.04/docs/b0d8b77-app-card.PNG "app-card.PNG")
...
![916](/images/marketing-solutions/v2024.04/docs/eed01d6-create-connector.PNG "create-connector.PNG")
...
[API Error Types](/marketing-solutions/v2024.04/docs/api-error-types)

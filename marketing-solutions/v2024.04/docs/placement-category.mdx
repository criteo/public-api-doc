...
```http
 https://api.criteo.com/2024-04/categories/report
```
</EndpointBadge>
...
  The default time zone for requests is UTC. See [this link](/marketing-solutions/v2024.04/docs/campaign-statistics#timezones) for more information on supported time zones.

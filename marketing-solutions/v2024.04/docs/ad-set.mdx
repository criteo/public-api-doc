...
**`datasetId`**  
Data Set Id associated with the specified advertiser ID. See [Datasets](/marketing-solutions/v2024.07/docs/datasets) for how to find datasets associated to advertisers.

**`campaignId`**  
Id of the marketing campaign associated to the ad set. See [Search for Campaigns](/marketing-solutions/v2024.04/docs/campaign#searching-campaigns) for how to search for campaigns.
...
Can be `on` or `off`. `off` by default. Set by the advertiser, this represents the intent to deliver ads. See [Start and Stop Ad Sets](/marketing-solutions/v2024.04/docs/ad-set#start-an-ad-set) for how to change this value.
...
The data set ID is invalid or not associated to your account. See [Datasets](/marketing-solutions/v2024.07/docs/datasets) for how to find ad sets associated to your account.

**`campaign--ad-set-creation-check--invalid-audience-configuration`**  
The Ad Set has invalid audience or audience with missing parameters. See [Create an Ad Set](/marketing-solutions/v2024.04/docs/ad-set#create-an-ad-set) for how to configure Ad Set Audience.

**`campaign--ad-set-creation-check--no-audience-config`**  
The Ad Set has no audience configured. See [Create an Ad Set](/marketing-solutions/v2024.04/docs/ad-set#create-an-ad-set) for how to configure Ad Set Audience.

**`campaign--ad-set-creation-check--multiple-audience-configs`**  
The Ad Set has multiple audiences configured. Only one audience can be configured per Ad Set. See [Create an Ad Set](/marketing-solutions/v2024.04/docs/ad-set#create-an-ad-set) for how to configure Ad Set Audience.
...
This Ad Set is not linked to an audience. Check the section [Update Ad Set Audience](/marketing-solutions/v2024.04/docs/ad-set#update-adset-audience).

...
| `currency`      | The currency to be used in the report, ISO format.<br /><br />A list of supported currencies is [available here](/marketing-solutions/v2024.04/docs/campaign-statistics#currencies). | string        | Y                                               |
...
| `timezone`      | The timezone for organizing the data in the report.<br /><br />A list of supported values is [available here](/marketing-solutions/v2024.04/docs/campaign-statistics#timezones).     | string        | N<br /><br />UTC will be default timezone if not specified. |

...
These guides assume you have created a developer account, are part of an organization and have created an app. Instructions for getting started can be found [here](/marketing-solutions/v2023.10/docs/onboarding-checklist).
...
![1278](/images/marketing-solutions/v2023.10/docs/52f9f11-app-card.PNG "app-card.PNG")
...
![1410](/images/marketing-solutions/v2023.10/docs/4e1e9e0-generate_new_url.PNG "generate_new_url.PNG")
...
![1278](/images/marketing-solutions/v2023.10/docs/b0d8b77-app-card.PNG "app-card.PNG")
...
![916](/images/marketing-solutions/v2023.10/docs/eed01d6-create-connector.PNG "create-connector.PNG")
...
<CodeGroup>
  ...
  function generateConsentURL(publicSigningKey, signingSecret, redirect, state){
    ...
    return `https://consent.preprod.crto.in/request?key=${publicSigningKey}&timestamp=${timestamp}&state=${state}&redirect-uri=${encodeURIComponent(redirect)}&signature=${sha512.hmac(signingSecret, query)}`;
  }
  ...
  */
  ...
  public class Program
  {
    ...
    public static string generateUrl(string publicSigningKey, long timestamp, string state, string redirectUri, string signature)
    {
      ...
      return $"https://consent.criteo.com/request?key={publicSigningKey}&timestamp={timestamp}&state={state}&redirect-uri={encodedRedirectUri}&signature={signature}";
    }
  }
...
[API Error Types](/marketing-solutions/v2023.10/docs/api-error-types)

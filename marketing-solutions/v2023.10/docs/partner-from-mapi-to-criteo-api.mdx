...
* **Endpoints**: MAPI endpoints will be deprecated on June 15th, 2021. Partners must migrate to the new Criteo API endpoints to send audience identifiers (see our [Audiences API Guide](https://developers.criteo.com/marketing-solutions/docs/audience)), retrieve statistics (see our [Analytics API Guide](https://developers.criteo.com/marketing-solutions/docs/analytics) ), or perform other types of requests in order to continue interacting with Criteo’s platform on behalf of mutual clients.
...
* Test our requests on the Criteo API within an interactive UI format using our [Criteo API Swagger Tool](https://developers.criteo.com/marketing-solutions/docs/authentication)

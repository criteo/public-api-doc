...
| EMEA                                                                        | APAC                                                                | Americas                                      |
| --------------------------------------------------------------------------- | ------------------------------------------------------------------- | --------------------------------------------- |
| 178.250.0.0/21 185.235.84.0/22 91.212.98.0/24 91.199.242.0/24<br/>2a02:2638::/32 | 74.119.116.0/22 199.204.168.0/22 177.73.128.0/21<br/>2620: 100:a000::/44 | 116.213.20.0/22 182.161.72.0/22<br/>2406:2600::/32 |
...
Usually if advertiser hasn't given a consent to your app you will get an error in 4xx range. Part 1 of the tutorial covers 4xx error series in more detail here: [How to handle API errors](/marketing-solutions/v2023.10/docs/api-error-types). In order to perform a quick check whether an advertiser has given consent to the app you can query [/advertisers/me endpoint](/marketing-solutions/reference-link/apiportfolioget) and see if it returns advertiser ID that you expect.

**Implementation errors**

If the request is not formed according to the \[specification] (ref:apiv1oauth2tokenpost) or an invalid request header is provided, the server will respond with an error in the 400 code series. Part 1 of the tutorial covers 4xx error series in more detail here: [How to handle API errors](/marketing-solutions/v2023.10/docs/api-error-types).
...
Starting from [How to handle API errors - Part 1](/marketing-solutions/v2023.10/docs/api-error-types) to now, we have focused on common issues that can arise with the API.
...
| --- | --- | --- |
| Revenue and basic metrics, including:<ul><li>Displays, clicks, advertiser cost Revenue metrics</li><li>Revenue-based ROI: ECoS and related metrics</li><li>Sales and derivative metrics:</li><li>Sales data</li><li>Conversion data</li><li>Conversion-based ROI: CPO, CPI, and related metrics</li></ul> | 12 hours | 5 hours |
| Audience metrics:<br/>Potential users<br/>Exposed users<br/>Displays | 19 hours | 7 hours |
...
Aligning the timezones and the date ranges in the API request body and the platform UI (whether Criteo Commerce Growth or a third-party platform) will resolve the issue most of the time. Check [this document](/marketing-solutions/v2023.10/docs/campaign-statistics#timezones) for the list of supported timezones.

**Attribution scope**

Please view [this document](/marketing-solutions/v2023.10/docs/campaign-statistics#metrics) for the list of supported metrics in the Criteo API.
...
[API Client Libraries](/marketing-solutions/v2023.10/docs/api-client-libraries)

[Analytics from MAPI to Criteo API](/marketing-solutions/v2023.10/docs/analytics-from-mapi-to-criteo-api)

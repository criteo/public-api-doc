...
<Warning>
  **Deprecated Versions**
  ...
  If you are using one of the following versions and endpoints, we advise you to migrate your applications to a newer version : [**2025-07**](/marketing-solutions/v2025.07/reference/apiv1oauth2tokenpost).

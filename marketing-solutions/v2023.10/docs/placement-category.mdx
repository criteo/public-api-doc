...
  The default time zone for requests is UTC. See [this link](/marketing-solutions/v2023.10/docs/campaign-statistics#timezones) for more information on supported time zones.

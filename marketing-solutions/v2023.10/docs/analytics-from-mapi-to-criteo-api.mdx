...
This article focuses on the changes required to use the endpoint. But you will need to update also your authentication system. Please see our [Onboarding checklist](/marketing-solutions/docs/onboarding-checklist) to learn how to create a developer Account, get access to your new credentials and request access to your users. And please see our [Authentication guide](/marketing-solutions/docs/authentication) to learn how to authenticate and get your token.
...
All metrics available in Criteo Commerce Growth are available through the Statistics API. To explore all available metrics, dimensions, and options, see [the Statistics guide](/marketing-solutions/docs/analytics).

...
2. [Is Criteo API for you?](/marketing-solutions/v2023.10/docs/is-criteo-api-for-you)
...
* Using the [PATCH /ad-sets endpoint](/marketing-solutions/v2023.10/docs/ad-set#update-ad-sets) , you can adjust your bidding at any time you decide
...
* You can then implement a feedback loop with your rules and your performance to adjust your bids accordingly with the [PATCH /ad-sets endpoint](/marketing-solutions/v2023.10/docs/ad-set#update-ad-sets), leading to a more efficient ROI and campaign performance
...
[Commerce Growth vs. Criteo API](/marketing-solutions/v2023.10/docs/commerce-growth-vs-criteo-api)

[Onboarding Checklist](/marketing-solutions/v2023.10/docs/onboarding-checklist)

...
The data set ID is invalid or not associated to your account. See [Datasets](/marketing-solutions/v2025.01/docs/datasets) for how to find ad sets associated to your account.

**`campaign--ad-set-creation-check--invalid-audience-configuration`**  
The Ad Set has invalid audience or audience with missing parameters. See [Create an Ad Set](/marketing-solutions/v2024.10/docs/ad-set#create-an-ad-set) for how to configure Ad Set Audience.

**`campaign--ad-set-creation-check--no-audience-config`**  
The Ad Set has no audience configured. See [Create an Ad Set](/marketing-solutions/v2024.10/docs/ad-set#create-an-ad-set) for how to configure Ad Set Audience.

**`campaign--ad-set-creation-check--multiple-audience-configs`**  
The Ad Set has multiple audiences configured. Only one audience can be configured per Ad Set. See [Create an Ad Set](/marketing-solutions/v2024.10/docs/ad-set#create-an-ad-set) for how to configure Ad Set Audience.
...
**`campaign--ad-set-creation-check--media-type-not-compatible-with-automated-budget`**  
The media type has to be the same as the one chosen for the marketing campaign.

**`campaign--ad-set-creation-check--revenue-type-not-compatible-with-automated-budget`**  
The revenue type has to be part of the chosen optimization objective for the marketing campaign.

**`campaign--ad-set-creation-check--spend-strategy-not-compatible-with-automated-budget`**  
All spend strategies (active and scheduled) have to be smoothed. The active spend strategy has to have the same periodicity as the one of its marketing campaign. Scheduled spend strategy is not allowed.
...
**`campaign--ad-set-update-check--revenue-type-not-compatible-with-automated-budget`**  
The revenue type has to be part of the chosen optimization objective for the marketing campaign.

**`campaign--ad-set-update-check--spend-strategy-not-compatible-with-automated-budget`**  
All spend strategies (active and scheduled) have to be smoothed. The active spend strategy has to have the same periodicity as the one of its marketing campaign. Scheduled spend strategy is not allowed.
...
Your Ad Set is a CRP Ad Set and should not employ budget smoothing.
...
This Ad Set is not linked to an audience. Check the section [Update Ad Set Audience](/marketing-solutions/v2024.10/docs/ad-set#update-adset-audience).

...
| 401       | Authentication error        | If Criteo API responded with 401 it means that there is an issue with authentication, e.g invalid authentication credentials, or an expired token was supplied with the request. Please check [Authentication](/marketing-solutions/v2024.10/docs/authentication) for further information.                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
[Partial Success for Bulk Operations](/marketing-solutions/v2024.10/docs/partial-success-for-bulk-operations)

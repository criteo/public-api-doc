...
<Warning>
  **Deprecated Versions**
  ...
  If you are using one of the following versions and endpoints, we advise you to migrate your applications to a newer version : [**2023-04**](/marketing-solutions/v2023.07/reference/apiv1oauth2tokenpost).

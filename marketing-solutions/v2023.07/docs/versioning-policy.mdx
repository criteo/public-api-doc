...
<Warning>
  ...
  If you are using one of the following versions and endpoints, we advise you to migrate your applications to a newer version : [**2023-04**](https://developers.criteo.com/marketing-solutions/v2023.07/reference).
...
[Start Using Your API Connection](/marketing-solutions/v2023.07/docs/start-using-your-api-connection)

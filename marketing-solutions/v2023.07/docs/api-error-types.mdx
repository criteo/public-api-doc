...
| 401       | Authentication error        | If Criteo API responded with 401 it means that there is an issue with authentication, e.g invalid authentication credentials, or an expired token was supplied with the request. Please check [Authentication](/marketing-solutions/v2023.07/docs/authentication) for further information.                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| 429       | Rate limit reached          | Limit is 100 requests per minute per application. More details [here](/marketing-solutions/docs/rate-limits-1).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
[OAuth App implementation](/marketing-solutions/v2023.07/docs/oauth-app-implementation)

[Partial Success for Bulk Operations](/marketing-solutions/v2023.07/docs/partial-success-for-bulk-operations)

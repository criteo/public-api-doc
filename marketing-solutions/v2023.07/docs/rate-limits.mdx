...
| ------------------------------------------------------ | -------------------- | --------------------------- |
| [Client Credentials](/marketing-solutions/v2023.07/docs/oauth-app-implementation) | 250 calls per minute | Application level           |
| [Authorization Code](/marketing-solutions/v2023.07/docs/oauth-app-implementation) | 35 calls per minute  | Access token level          |

...
These guides assume you have created a developer account, are part of an organization. Instructions for getting started can be found [here](doc:onboarding-checklist).
...
In your App page you will be able to define the scope of your application and the OAuth parameters. Please see this [page](doc:onboarding-checklist#3-define-your-app-scope) to see more details on how to define your app scope.

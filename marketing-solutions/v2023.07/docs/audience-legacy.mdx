...
  **`invalid-schema`** Bad schema name. Please check the list of allowed schemas on [Managing Audiences](doc:audience)

 

  **`invalid-operation`** Bad operation name. Please check the list of allowed operations on [Managing Audiences](doc:audience)

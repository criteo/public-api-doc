...
These guides assume you have created a developer account, are part of an organization and have created an app. Instructions for getting started can be found [here](/marketing-solutions/v2023.07/docs/onboarding-checklist).
...
<Frame>
![1278](/images/marketing-solutions/v2023.07/docs/52f9f11-app-card.PNG "app-card.PNG")
</Frame>
...
<Frame>
![1410](/images/marketing-solutions/v2023.07/docs/4e1e9e0-generate_new_url.PNG "generate_new_url.PNG")
</Frame>
...
<Frame>
![1278](/images/marketing-solutions/v2023.07/docs/b0d8b77-app-card.PNG "app-card.PNG")
</Frame>
...
<Frame>
![916](/images/marketing-solutions/v2023.07/docs/eed01d6-create-connector.PNG "create-connector.PNG")
</Frame>

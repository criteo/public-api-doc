...
```http
 https://api.criteo.com/2023-01/categories/report
```
</EndpointBadge>
...
API users must be authenticated in order to make calls to the category endpoint. For more information on authentication see [https://developers.criteo.com/marketing-solutions/docs/authentication](https://developers.criteo.com/marketing-solutions/docs/authentication).
...
  The default time zone for requests is UTC. See [this link](/marketing-solutions/v2023.07/docs/campaign-statistics#timezones) for more information on supported time zones.

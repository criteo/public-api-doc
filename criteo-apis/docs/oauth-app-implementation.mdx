...
<Info>
  This guide assumes you have a **partner account** and **Organization & API application** created within Criteo. Instructions for getting started are available on [Getting connected to the API](/criteo-apis/docs/connect-to-the-api).
</Info>
...
For more information, check out the app setup process for [OAuth App - Client Credentials Setup](/criteo-apis/docs/oauth-app-client-credentials).
...
For setup details, refer to [OAuth App - Authorization Code Setup](/criteo-apis/docs/oauth-app-authorization-code)
...
* [OAuth App - Authorization Code Setup](/criteo-apis/docs/oauth-app-authorization-code)

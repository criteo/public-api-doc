...
2. For this setup, we are selecting "_Client Credentials_", but you can review our [OAuth App implementation](/criteo-apis/docs/oauth-app-implementation) guide to determine the best option for your organization.

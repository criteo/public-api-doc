...
<Info>
  **Retail Media Private Market retailers**
  ...
  If you are a retailer setting up a private market integration, you will need two separate apps with different authentication methods — an Admin app and a Business app. See [Choosing Your Consent Flow](/retail-media/docs/consent-flow-overview) before proceeding.
</Info>

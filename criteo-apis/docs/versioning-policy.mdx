...
<Columns cols={2}>
  <Card title="Breaking — you need to update" icon="circle-xmark" color="#f87171">
    - Removing a field, endpoint, or parameter from a request
    - Removing a **required** field from a response
    - Adding a **required** field or parameter to a request
  ...
  <Card title="Non-breaking — no action needed" icon="circle-check" color="#4ade80">
    - New optional fields or parameters in requests
    - New fields added to responses (optional or required)

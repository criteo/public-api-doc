...
<Info>
  Check the changelog for your API ([Retail Media](/retail-media/changelog/index) · [Marketing Solutions](/marketing-solutions/changelog/index)) to see which endpoints changed between versions and which ones fall forward safely.
</Info>

...
<Info>
  ...
  * [Demand Side Analytics (DSP)](/criteo-apis/docs/demand-side-analytics-get-started)
  * [Supply Side Analytics (SSP)](/criteo-apis/docs/supply-side-reporting-ssp)
</Info>
...
<Info>
  See [this page ](/criteo-apis/docs/metrics-and-dimensions)for the full list of available metrics and dimensions.
</Info>
...
* Reports support a maximum window of **100 days per request** for the campaigns and line items endpoints. For the [account reporting endpoint](/criteo-apis/docs/account-level-report), that window is **31 days max**.
* Use [bulk calls](/criteo-apis/docs/bulk-calls) to pass up to **50 IDs** at a time when pulling data across a large number of Campaigns or Line Items. Note that for [the account reporting endpoint](/criteo-apis/docs/account-level-report), that limit is only **5 IDs**.
...
* [DSP Analytics Endpoints](/criteo-apis/docs/demand-side-analytics-get-started)
* [Supply Side Analytics (SSP)](/criteo-apis/docs/supply-side-reporting-ssp)
* [Metrics and Dimensions (SSP)](/criteo-apis/docs/metrics-and-dimensions-ssp)
* [Metrics & Dimensions (Fill Rate Report)](/criteo-apis/docs/metrics-dimensions-fill-rate-report)
* [Metrics and Dimensions (DSP)](/criteo-apis/docs/metrics-and-dimensions)
